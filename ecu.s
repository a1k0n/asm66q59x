...
reset_vector:
0x0076 DD=0: b4 2a ab d2         MOVB fix 0x022a, #0xd2
0x007a DD=0: b4 29 ab 02         MOVB fix 0x0229, #0x02
0x007e DD=0: ff                  BRK
wdt_vector:
0x007f DD=0: b4 2a ab cc         MOVB fix 0x022a, #0xcc
0x0083 DD=0: ff                  BRK
optrp_vector:
0x0084 DD=0: b4 2a ab cd         MOVB fix 0x022a, #0xcd
0x0088 DD=0: ff                  BRK
nmi_vector:
tm0_vector:
cap2_vector:
...
sci4_vector:
sci5_vector:
0x0089 DD=0: b4 2a ab ce         MOVB fix 0x022a, #0xce
0x008d DD=0: ff                  BRK
vcal1_vector:
vcal2_vector:
vcal3_vector:
...
vcal14_vector:
vcal15_vector:
0x008e DD=0: b4 2a ab d3         MOVB fix 0x022a, #0xd3
0x0092 DD=0: ff                  BRK
brk_vector:
...
0x00bd DD=0: 94 2a               LB A, fix 0x022a
0x00bf DD=0: 34 28               STB A, fix 0x0228
0x00c1 DD=0: f6 0e               JNE label_00d1
0x00c3 DD=0: b4 2a ab cf         MOVB fix 0x022a, #0xcf
...
0x00d5 DD=0: b4 29 d6            DECB fix 0x0229
...
0x0101 DD=0: b7 fc 8f 72         MOVB R2, tbl_8ffc
...
0x012f DD=0: b7 fc 8f 72         MOVB R2, tbl_8ffc
0x0133 DD=0: 57 13               ACAL label_1713
label_0135:
0x0135 DD=0: 04 fe               SJ label_0135
label_0137:
0x0137 DD=0: b4 28 c7            CLRB fix 0x0228
label_013a:
...
label_0181:
0x0181 DD=0: b4 2a ab c0         MOVB fix 0x022a, #0xc0
0x0185 DD=0: ff                  BRK
label_0186:
0x0186 DD=1: d9                  SDD
...
label_01bd:
0x01bd DD=1: b4 2a ab c1         MOVB fix 0x022a, #0xc1
0x01c1 DD=0: ff                  BRK
label_01c2:
...
0x01cb DD=1: b4 2a 86 00         MOVB fix 0x0200, fix 0x022a
0x01cf DD=1: b4 29 86 01         MOVB fix 0x0201, fix 0x0229
0x01d3 DD=1: b4 28 86 02         MOVB fix 0x0202, fix 0x0228
...
0x01e2 DD=1: b4 02 86 28         MOVB fix 0x0228, fix 0x0202
0x01e6 DD=1: b4 01 86 29         MOVB fix 0x0229, fix 0x0201
0x01ea DD=1: b4 00 86 2a         MOVB fix 0x022a, fix 0x0200
...
0x0265 DD=1: c6 c2 ff ff         MOV TMSEL, #tbl_ffff
...
0x02ef DD=1: c6 d6 f0 ff         MOV TM1, #tbl_fff0
...
0x0300 DD=1: 9e f3 ff            CMP A, #tbl_fff3
...
label_030d:
0x030d DD=1: b4 2a ab c5         MOVB fix 0x022a, #0xc5
0x0311 DD=0: ff                  BRK
label_0312:
0x0312 DD=1: b7 60 01 ab 0b      MOVB 0x0160, #0x0b
0x0317 DD=1: c6 82 00 f0         MOV PWINTQ0, #tbl_f000
0x031b DD=1: c6 84 00 f0         MOV PWINTQ1, #tbl_f000
0x031f DD=1: c6 86 00 f0         MOV PWINTE0, #tbl_f000
0x0323 DD=1: c6 88 00 f0         MOV PWINTE1, #tbl_f000
0x0327 DD=1: c6 50 3f 9c         MOV PWC0, #tbl_9c3f
...
0x0357 DD=1: b4 2a ab c4         MOVB fix 0x022a, #0xc4
0x035b DD=0: ff                  BRK
label_035c:
0x035c DD=1: b6 ee 00            RB ADINTCON0.0
0x035f DD=1: b6 fe 00            RB ADINTCON1.0
0x0362 DD=1: a6 d6 87 0c         MOV off 0x060c, TM1
...
0x0409 DD=0: b7 14 a0 2f 05      JBS tbl_a014.7, label_0413
0x040e DD=0: b4 2a ab c2         MOVB fix 0x022a, #0xc2
0x0412 DD=0: ff                  BRK
label_0413:
0x0413 DD=0: 68 87 10            MOVB off 0x0610, R0
0x0416 DD=0: 62 87 0e            MOV off 0x060e, DP
0x0419 DD=0: 47 61               ACAL label_1361
0x041b DD=0: 47 13               ACAL label_1313
0x041d DD=1: f8 00 00            L A, #0x0000
0x0420 DD=1: 34 3c               ST A, fix 0x023c
...
label_042d:
0x042d DD=0: 34 3e               STB A, fix 0x023e
0x042f DD=0: b4 42 ab 67         MOVB fix 0x0242, #0x67
0x0433 DD=0: b4 43 ab 85         MOVB fix 0x0243, #0x85
0x0437 DD=1: f8 8e 01            L A, #0x018e
0x043a DD=1: 34 56               ST A, fix 0x0256
0x043c DD=1: 34 58               ST A, fix 0x0258
0x043e DD=1: 34 5a               ST A, fix 0x025a
0x0440 DD=1: 34 5c               ST A, fix 0x025c
0x0442 DD=1: 34 5e               ST A, fix 0x025e
0x0444 DD=1: 86 e1               L A, ADCR1
0x0446 DD=1: 37 12 04            ST A, 0x0412
0x0449 DD=1: b6 07 87 1c         MOVB off 0x061c, ACCH
0x044d DD=1: f8 d4 01            L A, #0x01d4
0x0450 DD=1: 34 64               ST A, fix 0x0264
0x0452 DD=1: 8e 00 02            SUB A, #0x0200
0x0455 DD=1: f5 01               JGE label_0458
0x0457 DD=1: fa                  CLR A
label_0458:
0x0458 DD=1: 9f                  SRL A
0x0459 DD=1: b4 63 aa            MOVB fix 0x0263, A
0x045c DD=1: 86 e2               L A, ADCR2
0x045e DD=1: 37 14 04            ST A, 0x0414
0x0461 DD=1: b6 07 87 1d         MOVB off 0x061d, ACCH
0x0465 DD=1: 86 e6               L A, ADCR6
0x0467 DD=1: b6 07 86 72         MOVB fix 0x0272, ACCH
0x046b DD=1: b4 6e ab 94         MOVB fix 0x026e, #0x94
0x046f DD=1: b4 6f ab 6e         MOVB fix 0x026f, #0x6e
0x0473 DD=1: b4 70 ab 58         MOVB fix 0x0270, #0x58
0x0477 DD=1: 86 f2               L A, ADCR14
0x0479 DD=0: 96 07               LB A, ACCH
0x047b DD=0: 35 18               STB A, off 0x0618
0x047d DD=0: 54 0a               ACAL label_140a
0x047f DD=0: b4 71 ab f9         MOVB fix 0x0271, #0xf9
...
0x0493 DD=1: b6 07 86 74         MOVB fix 0x0274, ACCH
0x0497 DD=1: 86 f9               L A, ADCR21
0x0499 DD=1: b6 07 86 75         MOVB fix 0x0275, ACCH
0x049d DD=1: 86 fa               L A, ADCR22
0x049f DD=1: b6 07 86 76         MOVB fix 0x0276, ACCH
0x04a3 DD=1: 86 fb               L A, ADCR23
0x04a5 DD=1: b6 07 86 77         MOVB fix 0x0277, ACCH
0x04a9 DD=1: 84 3c               L A, fix 0x023c
0x04ab DD=1: 35 48               ST A, off 0x0648
0x04ad DD=1: 35 4a               ST A, off 0x064a
0x04af DD=1: 14 10               MOVB R4, #0x10
0x04b1 DD=1: 20 ca 8f            MOV X1, #tbl_8fca
...
0x04e0 DD=0: 97 83 8e            LB A, tbl_8e83
...
label_052b:
0x052b DD=1: 5c 35               SB sbafix 0x02f5.4
label_052d:
0x052d DD=1: 10 00               MOVB R0, #0x00
0x052f DD=1: 20 94 92            MOV X1, #tbl_9294
label_0532:
...
0x053f DD=0: b4 d8 b8            SBR fix 0x02d8.(AL)
label_0542:
...
0x054c DD=0: 5f a6 28            JBS sbafix 0x02e6.7, label_0577
0x054f DD=0: 61 c7               CLR X2
0x0551 DD=0: 20 00 90            MOV X1, #tbl_9000
0x0554 DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_055a
0x0557 DD=0: 20 09 90            MOV X1, #tbl_9009
label_055a:
...
label_0571:
0x0571 DD=0: b7 fa 8f 76         MOVB R6, tbl_8ffa
...
0x0586 DD=1: b7 10 90 72         MOVB R2, tbl_9010
...
0x0596 DD=1: b7 11 90 72         MOVB R2, tbl_9011
...
label_05b7:
0x05b7 DD=1: b7 fa 8f 76         MOVB R6, tbl_8ffa
...
0x05cc DD=1: b7 04 90 72         MOVB R2, tbl_9004
0x05d0 DD=1: 57 58               ACAL label_1758
0x05d2 DD=1: f5 08               JGE label_05dc
0x05d4 DD=1: b7 fa 8f 76         MOVB R6, tbl_8ffa
0x05d8 DD=1: 54 2a               ACAL label_142a
0x05da DD=0: f9 67               LB A, #0x67
label_05dc:
0x05dc DD=0: d8                  RDD
0x05dd DD=0: 34 42               STB A, fix 0x0242
0x05df DD=0: 97 05 90            LB A, tbl_9005
0x05e2 DD=0: 56 c6               ACAL label_16c6
0x05e4 DD=0: 35 94               STB A, off 0x0694
0x05e6 DD=0: 5f a6 3f            JBS sbafix 0x02e6.7, label_0628
0x05e9 DD=0: b7 fd 8f 72         MOVB R2, tbl_8ffd
0x05ed DD=0: 5a f1 04            JBR sbafix 0x02f1.2, label_05f4
0x05f0 DD=0: b7 06 90 72         MOVB R2, tbl_9006
label_05f4:
0x05f4 DD=0: 57 42               ACAL label_1742
0x05f6 DD=0: f2 2a               JLT label_0622
0x05f8 DD=0: 35 14               STB A, off 0x0614
0x05fa DD=0: b7 fe 8f 72         MOVB R2, tbl_8ffe
0x05fe DD=0: 5a f1 04            JBR sbafix 0x02f1.2, label_0605
0x0601 DD=0: b7 07 90 72         MOVB R2, tbl_9007
label_0605:
0x0605 DD=0: 57 42               ACAL label_1742
0x0607 DD=0: f2 19               JLT label_0622
0x0609 DD=0: 35 12               STB A, off 0x0612
0x060b DD=0: b7 ff 8f 72         MOVB R2, tbl_8fff
0x060f DD=0: 5a f1 04            JBR sbafix 0x02f1.2, label_0616
0x0612 DD=0: b7 08 90 72         MOVB R2, tbl_9008
label_0616:
0x0616 DD=0: 57 42               ACAL label_1742
0x0618 DD=0: f2 08               JLT label_0622
0x061a DD=0: d8                  RDD
0x061b DD=0: 35 16               STB A, off 0x0616
0x061d DD=0: df                  SWAP
0x061e DD=0: 35 17               STB A, off 0x0617
0x0620 DD=0: 04 12               SJ label_0634
label_0622:
0x0622 DD=0: b7 fa 8f 76         MOVB R6, tbl_8ffa
0x0626 DD=0: 54 2a               ACAL label_142a
label_0628:
0x0628 DD=0: a5 14 c7            CLR off 0x0614
0x062b DD=0: a5 12 c7            CLR off 0x0612
0x062e DD=0: d7 17 80            MOVB off 0x0617, #0x80
0x0631 DD=0: d7 16 80            MOVB off 0x0616, #0x80
label_0634:
0x0634 DD=0: 47 f1               ACAL label_13f1
0x0636 DD=0: 94 28               LB A, fix 0x0228
...
0x063f DD=0: b7 fc 8f 72         MOVB R2, tbl_8ffc
...
0x0669 DD=0: b7 fc 8f 72         MOVB R2, tbl_8ffc
...
0x0690 DD=0: b7 fc 8f 72         MOVB R2, tbl_8ffc
0x0694 DD=0: 57 42               ACAL label_1742
0x0696 DD=0: f5 02               JGE label_069a
0x0698 DD=0: f9 d1               LB A, #0xd1
label_069a:
0x069a DD=0: d8                  RDD
0x069b DD=0: 34 2b               STB A, fix 0x022b
0x069d DD=0: 38                  STB A, R0
0x069e DD=0: 94 28               LB A, fix 0x0228
0x06a0 DD=0: f1 07               JEQ label_06a9
0x06a2 DD=0: 18                  CMPB A, R0
0x06a3 DD=0: f1 04               JEQ label_06a9
0x06a5 DD=0: b4 2b ab d1         MOVB fix 0x022b, #0xd1
label_06a9:
0x06a9 DD=0: b7 fb 8f 72         MOVB R2, tbl_8ffb
0x06ad DD=0: 57 42               ACAL label_1742
0x06af DD=0: f5 03               JGE label_06b4
0x06b1 DD=1: f8 00 80            L A, #0x8000
label_06b4:
0x06b4 DD=1: 35 00               ST A, off 0x0600
0x06b6 DD=1: b4 2a c7            CLRB fix 0x022a
0x06b9 DD=1: 58 96 03            JBS sbafix 0x02d6.0, label_06bf
0x06bc DD=1: 58 9c 04            JBS sbafix 0x02dc.0, label_06c3
label_06bf:
0x06bf DD=0: f9 02               LB A, #0x02
0x06c1 DD=0: 04 07               SJ label_06ca
label_06c3:
0x06c3 DD=0: f9 08               LB A, #0x08
0x06c5 DD=0: 5c f5 02            JBR sbafix 0x02f5.4, label_06ca
0x06c8 DD=0: f9 04               LB A, #0x04
label_06ca:
0x06ca DD=0: 34 f9               STB A, fix 0x02f9
0x06cc DD=0: 5d e7 0a            JBR sbafix 0x02e7.5, label_06d9
0x06cf DD=0: 59 dc 07            JBR sbafix 0x02dc.1, label_06d9
0x06d2 DD=0: 4b 02               SB sbaoff 0x06c2.3
0x06d4 DD=0: 48 02               SB sbaoff 0x06c2.0
0x06d6 DD=0: b6 11 0a            SB P1.2
label_06d9:
0x06d9 DD=0: d7 b3 32            MOVB off 0x06b3, #0x32
0x06dc DD=0: d7 b2 0f            MOVB off 0x06b2, #0x0f
0x06df DD=0: d7 b6 05            MOVB off 0x06b6, #0x05
...
0x06fc DD=1: b7 f2 8f 76         MOVB R6, tbl_8ff2
...
0x071c DD=1: b7 f3 8f 76         MOVB R6, tbl_8ff3
...
0x073c DD=1: b7 f4 8f 76         MOVB R6, tbl_8ff4
...
0x075c DD=1: b7 f5 8f 76         MOVB R6, tbl_8ff5
...
org 0x1000
label_1000:
0x1000 DD=0: 94 70               LB A, fix 0x0270
...
0x102b DD=0: 01                  RT
label_102c:
0x102c DD=0: 94 70               LB A, fix 0x0270
...
0x11bf DD=1: f8 ff ff            L A, #tbl_ffff
0x11c2 DD=1: 01                  RT
label_11c3:
...
0x1312 DD=0: 01                  RT
label_1313:
0x1313 DD=0: 22 16 a0            MOV DP, #tbl_a016
0x1316 DD=0: 5a b1 03            JBS sbafix 0x02f1.2, label_131c
0x1319 DD=0: 22 10 a0            MOV DP, #tbl_a010
label_131c:
0x131c DD=0: 93                  LB A, [DP+]
0x131d DD=0: be 3f               ANDB A, #0x3f
0x131f DD=0: 34 e2               STB A, fix 0x02e2
0x1321 DD=0: 93                  LB A, [DP+]
0x1322 DD=0: be 0f               ANDB A, #0x0f
0x1324 DD=0: 34 e3               STB A, fix 0x02e3
0x1326 DD=0: 93                  LB A, [DP+]
0x1327 DD=0: be 7f               ANDB A, #0x7f
0x1329 DD=0: 34 e4               STB A, fix 0x02e4
0x132b DD=0: 97 13 a0            LB A, tbl_a013
0x132e DD=0: be bf               ANDB A, #0xbf
0x1330 DD=0: 34 e5               STB A, fix 0x02e5
0x1332 DD=0: 97 14 a0            LB A, tbl_a014
0x1335 DD=0: be bc               ANDB A, #0xbc
0x1337 DD=0: 34 e6               STB A, fix 0x02e6
0x1339 DD=0: 97 15 a0            LB A, tbl_a015
0x133c DD=0: be bf               ANDB A, #0xbf
0x133e DD=0: 34 e7               STB A, fix 0x02e7
0x1340 DD=0: 14 08               MOVB R4, #0x08
0x1342 DD=0: 22 04 06            MOV DP, #0x0604
0x1345 DD=0: 20 00 a0            MOV X1, #tbl_a000
loop_1348:
...
0x1352 DD=0: 20 12 90            MOV X1, #tbl_9012
loop_1355:
0x1355 DD=0: b0 8b               MOVB [DP+], [X1]
0x1357 DD=0: 40                  INC X1
0x1358 DD=0: 05 7b               DJNZ R4, loop_1355
0x135a DD=0: a7 08 a0 9b 02 06   MOV 0x0602, tbl_a008
0x1360 DD=0: 01                  RT
label_1361:
...
0x1371 DD=0: 5a b3 08            JBS sbafix 0x02f3.2, label_137c
0x1374 DD=0: 5a 33               SB sbafix 0x02f3.2
0x1376 DD=0: 34 dd               STB A, fix 0x02dd
0x1378 DD=0: 34 de               STB A, fix 0x02de
0x137a DD=0: 04 1d               SJ label_1399
label_137c:
0x137c DD=0: 38                  STB A, R0
0x137d DD=0: 39                  STB A, R1
0x137e DD=0: b4 dd d5            XORB A, fix 0x02dd
0x1381 DD=0: 68 d0 de            XORB R0, fix 0x02de
...
0x138d DD=0: b4 dc b5            ANDB A, fix 0x02dc
0x1390 DD=0: 68 c5               ORB A, R0
0x1392 DD=0: b4 dd 86 de         MOVB fix 0x02de, fix 0x02dd
0x1396 DD=0: 69 86 dd            MOVB fix 0x02dd, R1
label_1399:
0x1399 DD=0: 34 dc               STB A, fix 0x02dc
...
0x13a5 DD=0: 5f b3 08            JBS sbafix 0x02f3.7, label_13b0
0x13a8 DD=0: 5f 33               SB sbafix 0x02f3.7
0x13aa DD=0: 34 e0               STB A, fix 0x02e0
0x13ac DD=0: 34 e1               STB A, fix 0x02e1
0x13ae DD=0: 04 1d               SJ label_13cd
label_13b0:
0x13b0 DD=0: 38                  STB A, R0
0x13b1 DD=0: 39                  STB A, R1
0x13b2 DD=0: b4 e0 d5            XORB A, fix 0x02e0
0x13b5 DD=0: 68 d0 e1            XORB R0, fix 0x02e1
...
0x13c1 DD=0: b4 df b5            ANDB A, fix 0x02df
0x13c4 DD=0: 68 c5               ORB A, R0
0x13c6 DD=0: b4 e0 86 e1         MOVB fix 0x02e1, fix 0x02e0
0x13ca DD=0: 69 86 e0            MOVB fix 0x02e0, R1
label_13cd:
0x13cd DD=0: 34 df               STB A, fix 0x02df
0x13cf DD=0: 01                  RT
label_13d0:
...
0x1409 DD=0: 01                  RT
label_140a:
0x140a DD=0: b7 d6 8e a5         ADDB A, tbl_8ed6
0x140e DD=0: f5 02               JGE label_1412
0x1410 DD=0: bc d7               FILLB A
label_1412:
0x1412 DD=0: 58 af 09            JBS sbafix 0x02ef.0, label_141e
0x1415 DD=0: 58 f3 06            JBR sbafix 0x02f3.0, label_141e
0x1418 DD=0: b7 19 06 95         CMPB A, 0x0619
0x141c DD=0: f5 0b               JGE label_1429
label_141e:
0x141e DD=0: b7 d5 8e 70         MOVB R0, tbl_8ed5
...
0x142c DD=0: b4 d4 b8            SBR fix 0x02d4.(AL)
0x142f DD=0: 59 36               SB sbafix 0x02f6.1
0x1431 DD=0: b7 b2 08 24 02      JBR 0x08b2.4, label_1438
0x1436 DD=0: 5d 35               SB sbafix 0x02f5.5
label_1438:
0x1438 DD=0: 94 d4               LB A, fix 0x02d4
0x143a DD=0: ac d5               ADDB A, fix 0x02d5
0x143c DD=0: ac d6               ADDB A, fix 0x02d6
0x143e DD=0: ac d7               ADDB A, fix 0x02d7
0x1440 DD=0: 34 9f               STB A, fix 0x029f
0x1442 DD=0: fb                  CLRB A
0x1443 DD=0: b4 d4 d5            XORB A, fix 0x02d4
0x1446 DD=0: b4 d5 d5            XORB A, fix 0x02d5
0x1449 DD=0: b4 d6 d5            XORB A, fix 0x02d6
0x144c DD=0: b4 d7 d5            XORB A, fix 0x02d7
0x144f DD=0: 34 a0               STB A, fix 0x02a0
0x1451 DD=0: b6 07 c7            CLRB ACCH
0x1454 DD=0: 7e                  LB A, R6
0x1455 DD=0: dc                  DECB A
0x1456 DD=1: d9                  SDD
0x1457 DD=1: 8f                  SLL A
0x1458 DD=1: ae 54 92            ADD A, #tbl_9254
...
0x154b DD=0: 34 8d               STB A, fix 0x028d
case_6:
case_7:
case_14:
case_15:
...
label_1579:
0x1579 DD=0: 59 34               SB sbafix 0x02f4.1
...
label_15d3:
0x15d3 DD=0: 5f 35               SB sbafix 0x02f5.7
...
0x1615 DD=1: d5 a3 48            CMPB off 0x08a3, #0x48
0x1618 DD=1: f6 05               JNE label_161f
0x161a DD=1: d5 a4 77            CMPB off 0x08a4, #0x77
...
label_162e:
0x162e DD=1: b4 2a ab c7         MOVB fix 0x022a, #0xc7
0x1632 DD=0: ff                  BRK
label_1633:
...
0x1677 DD=1: 8d 0c               SUB A, off 0x000c
...
label_1688:
0x1688 DD=1: b4 2a ab c4         MOVB fix 0x022a, #0xc4
0x168c DD=0: ff                  BRK
label_168d:
0x168d DD=1: a6 d6 87 0c         MOV off 0x000c, TM1
label_1691:
0x1691 DD=1: 01                  RT
label_1692:
0x1692 DD=1: f8 00 98            L A, #tbl_9800
0x1695 DD=1: 58 35               SB sbafix 0x02f5.0
0x1697 DD=1: 04 05               SJ label_169e
label_1699:
0x1699 DD=1: f8 00 80            L A, #0x8000
0x169c DD=1: 58 75               RB sbafix 0x02f5.0
label_169e:
...
0x17d0 DD=1: 58 dc 07            JBR sbafix 0x02dc.0, label_17da
...
0x17ea DD=1: 01                  RT
int0_vector:
0x17eb DD=0: 5d 95 05            JBS sbafix 0x02d5.5, label_17f3
0x17ee DD=0: 5f ef 02            JBR sbafix 0x02ef.7, label_17f3
0x17f1 DD=0: 59 12               SB sbafix 0x02d2.1
label_17f3:
0x17f3 DD=0: b7 ca 8f 86 8e      MOVB fix 0x028e, tbl_8fca
0x17f8 DD=0: 5f 2f               SB sbafix 0x02ef.7
0x17fa DD=0: 02                  RTI
cap0_vector:
0x17fb DD=0: c6 02 e4 04         MOV LRB, #0x04e4
0x17ff DD=0: 8a ab 04            MOVB PSWL, #0x04
0x1802 DD=1: 86 8a               L A, TMR0
0x1804 DD=1: 35 0a               ST A, off 0x040a
0x1806 DD=1: 3d                  ST A, X2
0x1807 DD=1: 4c 41               RB sbaoff 0x04c1.4
...
label_18fb:
0x18fb DD=1: 4f 44               RB sbaoff 0x04c4.7
0x18fd DD=1: f1 08               JEQ label_1907
0x18ff DD=1: 85 40               L A, off 0x0440
0x1901 DD=1: 2d                  ADD A, X2
0x1902 DD=1: 36 a0               ST A, TMR11
0x1904 DD=1: d6 cd fe            MOVB RTOCON11, #0xfe
label_1907:
0x1907 DD=1: 4c 40               RB sbaoff 0x04c0.4
0x1909 DD=1: f1 0d               JEQ label_1918
0x190b DD=1: 85 5a               L A, off 0x045a
0x190d DD=1: 2d                  ADD A, X2
0x190e DD=1: 36 a2               ST A, TMR12
0x1910 DD=1: 85 5c               L A, off 0x045c
0x1912 DD=1: 2d                  ADD A, X2
0x1913 DD=1: 36 be               ST A, TMR12BF
0x1915 DD=1: d6 ce fd            MOVB RTOCON12, #0xfd
label_1918:
0x1918 DD=1: b7 cb 8f 86 8f      MOVB fix 0x028f, tbl_8fcb
0x191d DD=0: 94 2c               LB A, fix 0x022c
0x191f DD=0: b4 ef 17            MB C, fix 0x02ef.7
0x1922 DD=0: 5f 6f               RB sbafix 0x02ef.7
0x1924 DD=0: b5 00 ac            ROLB off 0x0400, 1
0x1927 DD=0: b5 00 b3 07         ANDB off 0x0400, #0x07
0x192b DD=0: d5 00 05            CMPB off 0x0400, #0x05
0x192e DD=0: f6 19               JNE label_1949
0x1930 DD=0: b5 c0 30 0b         JBRS off 0x04c0.0, label_193f
0x1934 DD=0: 9e 17               CMPB A, #0x17
0x1936 DD=0: f6 07               JNE label_193f
0x1938 DD=0: 49 c0 04            JBR sbaoff 0x04c0.1, label_193f
0x193b DD=0: 58 28               SB sbafix 0x02e8.0
0x193d DD=0: 04 02               SJ label_1941
label_193f:
0x193f DD=0: 58 68               RB sbafix 0x02e8.0
label_1941:
0x1941 DD=0: f9 00               LB A, #0x00
0x1943 DD=0: 4a 00               SB sbaoff 0x04c0.2
0x1945 DD=0: 49 40               RB sbaoff 0x04c0.1
0x1947 DD=0: 04 2f               SJ label_1978
label_1949:
0x1949 DD=0: d5 00 01            CMPB off 0x0400, #0x01
0x194c DD=0: f6 1d               JNE label_196b
0x194e DD=0: b5 c0 30 0f         JBRS off 0x04c0.0, label_1961
...
0x195a DD=0: 4a c0 04            JBR sbaoff 0x04c0.2, label_1961
0x195d DD=0: 58 28               SB sbafix 0x02e8.0
0x195f DD=0: 04 02               SJ label_1963
label_1961:
0x1961 DD=0: 58 68               RB sbafix 0x02e8.0
label_1963:
0x1963 DD=0: f9 0c               LB A, #0x0c
0x1965 DD=0: 49 00               SB sbaoff 0x04c0.1
0x1967 DD=0: 4a 40               RB sbaoff 0x04c0.2
0x1969 DD=0: 04 0d               SJ label_1978
label_196b:
0x196b DD=0: cc                  INCB A
0x196c DD=0: 9e 18               CMPB A, #0x18
0x196e DD=0: f2 08               JLT label_1978
0x1970 DD=0: 58 68               RB sbafix 0x02e8.0
0x1972 DD=0: fb                  CLRB A
0x1973 DD=0: 5c 95 02            JBS sbafix 0x02d5.4, label_1978
0x1976 DD=0: 58 12               SB sbafix 0x02d2.0
label_1978:
0x1978 DD=0: 34 2c               STB A, fix 0x022c
0x197a DD=0: 94 2c               LB A, fix 0x022c
0x197c DD=1: fc                  EXTND
0x197d DD=1: bc 8d               SLL A, 2
0x197f DD=1: 3c                  ST A, X1
0x1980 DD=1: a8 fa 8e 87 02      MOV off 0x0402, tbl_8efa[X1]
0x1985 DD=1: a8 fc 8e 87 04      MOV off 0x0404, tbl_8efc[X1]
0x198a DD=1: a8 5a 8f 87 06      MOV off 0x0406, tbl_8f5a[X1]
0x198f DD=1: a8 5c 8f 87 08      MOV off 0x0408, tbl_8f5c[X1]
0x1994 DD=1: 86 e0               L A, ADCR0
0x1996 DD=1: bc 9f               SRL A, 4
0x1998 DD=1: bc 9d               SRL A, 2
0x199a DD=1: ca                  RC
0x199b DD=1: 5c 94 0e            JBS sbafix 0x02d4.4, label_19ac
...
label_19aa:
0x19aa DD=1: 84 3a               L A, fix 0x023a
label_19ac:
0x19ac DD=1: b4 d0 1c            MB fix 0x02d0.4, C
0x19af DD=1: 34 3a               ST A, fix 0x023a
0x19b1 DD=1: b5 18 70            MOVB R0, off 0x0418
0x19b4 DD=1: d5 18 30            CMPB off 0x0418, #0x30
0x19b7 DD=1: f2 07               JLT label_19c0
0x19b9 DD=1: b5 18 c7            CLRB off 0x0418
0x19bc DD=1: 68 c7               CLRB R0
0x19be DD=1: 4f 00               SB sbaoff 0x04c0.7
label_19c0:
0x19c0 DD=1: 68 8c               SLLB R0, 1
0x19c2 DD=1: 20 30 0b            MOV X1, #0x0b30
0x19c5 DD=1: ab c8               XCHG A, [X1+R0]
0x19c7 DD=1: 5c 90 24            JBS sbafix 0x02d0.4, label_19ee
0x19ca DD=1: 5c d4 07            JBR sbafix 0x02d4.4, label_19d4
0x19cd DD=1: a4 3c ab 00 00      MOV fix 0x023c, #0x0000
0x19d2 DD=1: 04 1a               SJ label_19ee
label_19d4:
0x19d4 DD=1: 39                  ST A, ER1
0x19d5 DD=1: 84 3a               L A, fix 0x023a
0x19d7 DD=1: 38                  ST A, ER0
0x19d8 DD=1: 69 a7 02            TJZB R1, label_19dd
0x19db DD=1: 68 d7               FILLB R0
label_19dd:
0x19dd DD=1: 68 86 3e            MOVB fix 0x023e, R0
0x19e0 DD=1: 64 c7               CLR ER0
0x19e2 DD=1: b4 42 70            MOVB R0, fix 0x0242
0x19e5 DD=1: 08                  SUB A, ER0
0x19e6 DD=1: f5 01               JGE label_19e9
0x19e8 DD=1: fa                  CLR A
label_19e9:
0x19e9 DD=1: 34 3c               ST A, fix 0x023c
0x19eb DD=1: 4f 80 0e            JBS sbaoff 0x04c0.7, label_19fc
label_19ee:
0x19ee DD=1: fa                  CLR A
0x19ef DD=1: 35 16               ST A, off 0x0416
0x19f1 DD=1: 5d 69               RB sbafix 0x02e9.5
0x19f3 DD=1: 4e 40               RB sbaoff 0x04c0.6
0x19f5 DD=1: 5b 69               RB sbafix 0x02e9.3
0x19f7 DD=1: 34 44               ST A, fix 0x0244
0x19f9 DD=1: 03 b8 1a            J label_1ab8
label_19fc:
0x19fc DD=1: 27 55 15            MOV ER3, #0x1555
0x19ff DD=1: 26 06 02            MOV ER2, #0x0206
0x1a02 DD=1: 84 34               L A, fix 0x0234
...
label_1a1e:
0x1a1e DD=0: 95 18               LB A, off 0x0418
...
0x1a44 DD=0: 95 18               LB A, off 0x0418
...
0x1a50 DD=1: d9                  SDD
0x1a51 DD=1: 8c 3a               SUB A, fix 0x023a
...
0x1a5c DD=1: a7 86 80 70         MOV ER0, tbl_8086
...
0x1a6e DD=1: a4 34 a9            MUL fix 0x0234
...
0x1a7f DD=1: 66 91 16            CMP ER2, off 0x0416
0x1a82 DD=1: 66 87 16            MOV off 0x0416, ER2
0x1a85 DD=1: f5 0f               JGE label_1a96
0x1a87 DD=0: 95 18               LB A, off 0x0418
...
0x1a92 DD=1: d9                  SDD
0x1a93 DD=1: 9c 3a               CMP A, fix 0x023a
0x1a95 DD=1: fd                  CPL C
label_1a96:
0x1a96 DD=1: b4 e9 1d            MB fix 0x02e9.5, C
...
label_1aa2:
0x1aa2 DD=1: b5 c0 1e            MB off 0x04c0.6, C
0x1aa5 DD=1: 8a 23 09            JBR PSWL.3, label_1ab1
0x1aa8 DD=1: 5b e9 06            JBR sbafix 0x02e9.3, label_1ab1
0x1aab DD=1: 9c 44               CMP A, fix 0x0244
0x1aad DD=1: f5 02               JGE label_1ab1
0x1aaf DD=1: 84 44               L A, fix 0x0244
label_1ab1:
0x1ab1 DD=1: 8a 13               MB C, PSWL.3
0x1ab3 DD=1: b4 e9 1b            MB fix 0x02e9.3, C
0x1ab6 DD=1: 34 44               ST A, fix 0x0244
label_1ab8:
0x1ab8 DD=1: b5 18 c6            INCB off 0x0418
0x1abb DD=1: 5c 94 23            JBS sbafix 0x02d4.4, label_1ae1
0x1abe DD=1: 5c 90 28            JBS sbafix 0x02d0.4, label_1ae9
0x1ac1 DD=1: 22 7e 80            MOV DP, #tbl_807e
0x1ac4 DD=1: 5a f1 03            JBR sbafix 0x02f1.2, label_1aca
0x1ac7 DD=1: 22 0e 84            MOV DP, #tbl_840e
label_1aca:
0x1aca DD=1: 83                  L A, [DP+]
0x1acb DD=1: 58 a9 0f            JBS sbafix 0x02e9.0, label_1add
0x1ace DD=1: a2 a5               ADD A, [DP]
0x1ad0 DD=1: f2 17               JLT label_1ae9
0x1ad2 DD=1: a4 3c 94            CMP fix 0x023c, A
0x1ad5 DD=1: f2 12               JLT label_1ae9
0x1ad7 DD=1: 58 29               SB sbafix 0x02e9.0
0x1ad9 DD=1: 5a 29               SB sbafix 0x02e9.2
0x1adb DD=1: 04 0c               SJ label_1ae9
label_1add:
0x1add DD=1: 9c 3c               CMP A, fix 0x023c
0x1adf DD=1: f2 08               JLT label_1ae9
label_1ae1:
0x1ae1 DD=1: 58 69               RB sbafix 0x02e9.0
0x1ae3 DD=1: 5a 69               RB sbafix 0x02e9.2
0x1ae5 DD=1: b7 d3 03 00         RB 0x03d3.0
label_1ae9:
0x1ae9 DD=1: ca                  RC
0x1aea DD=1: 5b ef 0e            JBR sbafix 0x02ef.3, label_1afb
0x1aed DD=1: f8 9a 01            L A, #0x019a
0x1af0 DD=1: 49 86 03            JBS sbaoff 0x04c6.1, label_1af6
0x1af3 DD=1: f8 cd 01            L A, #0x01cd
label_1af6:
0x1af6 DD=1: 9c 3c               CMP A, fix 0x023c
0x1af8 DD=1: b5 c6 19            MB off 0x04c6.1, C
label_1afb:
0x1afb DD=1: b5 c7 18            MB off 0x04c7.0, C
0x1afe DD=1: 85 0a               L A, off 0x040a
0x1b00 DD=1: b6 07 2f 09         JBS ACCH.7, label_1b0d
0x1b04 DD=1: b6 40 22 05         JBR IRQ0L.2, label_1b0d
0x1b08 DD=1: 5a 2f               SB sbafix 0x02ef.2
0x1b0a DD=1: b4 2d c6            INCB fix 0x022d
label_1b0d:
0x1b0d DD=1: b5 c0 35 46         JBRS off 0x04c0.5, label_1b57
0x1b11 DD=1: 8d 0c               SUB A, off 0x040c
0x1b13 DD=1: b4 2d e3 00         SBCB fix 0x022d, #0x00
0x1b17 DD=1: f1 04               JEQ label_1b1d
0x1b19 DD=1: 59 2f               SB sbafix 0x02ef.1
0x1b1b DD=1: bc d7               FILL A
label_1b1d:
0x1b1d DD=1: 35 0e               ST A, off 0x040e
0x1b1f DD=1: 58 e8 1a            JBR sbafix 0x02e8.0, label_1b3c
0x1b22 DD=1: 20 00 0b            MOV X1, #0x0b00
0x1b25 DD=1: b4 2c 70            MOVB R0, fix 0x022c
0x1b28 DD=1: 68 8c               SLLB R0, 1
0x1b2a DD=1: ab c8               XCHG A, [X1+R0]
0x1b2c DD=1: a4 2e 84            SUB fix 0x022e, A
0x1b2f DD=1: b4 32 e3 00         SBCB fix 0x0232, #0x00
0x1b33 DD=1: 85 0e               L A, off 0x040e
0x1b35 DD=1: a4 2e a4            ADD fix 0x022e, A
0x1b38 DD=1: b4 32 f3 00         ADCB fix 0x0232, #0x00
label_1b3c:
0x1b3c DD=1: 58 ef 0b            JBR sbafix 0x02ef.0, label_1b4a
0x1b3f DD=1: 9e 50 c3            CMP A, #tbl_c350
0x1b42 DD=1: f0 13               JGT label_1b57
0x1b44 DD=1: 59 28               SB sbafix 0x02e8.1
0x1b46 DD=1: 58 6f               RB sbafix 0x02ef.0
0x1b48 DD=1: 04 0d               SJ label_1b57
label_1b4a:
0x1b4a DD=1: b5 10 c6            INCB off 0x0410
0x1b4d DD=1: d5 10 18            CMPB off 0x0410, #0x18
0x1b50 DD=1: f2 05               JLT label_1b57
0x1b52 DD=1: d7 10 17            MOVB off 0x0410, #0x17
0x1b55 DD=1: 5d 28               SB sbafix 0x02e8.5
label_1b57:
0x1b57 DD=1: b4 2d ab 00         MOVB fix 0x022d, #0x00
0x1b5b DD=1: a5 0a 87 0c         MOV off 0x040c, off 0x040a
0x1b5f DD=1: 58 e3 28            JBR sbafix 0x02e3.0, label_1b8a
0x1b62 DD=1: 58 e8 25            JBR sbafix 0x02e8.0, label_1b8a
0x1b65 DD=0: 94 2c               LB A, fix 0x022c
0x1b67 DD=0: b7 00 8e ca         TBR tbl_8e00.(AL)
0x1b6b DD=0: f1 06               JEQ label_1b73
0x1b6d DD=0: a6 f1 87 58         MOV off 0x0458, ADCR13
0x1b71 DD=0: 04 06               SJ label_1b79
label_1b73:
0x1b73 DD=0: b7 03 8e ca         TBR tbl_8e03.(AL)
...
0x1b83 DD=1: b6 07 87 54         MOVB off 0x0454, ACCH
0x1b87 DD=1: b6 11 0c            SB P1.4
label_1b8a:
0x1b8a DD=1: a6 e1 70            MOV ER0, ADCR1
0x1b8d DD=0: 94 2c               LB A, fix 0x022c
...
label_1b9f:
0x1b9f DD=0: 64 87 12            MOV off 0x0412, ER0
label_1ba2:
0x1ba2 DD=0: 58 a8 05            JBS sbafix 0x02e8.0, label_1baa
0x1ba5 DD=0: b5 c5 c7            CLRB off 0x04c5
0x1ba8 DD=0: 04 18               SJ label_1bc2
label_1baa:
0x1baa DD=0: 95 06               LB A, off 0x0406
0x1bac DD=0: f6 02               JNE label_1bb0
0x1bae DD=0: 48 45               RB sbaoff 0x04c5.0
label_1bb0:
0x1bb0 DD=0: 95 07               LB A, off 0x0407
0x1bb2 DD=0: f6 02               JNE label_1bb6
0x1bb4 DD=0: 49 45               RB sbaoff 0x04c5.1
label_1bb6:
0x1bb6 DD=0: 95 08               LB A, off 0x0408
0x1bb8 DD=0: f6 02               JNE label_1bbc
0x1bba DD=0: 4a 45               RB sbaoff 0x04c5.2
label_1bbc:
0x1bbc DD=0: 95 09               LB A, off 0x0409
0x1bbe DD=0: f6 02               JNE label_1bc2
0x1bc0 DD=0: 4b 45               RB sbaoff 0x04c5.3
label_1bc2:
0x1bc2 DD=0: 58 9f 0c            JBS sbafix 0x02df.0, label_1bd1
0x1bc5 DD=0: 48 87 09            JBS sbaoff 0x04c7.0, label_1bd1
0x1bc8 DD=0: 58 af 06            JBS sbafix 0x02ef.0, label_1bd1
0x1bcb DD=0: 5f 9c 03            JBS sbafix 0x02dc.7, label_1bd1
0x1bce DD=0: 58 a8 22            JBS sbafix 0x02e8.0, label_1bf3
label_1bd1:
...
0x1c34 DD=0: a5 0e a9            MUL off 0x040e
0x1c37 DD=0: df                  SWAP
...
0x1c4a DD=1: a5 0e a9            MUL off 0x040e
...
label_1c5b:
0x1c5b DD=1: a5 0e fb            DIVQ off 0x040e
label_1c5e:
0x1c5e DD=0: d8                  RDD
...
0x1c90 DD=0: a5 0e a9            MUL off 0x040e
0x1c93 DD=0: df                  SWAP
...
0x1ca6 DD=1: a5 0e a9            MUL off 0x040e
...
label_1cb7:
0x1cb7 DD=1: a5 0e fb            DIVQ off 0x040e
label_1cba:
...
0x1cde DD=1: 8d 0c               SUB A, off 0x040c
...
0x1cf4 DD=1: ad 0c               ADD A, off 0x040c
...
0x1d57 DD=0: a5 0e a9            MUL off 0x040e
0x1d5a DD=0: df                  SWAP
...
0x1d7f DD=1: 5b e2 1e            JBR sbafix 0x02e2.3, label_1da0
0x1d82 DD=1: 5d e8 1b            JBR sbafix 0x02e8.5, label_1da0
0x1d85 DD=1: 58 e9 18            JBR sbafix 0x02e9.0, label_1da0
0x1d88 DD=1: 5d e2 05            JBR sbafix 0x02e2.5, label_1d90
...
label_1d9e:
0x1d9e DD=0: 5a 69               RB sbafix 0x02e9.2
label_1da0:
0x1da0 DD=0: 03 b3 1e            J label_1eb3
label_1da3:
0x1da3 DD=0: 5c a2 04            JBS sbafix 0x02e2.4, label_1daa
0x1da6 DD=0: 5a 69               RB sbafix 0x02e9.2
0x1da8 DD=0: f6 2e               JNE label_1dd8
label_1daa:
0x1daa DD=0: 5b e9 0c            JBR sbafix 0x02e9.3, label_1db9
0x1dad DD=0: a7 86 80 90 44      CMP tbl_8086, fix 0x0244
...
0x1dc0 DD=0: 5c e2 04            JBR sbafix 0x02e2.4, label_1dc7
...
0x1e13 DD=0: 94 2c               LB A, fix 0x022c
0x1e15 DD=0: 20 ae 80            MOV X1, #tbl_80ae
0x1e18 DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_1e1e
0x1e1b DD=0: 20 34 84            MOV X1, #tbl_8434
label_1e1e:
0x1e1e DD=0: ba 70               MOVB R0, [X1+A]
0x1e20 DD=0: 68 b1 c5            ANDB R0, off 0x04c5
...
label_1eb3:
0x1eb3 DD=0: 94 2c               LB A, fix 0x022c
0x1eb5 DD=0: b7 19 8d ba         MBR C, tbl_8d19.(AL)
0x1eb9 DD=0: b6 10 1a            MB P0.2, C
0x1ebc DD=0: 58 a3 03            JBS sbafix 0x02e3.0, label_1ec2
0x1ebf DD=0: 03 73 1f            J label_1f73
label_1ec2:
0x1ec2 DD=0: 94 2c               LB A, fix 0x022c
0x1ec4 DD=0: b7 06 8e ca         TBR tbl_8e06.(AL)
0x1ec8 DD=0: f1 43               JEQ label_1f0d
0x1eca DD=0: 48 86 13            JBS sbaoff 0x04c6.0, label_1ee0
0x1ecd DD=1: 85 58               L A, off 0x0458
...
0x1ed4 DD=0: d8                  RDD
0x1ed5 DD=0: df                  SWAP
0x1ed6 DD=0: b7 12 8e 70         MOVB R0, tbl_8e12
0x1eda DD=0: 18                  CMPB A, R0
0x1edb DD=0: f5 01               JGE label_1ede
0x1edd DD=0: 78                  LB A, R0
label_1ede:
0x1ede DD=0: 35 56               STB A, off 0x0456
label_1ee0:
0x1ee0 DD=0: 95 56               LB A, off 0x0456
0x1ee2 DD=0: b4 a7 a9            MULB fix 0x02a7
0x1ee5 DD=1: d9                  SDD
...
0x1eee DD=0: 35 55               STB A, off 0x0455
0x1ef0 DD=0: 5a a8 0e            JBS sbafix 0x02e8.2, label_1f01
0x1ef3 DD=0: 58 ec 0b            JBR sbafix 0x02ec.0, label_1f01
0x1ef6 DD=0: 9d 54               CMPB A, off 0x0454
0x1ef8 DD=0: f0 07               JGT label_1f01
0x1efa DD=0: 59 2c               SB sbafix 0x02ec.1
0x1efc DD=0: 97 13 8e            LB A, tbl_8e13
0x1eff DD=0: 35 57               STB A, off 0x0457
label_1f01:
0x1f01 DD=0: ca                  RC
0x1f02 DD=0: 95 57               LB A, off 0x0457
0x1f04 DD=0: f1 04               JEQ label_1f0a
0x1f06 DD=0: b5 57 d6            DECB off 0x0457
0x1f09 DD=0: cb                  SC
label_1f0a:
0x1f0a DD=0: b5 c6 18            MB off 0x04c6.0, C
label_1f0d:
0x1f0d DD=0: 94 2c               LB A, fix 0x022c
0x1f0f DD=0: cc                  INCB A
0x1f10 DD=0: 9e 18               CMPB A, #0x18
0x1f12 DD=0: f2 01               JLT label_1f15
0x1f14 DD=0: fb                  CLRB A
label_1f15:
0x1f15 DD=0: b7 14 8e ca         TBR tbl_8e14.(AL)
0x1f19 DD=0: f1 58               JEQ label_1f73
0x1f1b DD=0: 66 c7               CLR ER2
0x1f1d DD=0: b7 25 05 74         MOVB R4, 0x0525
0x1f21 DD=1: 87 17 8e            L A, tbl_8e17
...
0x1f2e DD=1: a5 0e a9            MUL off 0x040e
...
0x1f47 DD=1: 87 19 8e            L A, tbl_8e19
...
0x1f51 DD=1: a5 0e a9            MUL off 0x040e
...
0x1f71 DD=1: 4c 00               SB sbaoff 0x04c0.4
label_1f73:
0x1f73 DD=1: 58 e4 18            JBR sbafix 0x02e4.0, label_1f8e
0x1f76 DD=1: a6 e2 70            MOV ER0, ADCR2
0x1f79 DD=0: 94 2c               LB A, fix 0x022c
...
label_1f8b:
0x1f8b DD=0: 64 87 14            MOV off 0x0414, ER0
label_1f8e:
...
0x1f96 DD=0: 22 32 8a            MOV DP, #tbl_8a32
0x1f99 DD=0: 95 43               LB A, off 0x0443
0x1f9b DD=0: bc 8d               SLLB A, 2
0x1f9d DD=0: 62 a4               ADD DP, A
label_1f9f:
0x1f9f DD=0: a2 90 3c            CMP [DP], fix 0x023c
...
label_1fac:
0x1fac DD=0: 22 2c 8a            MOV DP, #tbl_8a2c
0x1faf DD=0: 62 a4               ADD DP, A
label_1fb1:
0x1fb1 DD=0: a2 90 3c            CMP [DP], fix 0x023c
...
label_1fc6:
0x1fc6 DD=0: 35 43               STB A, off 0x0443
0x1fc8 DD=0: f9 05               LB A, #0x05
0x1fca DD=0: b5 42 a9            MULB off 0x0442
0x1fcd DD=0: ad 43               ADDB A, off 0x0443
0x1fcf DD=0: 22 45 8a            MOV DP, #tbl_8a45
0x1fd2 DD=0: 62 a4               ADD DP, A
0x1fd4 DD=0: b2 87 44            MOVB off 0x0444, [DP]
0x1fd7 DD=0: 95 44               LB A, off 0x0444
0x1fd9 DD=0: b8 46 04 95         CMPB A, 0x0446[X1]
0x1fdd DD=0: f6 05               JNE label_1fe4
0x1fdf DD=0: 97 44 8a            LB A, tbl_8a44
...
label_1ff5:
0x1ff5 DD=0: 97 44 8a            LB A, tbl_8a44
label_1ff8:
...
0x2003 DD=0: 59 e8 0d            JBR sbafix 0x02e8.1, label_2013
0x2006 DD=0: b4 7a ab 01         MOVB fix 0x027a, #0x01
0x200a DD=0: b4 79 ab 01         MOVB fix 0x0279, #0x01
0x200e DD=0: b6 42 0b            SB IRQ1L.3
0x2011 DD=0: 04 52               SJ label_2065
label_2013:
0x2013 DD=0: 58 e8 4f            JBR sbafix 0x02e8.0, label_2065
0x2016 DD=0: 61 c7               CLR X2
label_2018:
0x2018 DD=1: fa                  CLR A
0x2019 DD=1: b9 fc 89 97         MOVB A, tbl_89fc[X2]
...
0x2066 DD=0: 02                  RTI
ftm17_vector:
0x2067 DD=0: 5d e4 2f            JBR sbafix 0x02e4.5, label_2099
0x206a DD=0: c6 02 e3 05         MOV LRB, #0x05e3
0x206e DD=0: 8a ab 03            MOVB PSWL, #0x03
0x2071 DD=0: b5 ed 38 27         JBSR off 0x05ed.0, label_209c
0x2075 DD=0: 48 2d               SB sbaoff 0x05ed.0
0x2077 DD=1: 86 e6               L A, ADCR6
0x2079 DD=0: 96 07               LB A, ACCH
0x207b DD=0: 35 5a               STB A, off 0x055a
0x207d DD=0: 48 ae 0b            JBS sbaoff 0x05ee.0, label_208b
label_2080:
0x2080 DD=0: 9e 49               CMPB A, #0x49
0x2082 DD=0: f5 0d               JGE label_2091
label_2084:
0x2084 DD=1: f8 10 27            L A, #0x2710
0x2087 DD=1: 49 6d               RB sbaoff 0x05ed.1
0x2089 DD=1: 04 0b               SJ label_2096
label_208b:
0x208b DD=0: 49 ae f2            JBS sbaoff 0x05ee.1, label_2080
0x208e DD=0: 49 ed f3            JBR sbaoff 0x05ed.1, label_2084
label_2091:
0x2091 DD=1: f8 88 13            L A, #0x1388
0x2094 DD=1: 49 2d               SB sbaoff 0x05ed.1
label_2096:
...
0x209f DD=1: b6 07 87 5b         MOVB off 0x055b, ACCH
0x20a3 DD=1: 86 e8               L A, ADCR8
0x20a5 DD=1: b6 07 87 5c         MOVB off 0x055c, ACCH
0x20a9 DD=1: 5f 97 20            JBS sbafix 0x02d7.7, label_20cc
0x20ac DD=1: d5 5a 41            CMPB off 0x055a, #0x41
0x20af DD=1: f2 19               JLT label_20ca
0x20b1 DD=1: d5 5a a0            CMPB off 0x055a, #0xa0
0x20b4 DD=1: f0 14               JGT label_20ca
0x20b6 DD=1: d5 5b 20            CMPB off 0x055b, #0x20
0x20b9 DD=1: f2 1e               JLT label_20d9
0x20bb DD=1: d5 5b ec            CMPB off 0x055b, #0xec
0x20be DD=1: f0 19               JGT label_20d9
0x20c0 DD=1: d5 5c 20            CMPB off 0x055c, #0x20
0x20c3 DD=1: f2 10               JLT label_20d5
0x20c5 DD=1: d5 5c ec            CMPB off 0x055c, #0xec
0x20c8 DD=1: f0 0b               JGT label_20d5
label_20ca:
0x20ca DD=1: 4e 6d               RB sbaoff 0x05ed.6
label_20cc:
0x20cc DD=1: 5e 51               RB sbafix 0x02d1.6
0x20ce DD=1: 5f 51               RB sbafix 0x02d1.7
0x20d0 DD=1: d7 6f 05            MOVB off 0x056f, #0x05
0x20d3 DD=1: 04 08               SJ label_20dd
label_20d5:
0x20d5 DD=1: 5f 11               SB sbafix 0x02d1.7
0x20d7 DD=1: 04 02               SJ label_20db
label_20d9:
0x20d9 DD=1: 5e 11               SB sbafix 0x02d1.6
label_20db:
0x20db DD=1: 4e 2d               SB sbaoff 0x05ed.6
label_20dd:
0x20dd DD=1: 58 ef 09            JBR sbafix 0x02ef.0, label_20e9
0x20e0 DD=1: d5 5a 49            CMPB off 0x055a, #0x49
0x20e3 DD=1: f2 04               JLT label_20e9
0x20e5 DD=1: 49 2f               SB sbaoff 0x05ef.1
0x20e7 DD=1: 04 09               SJ label_20f2
label_20e9:
0x20e9 DD=1: 49 6f               RB sbaoff 0x05ef.1
0x20eb DD=1: 48 6f               RB sbaoff 0x05ef.0
0x20ed DD=1: 4a 6f               RB sbaoff 0x05ef.2
0x20ef DD=1: d7 59 03            MOVB off 0x0559, #0x03
label_20f2:
0x20f2 DD=1: b5 54 a1 56         ADDB off 0x0554, off 0x0556
0x20f6 DD=1: 48 ef 21            JBR sbaoff 0x05ef.0, label_211a
0x20f9 DD=1: 4b 2f               SB sbaoff 0x05ef.3
0x20fb DD=1: 4a ef 14            JBR sbaoff 0x05ef.2, label_2112
0x20fe DD=1: b5 59 a6 0d         TJNZB off 0x0559, label_210f
0x2102 DD=1: d7 59 03            MOVB off 0x0559, #0x03
0x2105 DD=1: d7 ec 04            MOVB off 0x05ec, #0x04
0x2108 DD=1: d7 56 01            MOVB off 0x0556, #0x01
0x210b DD=1: 4a 6f               RB sbaoff 0x05ef.2
0x210d DD=1: 04 09               SJ label_2118
label_210f:
0x210f DD=1: b5 59 d6            DECB off 0x0559
label_2112:
0x2112 DD=1: d7 ec 01            MOVB off 0x05ec, #0x01
0x2115 DD=1: d7 56 00            MOVB off 0x0556, #0x00
label_2118:
0x2118 DD=1: 04 2c               SJ label_2146
label_211a:
0x211a DD=1: 4e ed 0b            JBR sbaoff 0x05ed.6, label_2128
0x211d DD=1: d7 ec 01            MOVB off 0x05ec, #0x01
0x2120 DD=1: d7 58 03            MOVB off 0x0558, #0x03
0x2123 DD=1: b5 56 c7            CLRB off 0x0556
0x2126 DD=1: 04 1e               SJ label_2146
label_2128:
0x2128 DD=1: f8 dc dd            L A, #tbl_dddc
0x212b DD=1: 48 ae 01            JBS sbaoff 0x05ee.0, label_212f
0x212e DD=1: df                  SWAP
label_212f:
0x212f DD=1: b5 54 94            CMPB off 0x0554, A
0x2132 DD=1: f6 04               JNE label_2138
0x2134 DD=1: b6 07 87 54         MOVB off 0x0554, ACCH
label_2138:
0x2138 DD=1: d5 5a 3e            CMPB off 0x055a, #0x3e
0x213b DD=1: f5 0c               JGE label_2149
0x213d DD=1: d7 ec 01            MOVB off 0x05ec, #0x01
0x2140 DD=1: d7 58 01            MOVB off 0x0558, #0x01
0x2143 DD=1: b5 56 c7            CLRB off 0x0556
label_2146:
0x2146 DD=1: 03 57 22            J label_2257
label_2149:
0x2149 DD=1: 4a ed 3f            JBR sbaoff 0x05ed.2, label_218b
0x214c DD=1: 48 ae 3c            JBS sbaoff 0x05ee.0, label_218b
0x214f DD=1: 68 c7               CLRB R0
0x2151 DD=1: b5 58 a7 05         TJZB off 0x0558, label_215a
0x2155 DD=1: b5 58 d6            DECB off 0x0558
0x2158 DD=1: 04 2b               SJ label_2185
label_215a:
0x215a DD=0: 95 54               LB A, off 0x0554
...
0x216d DD=0: 4a ab 0b            JBS sbaoff 0x05eb.2, label_217b
0x2170 DD=0: d0                  DEC R0
0x2171 DD=0: 04 10               SJ label_2183
label_2173:
0x2173 DD=0: f9 04               LB A, #0x04
0x2175 DD=0: 49 ab 03            JBS sbaoff 0x05eb.1, label_217b
0x2178 DD=0: c0                  INCB R0
0x2179 DD=0: 04 08               SJ label_2183
label_217b:
0x217b DD=0: f9 01               LB A, #0x01
0x217d DD=0: 48 ab 03            JBS sbaoff 0x05eb.0, label_2183
0x2180 DD=0: d7 58 03            MOVB off 0x0558, #0x03
label_2183:
0x2183 DD=0: 35 ec               STB A, off 0x05ec
label_2185:
0x2185 DD=0: 68 87 56            MOVB off 0x0556, R0
0x2188 DD=0: 03 26 22            J label_2226
label_218b:
0x218b DD=1: 4b ad 11            JBS sbaoff 0x05ed.3, label_219f
0x218e DD=1: 48 ae 06            JBS sbaoff 0x05ee.0, label_2197
0x2191 DD=1: d7 57 02            MOVB off 0x0557, #0x02
0x2194 DD=1: d7 54 dc            MOVB off 0x0554, #0xdc
label_2197:
0x2197 DD=1: d7 56 ff            MOVB off 0x0556, #0xff
0x219a DD=1: d7 ec 02            MOVB off 0x05ec, #0x02
0x219d DD=1: 4b 2d               SB sbaoff 0x05ed.3
label_219f:
0x219f DD=1: 4c ad 54            JBS sbaoff 0x05ed.4, label_21f6
0x21a2 DD=0: 95 54               LB A, off 0x0554
0x21a4 DD=0: 4a ad 0b            JBS sbaoff 0x05ed.2, label_21b2
0x21a7 DD=0: f6 48               JNE label_21f1
0x21a9 DD=0: 35 56               STB A, off 0x0556
0x21ab DD=0: 4c 2d               SB sbaoff 0x05ed.4
0x21ad DD=0: d7 ec 01            MOVB off 0x05ec, #0x01
0x21b0 DD=0: 04 42               SJ label_21f4
label_21b2:
0x21b2 DD=0: 9e dd               CMPB A, #0xdd
0x21b4 DD=0: f5 1c               JGE label_21d2
0x21b6 DD=0: 49 ee 38            JBR sbaoff 0x05ee.1, label_21f1
0x21b9 DD=0: b5 56 c7            CLRB off 0x0556
0x21bc DD=0: d7 ec 01            MOVB off 0x05ec, #0x01
0x21bf DD=0: 4b ae 07            JBS sbaoff 0x05ee.3, label_21c9
0x21c2 DD=0: d7 58 03            MOVB off 0x0558, #0x03
0x21c5 DD=0: 4b 2e               SB sbaoff 0x05ee.3
0x21c7 DD=0: 04 2b               SJ label_21f4
label_21c9:
0x21c9 DD=0: b5 58 d6            DECB off 0x0558
0x21cc DD=0: f6 26               JNE label_21f4
0x21ce DD=0: 48 6e               RB sbaoff 0x05ee.0
...
0x21da DD=0: 49 ee 14            JBR sbaoff 0x05ee.1, label_21f1
label_21dd:
0x21dd DD=0: b5 56 c7            CLRB off 0x0556
0x21e0 DD=0: 4c 2d               SB sbaoff 0x05ed.4
0x21e2 DD=0: 48 6e               RB sbaoff 0x05ee.0
0x21e4 DD=0: 4c 2e               SB sbaoff 0x05ee.4
0x21e6 DD=0: d7 54 f6            MOVB off 0x0554, #0xf6
0x21e9 DD=0: d7 58 02            MOVB off 0x0558, #0x02
0x21ec DD=0: d7 ec 01            MOVB off 0x05ec, #0x01
0x21ef DD=0: 04 03               SJ label_21f4
label_21f1:
0x21f1 DD=0: d7 56 ff            MOVB off 0x0556, #0xff
label_21f4:
0x21f4 DD=0: 04 30               SJ label_2226
label_21f6:
0x21f6 DD=1: 4d ad 13            JBS sbaoff 0x05ed.5, label_220c
0x21f9 DD=1: b5 57 83 01         SUBB off 0x0557, #0x01
0x21fd DD=1: f5 27               JGE label_2226
0x21ff DD=1: 4d 2d               SB sbaoff 0x05ed.5
0x2201 DD=1: d7 56 01            MOVB off 0x0556, #0x01
0x2204 DD=1: d7 57 0a            MOVB off 0x0557, #0x0a
0x2207 DD=1: d7 ec 04            MOVB off 0x05ec, #0x04
0x220a DD=1: 04 1a               SJ label_2226
label_220c:
0x220c DD=1: d7 56 01            MOVB off 0x0556, #0x01
0x220f DD=1: b5 57 d6            DECB off 0x0557
0x2212 DD=1: f6 12               JNE label_2226
0x2214 DD=1: b5 54 c7            CLRB off 0x0554
0x2217 DD=1: 4b 6d               RB sbaoff 0x05ed.3
0x2219 DD=1: 4c 6d               RB sbaoff 0x05ed.4
0x221b DD=1: b5 56 c7            CLRB off 0x0556
0x221e DD=1: d7 58 03            MOVB off 0x0558, #0x03
0x2221 DD=1: d7 ec 01            MOVB off 0x05ec, #0x01
0x2224 DD=1: 4a 2d               SB sbaoff 0x05ed.2
label_2226:
0x2226 DD=1: 48 ee 2e            JBR sbaoff 0x05ee.0, label_2257
0x2229 DD=1: 49 ae 2b            JBS sbaoff 0x05ee.1, label_2257
0x222c DD=1: 4a ae 13            JBS sbaoff 0x05ee.2, label_2242
0x222f DD=0: fb                  CLRB A
0x2230 DD=0: 49 ab 0b            JBS sbaoff 0x05eb.1, label_223e
0x2233 DD=0: cc                  INCB A
0x2234 DD=0: 48 ab 01            JBS sbaoff 0x05eb.0, label_2238
0x2237 DD=0: cc                  INCB A
label_2238:
0x2238 DD=0: d5 5a 49            CMPB off 0x055a, #0x49
0x223b DD=0: f2 01               JLT label_223e
0x223d DD=0: cc                  INCB A
label_223e:
0x223e DD=0: 35 57               STB A, off 0x0557
0x2240 DD=0: 4a 2e               SB sbaoff 0x05ee.2
label_2242:
0x2242 DD=0: b5 57 a7 0b         TJZB off 0x0557, label_2251
0x2246 DD=0: b5 57 d6            DECB off 0x0557
0x2249 DD=0: b5 56 c7            CLRB off 0x0556
0x224c DD=0: d7 ec 01            MOVB off 0x05ec, #0x01
0x224f DD=0: 04 06               SJ label_2257
label_2251:
0x2251 DD=0: d7 56 ff            MOVB off 0x0556, #0xff
0x2254 DD=0: d7 ec 02            MOVB off 0x05ec, #0x02
label_2257:
0x2257 DD=1: f8 10 27            L A, #0x2710
0x225a DD=1: 49 ed 03            JBR sbaoff 0x05ed.1, label_2260
0x225d DD=1: f8 88 13            L A, #0x1388
label_2260:
0x2260 DD=1: a6 ac a4            ADD TMR17, A
0x2263 DD=1: b5 ec 87 eb         MOVB off 0x05eb, off 0x05ec
0x2267 DD=0: 95 54               LB A, off 0x0554
0x2269 DD=0: ad 56               ADDB A, off 0x0556
0x226b DD=0: 38                  STB A, R0
0x226c DD=0: 4a ed 11            JBR sbaoff 0x05ed.2, label_2280
0x226f DD=0: 8e dd               SUBB A, #0xdd
0x2271 DD=0: 39                  STB A, R1
0x2272 DD=0: 95 55               LB A, off 0x0555
...
0x227e DD=0: 5c 36               SB sbafix 0x02f6.4
label_2280:
0x2280 DD=0: 68 87 55            MOVB off 0x0555, R0
label_2283:
0x2283 DD=1: f8 dc dd            L A, #tbl_dddc
0x2286 DD=0: d8                  RDD
0x2287 DD=0: 48 ae 01            JBS sbaoff 0x05ee.0, label_228b
0x228a DD=0: df                  SWAP
label_228b:
...
0x2293 DD=0: 4a ad 02            JBS sbaoff 0x05ed.2, label_2298
0x2296 DD=0: ae 02               ADDB A, #0x02
label_2298:
0x2298 DD=0: 20 81 8e            MOV X1, #tbl_8e81
...
0x22a4 DD=0: 02                  RTI
tm1_vector:
0x22a5 DD=0: 5a 6f               RB sbafix 0x02ef.2
0x22a7 DD=0: f6 07               JNE label_22b0
0x22a9 DD=0: 94 2d               LB A, fix 0x022d
0x22ab DD=0: cc                  INCB A
0x22ac DD=0: f1 02               JEQ label_22b0
0x22ae DD=0: 34 2d               STB A, fix 0x022d
label_22b0:
0x22b0 DD=0: 02                  RTI
gtmc_vector:
...
0x22d8 DD=0: cb                  SC
label_22d9:
0x22d9 DD=0: b5 b2 1f            MB off 0x08b2.7, C
0x22dc DD=0: b5 b2 26 36         JBR off 0x08b2.6, label_2316
0x22e0 DD=0: 95 78               LB A, off 0x0878
0x22e2 DD=0: 9d 79               CMPB A, off 0x0879
0x22e4 DD=0: f5 0b               JGE label_22f1
0x22e6 DD=0: b5 78 c6            INCB off 0x0878
0x22e9 DD=0: 20 7c 08            MOV X1, #0x087c
0x22ec DD=0: ba 96 26            MOVB S1BUF, [X1+A]
0x22ef DD=0: 04 24               SJ label_2315
label_22f1:
0x22f1 DD=0: b5 b3 21 0b         JBR off 0x08b3.1, label_2300
0x22f5 DD=0: b5 b3 01            RB off 0x08b3.1
0x22f8 DD=0: b5 bb c7            CLRB off 0x08bb
0x22fb DD=0: b5 b2 06            RB off 0x08b2.6
0x22fe DD=0: 04 15               SJ label_2315
label_2300:
0x2300 DD=0: b7 6e 90 87 bb      MOVB off 0x08bb, tbl_906e
0x2305 DD=0: b5 b5 21 06         JBR off 0x08b5.1, label_230f
0x2309 DD=0: b5 b5 08            SB off 0x08b5.0
0x230c DD=0: b5 b5 0c            SB off 0x08b5.4
label_230f:
0x230f DD=0: b5 b2 06            RB off 0x08b2.6
0x2312 DD=0: b5 b8 c7            CLRB off 0x08b8
label_2315:
0x2315 DD=0: 02                  RTI
label_2316:
0x2316 DD=0: b5 b2 27 0d         JBR off 0x08b2.7, label_2327
0x231a DD=0: 95 bb               LB A, off 0x08bb
0x231c DD=0: f1 08               JEQ label_2326
0x231e DD=0: b5 b1 04            RB off 0x08b1.4
label_2321:
0x2321 DD=0: b7 17 90 87 b8      MOVB off 0x08b8, tbl_9017
label_2326:
0x2326 DD=0: 02                  RTI
label_2327:
0x2327 DD=0: b5 b1 29 f6         JBS off 0x08b1.1, label_2321
0x232b DD=0: b5 b9 a6 04         TJNZB off 0x08b9, label_2333
0x232f DD=0: b5 bb a7 49         TJZB off 0x08bb, label_237c
label_2333:
0x2333 DD=0: 95 b8               LB A, off 0x08b8
0x2335 DD=0: f6 10               JNE label_2347
0x2337 DD=0: d7 78 01            MOVB off 0x0878, #0x01
0x233a DD=0: 6f 87 64            MOVB off 0x0864, R7
0x233d DD=0: b5 b1 0c            SB off 0x08b1.4
0x2340 DD=0: b7 18 90 87 7a      MOVB off 0x087a, tbl_9018
0x2345 DD=0: 04 30               SJ label_2377
label_2347:
0x2347 DD=0: b5 b1 24 2c         JBR off 0x08b1.4, label_2377
0x234b DD=0: b5 78 c6            INCB off 0x0878
0x234e DD=0: 95 78               LB A, off 0x0878
0x2350 DD=0: 9d 7a               CMPB A, off 0x087a
...
0x235b DD=0: b5 b0 22 02         JBR off 0x08b0.2, label_2361
0x235f DD=0: 9e 04               CMPB A, #0x04
label_2361:
0x2361 DD=0: f6 14               JNE label_2377
0x2363 DD=0: 7f                  LB A, R7
0x2364 DD=0: 35 7a               STB A, off 0x087a
0x2366 DD=0: 8a b6 18 90         CMPCB A, tbl_9018
0x236a DD=0: f7 0b               JLE label_2377
0x236c DD=0: 04 06               SJ label_2374
label_236e:
0x236e DD=0: 6f 87 76            MOVB off 0x0876, R7
0x2371 DD=0: b5 b1 09            SB off 0x08b1.1
label_2374:
0x2374 DD=0: b5 b1 04            RB off 0x08b1.4
label_2377:
0x2377 DD=0: b7 17 90 87 b8      MOVB off 0x08b8, tbl_9017
label_237c:
0x237c DD=0: 02                  RTI
sci0_vector:
0x237d DD=0: db                  EI
...
0x2395 DD=0: 5b 33               SB sbafix 0x02f3.3
0x2397 DD=0: 59 a5 26            JBS sbafix 0x02e5.1, label_23c0
0x239a DD=0: bc 27 05            JBR A.7, label_23a2
0x239d DD=0: 34 84               STB A, fix 0x0284
0x239f DD=0: 03 28 24            J label_2428
label_23a2:
0x23a2 DD=0: 9f                  SRLB A
0x23a3 DD=0: df                  SWAP
0x23a4 DD=0: 94 84               LB A, fix 0x0284
...
0x23b1 DD=1: b4 85 97            MOVB A, fix 0x0285
0x23b4 DD=1: f1 06               JEQ label_23bc
0x23b6 DD=1: da                  DI
0x23b7 DD=0: 93                  LB A, [DP+]
0x23b8 DD=0: b2 86 85            MOVB fix 0x0285, [DP]
0x23bb DD=0: db                  EI
label_23bc:
0x23bc DD=0: d8                  RDD
...
0x23c3 DD=0: 34 84               STB A, fix 0x0284
...
0x23e1 DD=0: b2 86 85            MOVB fix 0x0285, [DP]
0x23e4 DD=0: db                  EI
label_23e5:
0x23e5 DD=0: d8                  RDD
...
0x242a DD=0: 02                  RTI
adc0_vector:
0x242b DD=0: b4 79 a6 03         TJNZB fix 0x0279, label_2432
...
0x243a DD=0: b4 7d c8            XCHGB A, fix 0x027d
0x243d DD=0: b4 7c c8            XCHGB A, fix 0x027c
0x2440 DD=0: b4 7b c8            XCHGB A, fix 0x027b
0x2443 DD=0: b4 7a c8            XCHGB A, fix 0x027a
0x2446 DD=0: dc                  DECB A
0x2447 DD=0: 34 78               STB A, fix 0x0278
0x2449 DD=0: b4 79 d6            DECB fix 0x0279
0x244c DD=0: 5d 2f               SB sbafix 0x02ef.5
0x244e DD=0: db                  EI
0x244f DD=0: 94 78               LB A, fix 0x0278
0x2451 DD=0: da                  DI
0x2452 DD=0: b6 12 ba            MBR C, P2.(AL)
0x2455 DD=0: b5 df bb            MBR off 0x03df.(AL), C
0x2458 DD=0: db                  EI
0x2459 DD=1: f8 d2 27            L A, #0x27d2
0x245c DD=1: 49 91 03            JBS sbaoff 0x03d1.1, label_2462
0x245f DD=1: f8 ab 2a            L A, #0x2aab
label_2462:
0x2462 DD=1: 9c 34               CMP A, fix 0x0234
0x2464 DD=1: b5 d1 19            MB off 0x03d1.1, C
0x2467 DD=1: fa                  CLR A
0x2468 DD=1: 59 af 47            JBS sbafix 0x02ef.1, label_24b2
0x246b DD=1: f2 0a               JLT label_2477
0x246d DD=1: da                  DI
0x246e DD=1: a4 2e 73            MOV ER3, fix 0x022e
0x2471 DD=1: b4 32 74            MOVB R4, fix 0x0232
0x2474 DD=1: db                  EI
...
0x247e DD=1: b4 2c 97            MOVB A, fix 0x022c
...
label_24b2:
0x24b2 DD=1: 34 34               ST A, fix 0x0234
0x24b4 DD=1: 38                  ST A, ER0
0x24b5 DD=1: 22 68 a0            MOV DP, #tbl_a068
0x24b8 DD=1: b4 38 74            MOVB R4, fix 0x0238
0x24bb DD=1: 15 1a               MOVB R5, #0x1a
0x24bd DD=1: 45 d6               ACAL label_11d6
0x24bf DD=1: 6c 86 38            MOVB fix 0x0238, R4
0x24c2 DD=1: 34 36               ST A, fix 0x0236
0x24c4 DD=1: 22 06 8a            MOV DP, #tbl_8a06
0x24c7 DD=1: fa                  CLR A
0x24c8 DD=0: 97 42 04            LB A, 0x0442
0x24cb DD=0: bc 8d               SLLB A, 2
0x24cd DD=0: 62 a4               ADD DP, A
label_24cf:
0x24cf DD=0: a2 90 34            CMP [DP], fix 0x0234
...
label_24dc:
0x24dc DD=0: 22 00 8a            MOV DP, #tbl_8a00
0x24df DD=0: 62 a4               ADD DP, A
label_24e1:
0x24e1 DD=0: a2 90 34            CMP [DP], fix 0x0234
...
0x24f9 DD=0: da                  DI
0x24fa DD=0: a4 3c 86 4c         MOV fix 0x024c, fix 0x023c
0x24fe DD=0: a4 44 86 4e         MOV fix 0x024e, fix 0x0244
0x2502 DD=0: a7 16 04 86 44      MOV fix 0x0244, 0x0416
0x2507 DD=0: b4 e9 13            MB C, fix 0x02e9.3
0x250a DD=0: b4 e9 1c            MB fix 0x02e9.4, C
0x250d DD=0: b4 e9 10            MB C, fix 0x02e9.0
0x2510 DD=0: b4 e9 19            MB fix 0x02e9.1, C
0x2513 DD=0: b4 e9 15            MB C, fix 0x02e9.5
0x2516 DD=0: b4 e9 1e            MB fix 0x02e9.6, C
0x2519 DD=0: 48 53               RB sbaoff 0x03d3.0
0x251b DD=0: 9a 16               MB C, PSWH.6
0x251d DD=0: fd                  CPL C
0x251e DD=0: b5 d3 1c            MB off 0x03d3.4, C
0x2521 DD=0: 49 53               RB sbaoff 0x03d3.1
0x2523 DD=0: 9a 16               MB C, PSWH.6
0x2525 DD=0: fd                  CPL C
0x2526 DD=0: b5 d3 1d            MB off 0x03d3.5, C
0x2529 DD=0: db                  EI
0x252a DD=1: 84 4c               L A, fix 0x024c
0x252c DD=1: 59 e4 31            JBR sbafix 0x02e4.1, label_2560
0x252f DD=1: 5c e9 2e            JBR sbafix 0x02e9.4, label_2560
0x2532 DD=1: fa                  CLR A
0x2533 DD=1: b4 78 97            MOVB A, fix 0x0278
0x2536 DD=1: 3c                  ST A, X1
0x2537 DD=0: 98 5f 80            LB A, tbl_805f[X1]
0x253a DD=0: b8 46 04 85         SUBB A, 0x0446[X1]
0x253e DD=0: f5 01               JGE label_2541
0x2540 DD=0: fb                  CLRB A
label_2541:
0x2541 DD=0: 34 52               STB A, fix 0x0252
0x2543 DD=1: fc                  EXTND
0x2544 DD=1: a4 4e a9            MUL fix 0x024e
...
0x2554 DD=1: ac 4c               ADD A, fix 0x024c
...
label_2560:
0x2560 DD=1: 34 50               ST A, fix 0x0250
0x2562 DD=1: 38                  ST A, ER0
0x2563 DD=1: 22 20 a0            MOV DP, #tbl_a020
0x2566 DD=1: b4 53 74            MOVB R4, fix 0x0253
0x2569 DD=1: 15 12               MOVB R5, #0x12
0x256b DD=1: 45 d6               ACAL label_11d6
0x256d DD=1: 6c 86 53            MOVB fix 0x0253, R4
0x2570 DD=1: 34 54               ST A, fix 0x0254
0x2572 DD=1: fa                  CLR A
0x2573 DD=0: 94 78               LB A, fix 0x0278
0x2575 DD=0: 8f                  SLLB A
0x2576 DD=0: 60 aa               MOV X1, A
0x2578 DD=1: f8 8e 01            L A, #0x018e
0x257b DD=1: 58 94 14            JBS sbafix 0x02d4.0, label_2592
0x257e DD=1: 59 94 11            JBS sbafix 0x02d4.1, label_2592
...
label_2592:
0x2592 DD=1: 58 50               RB sbafix 0x02d0.0
0x2594 DD=1: 34 56               ST A, fix 0x0256
0x2596 DD=1: 04 04               SJ label_259c
label_2598:
0x2598 DD=1: 58 10               SB sbafix 0x02d0.0
0x259a DD=1: 84 56               L A, fix 0x0256
label_259c:
0x259c DD=1: c8 58 02            ST A, 0x0258[X1]
0x259f DD=1: 38                  ST A, ER0
0x25a0 DD=1: 22 44 a0            MOV DP, #tbl_a044
0x25a3 DD=1: b4 62 74            MOVB R4, fix 0x0262
0x25a6 DD=1: 15 12               MOVB R5, #0x12
0x25a8 DD=1: 45 d6               ACAL label_11d6
0x25aa DD=1: 6c 86 62            MOVB fix 0x0262, R4
0x25ad DD=1: 34 60               ST A, fix 0x0260
0x25af DD=1: fa                  CLR A
0x25b0 DD=1: ca                  RC
0x25b1 DD=1: 58 e4 1e            JBR sbafix 0x02e4.0, label_25d2
0x25b4 DD=1: 58 a6 21            JBS sbafix 0x02e6.0, label_25d8
0x25b7 DD=0: 94 d6               LB A, fix 0x02d6
...
label_25d0:
0x25d0 DD=1: 84 64               L A, fix 0x0264
label_25d2:
0x25d2 DD=1: b4 d1 18            MB fix 0x02d1.0, C
0x25d5 DD=1: 03 21 26            J label_2621
label_25d8:
0x25d8 DD=0: 94 d4               LB A, fix 0x02d4
...
label_25e8:
0x25e8 DD=0: a4 4c 70            MOV ER0, fix 0x024c
0x25eb DD=0: b4 6c 74            MOVB R4, fix 0x026c
0x25ee DD=0: 15 08               MOVB R5, #0x08
0x25f0 DD=0: 22 a4 eb            MOV DP, #tbl_eba4
0x25f3 DD=0: 45 d6               ACAL label_11d6
0x25f5 DD=0: 34 68               STB A, fix 0x0268
0x25f7 DD=0: 6c 86 6c            MOVB fix 0x026c, R4
0x25fa DD=0: 22 90 eb            MOV DP, #tbl_eb90
0x25fd DD=0: a4 34 70            MOV ER0, fix 0x0234
0x2600 DD=0: b4 6d 74            MOVB R4, fix 0x026d
0x2603 DD=0: 15 0a               MOVB R5, #0x0a
0x2605 DD=0: 45 d6               ACAL label_11d6
0x2607 DD=0: 6c 86 6d            MOVB fix 0x026d, R4
0x260a DD=0: 34 6a               STB A, fix 0x026a
0x260c DD=0: 3c                  STB A, R4
0x260d DD=0: 7c                  LB A, R4
0x260e DD=0: b4 6c 71            MOVB R1, fix 0x026c
0x2611 DD=0: 16 08               MOVB R6, #0x08
0x2613 DD=0: a4 68 72            MOV ER2, fix 0x0268
0x2616 DD=0: 22 b4 eb            MOV DP, #tbl_ebb4
0x2619 DD=0: 46 56               ACAL label_1256
0x261b DD=0: 34 66               STB A, fix 0x0266
0x261d DD=0: 4f 18               SB sbaoff 0x03d8.7
label_261f:
0x261f DD=0: 58 51               RB sbafix 0x02d1.0
label_2621:
0x2621 DD=0: 34 64               STB A, fix 0x0264
...
0x262a DD=0: d8                  RDD
0x262b DD=0: 34 63               STB A, fix 0x0263
0x262d DD=0: b7 53 06 85         SUBB A, 0x0653
0x2631 DD=0: da                  DI
0x2632 DD=0: b5 d8 1c            MB off 0x03d8.4, C
0x2635 DD=0: f5 01               JGE label_2638
0x2637 DD=0: cf                  NEGB A
label_2638:
0x2638 DD=0: 35 54               STB A, off 0x0354
0x263a DD=0: db                  EI
0x263b DD=0: b4 f0 13            MB C, fix 0x02f0.3
0x263e DD=0: b4 f0 1c            MB fix 0x02f0.4, C
...
label_264c:
0x264c DD=1: 9c 4c               CMP A, fix 0x024c
0x264e DD=1: b4 f0 1b            MB fix 0x02f0.3, C
...
label_2669:
0x2669 DD=1: 9c 34               CMP A, fix 0x0234
0x266b DD=1: b7 ea 05 1b         MB 0x05ea.3, C
0x266f DD=1: b4 f0 11            MB C, fix 0x02f0.1
0x2672 DD=1: b4 f0 1a            MB fix 0x02f0.2, C
0x2675 DD=1: f5 04               JGE label_267b
0x2677 DD=1: 66 73               MOV ER3, ER2
0x2679 DD=1: 64 71               MOV ER1, ER0
label_267b:
0x267b DD=1: 67 90 34            CMP ER3, fix 0x0234
0x267e DD=1: f2 03               JLT label_2683
0x2680 DD=1: 65 90 4c            CMP ER1, fix 0x024c
label_2683:
0x2683 DD=1: fd                  CPL C
0x2684 DD=1: b4 f0 19            MB fix 0x02f0.1, C
0x2687 DD=1: 5b e2 38            JBR sbafix 0x02e2.3, label_26c2
0x268a DD=1: 22 aa 80            MOV DP, #tbl_80aa
0x268d DD=1: 5a f1 03            JBR sbafix 0x02f1.2, label_2693
0x2690 DD=1: 22 30 84            MOV DP, #tbl_8430
label_2693:
0x2693 DD=1: 84 34               L A, fix 0x0234
...
label_269d:
0x269d DD=1: 6c 87 76            MOVB off 0x0376, R4
0x26a0 DD=1: 6c 70               MOVB R0, R4
0x26a2 DD=1: 68 8c               SLLB R0, 1
0x26a4 DD=1: 20 c6 80            MOV X1, #tbl_80c6
0x26a7 DD=1: ab 97               MOV A, [X1+R0]
0x26a9 DD=1: 9c 64               CMP A, fix 0x0264
0x26ab DD=1: 9a 56               BOR C, PSWH.6
0x26ad DD=1: b5 d5 18            MB off 0x03d5.0, C
0x26b0 DD=0: 94 78               LB A, fix 0x0278
0x26b2 DD=0: b7 c5 04 b8         SBR 0x04c5.(AL)
0x26b6 DD=0: 95 d2               LB A, off 0x03d2
0x26b8 DD=0: be 30               ANDB A, #0x30
0x26ba DD=0: f6 06               JNE label_26c2
0x26bc DD=0: 95 d3               LB A, off 0x03d3
0x26be DD=0: be 30               ANDB A, #0x30
0x26c0 DD=0: f1 03               JEQ label_26c5
label_26c2:
0x26c2 DD=0: 03 35 27            J label_2735
label_26c5:
0x26c5 DD=0: 22 88 80            MOV DP, #tbl_8088
0x26c8 DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_26ce
0x26cb DD=0: 22 12 84            MOV DP, #tbl_8412
label_26ce:
0x26ce DD=0: 6f c7               CLRB R7
0x26d0 DD=0: a5 68 74            MOV X1, off 0x0368
0x26d3 DD=0: 8b 04 90 34         CMP 4[DP], fix 0x0234
0x26d7 DD=0: f0 18               JGT label_26f1
0x26d9 DD=0: 8b 06 90 34         CMP 6[DP], fix 0x0234
0x26dd DD=0: f2 12               JLT label_26f1
0x26df DD=0: 20 1e 83            MOV X1, #tbl_831e
0x26e2 DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_26e8
0x26e5 DD=0: 20 84 86            MOV X1, #tbl_8684
label_26e8:
0x26e8 DD=0: f9 1e               LB A, #0x1e
0x26ea DD=0: b5 76 a9            MULB off 0x0376
0x26ed DD=0: 60 a4               ADD X1, A
0x26ef DD=0: 6f 09               SB R7.1
label_26f1:
0x26f1 DD=0: a5 6a 75            MOV X2, off 0x036a
0x26f4 DD=0: a2 90 34            CMP [DP], fix 0x0234
0x26f7 DD=0: f0 26               JGT label_271f
0x26f9 DD=0: 8b 02 90 34         CMP 2[DP], fix 0x0234
0x26fd DD=0: f2 20               JLT label_271f
0x26ff DD=0: 21 ae 81            MOV X2, #tbl_81ae
0x2702 DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_2708
0x2705 DD=0: 21 24 85            MOV X2, #tbl_8524
label_2708:
0x2708 DD=0: f9 2e               LB A, #0x2e
0x270a DD=0: b5 76 a9            MULB off 0x0376
0x270d DD=0: 61 a4               ADD X2, A
0x270f DD=0: 6f 08               SB R7.0
0x2711 DD=0: 24 59 8c            MOV ER0, #tbl_8c59
0x2714 DD=0: f9 05               LB A, #0x05
0x2716 DD=0: b5 76 a9            MULB off 0x0376
0x2719 DD=0: 64 a4               ADD ER0, A
0x271b DD=0: 64 9b 3e 05         MOV 0x053e, ER0
label_271f:
0x271f DD=0: da                  DI
0x2720 DD=0: 95 d3               LB A, off 0x03d3
0x2722 DD=0: be 03               ANDB A, #0x03
0x2724 DD=0: f6 0e               JNE label_2734
0x2726 DD=0: 60 87 68            MOV off 0x0368, X1
0x2729 DD=0: 61 87 6a            MOV off 0x036a, X2
0x272c DD=0: 7f                  LB A, R7
0x272d DD=0: b5 d2 b3 f8         ANDB off 0x03d2, #0xf8
0x2731 DD=0: b5 d2 c4            OR off 0x03d2, A
label_2734:
0x2734 DD=0: db                  EI
label_2735:
0x2735 DD=0: 58 af 06            JBS sbafix 0x02ef.0, label_273e
0x2738 DD=0: 59 a8 06            JBS sbafix 0x02e8.1, label_2741
0x273b DD=0: 5d a8 03            JBS sbafix 0x02e8.5, label_2741
label_273e:
0x273e DD=0: 03 72 30            J label_3072
label_2741:
0x2741 DD=0: 5b ef 44            JBR sbafix 0x02ef.3, label_2788
0x2744 DD=0: 22 00 80            MOV DP, #0x8000
0x2747 DD=0: 44 2c               ACAL label_102c
0x2749 DD=0: 35 00               STB A, off 0x0300
0x274b DD=0: b5 4e 71            MOVB R1, off 0x034e
...
label_275a:
0x275a DD=1: 35 02               ST A, off 0x0302
...
0x2763 DD=1: 4a 11               SB sbaoff 0x03d1.2
0x2765 DD=1: 22 27 80            MOV DP, #tbl_8027
0x2768 DD=1: 44 2c               ACAL label_102c
0x276a DD=1: 35 06               ST A, off 0x0306
0x276c DD=1: b5 05 c7            CLRB off 0x0305
...
0x27b5 DD=1: 4a 51               RB sbaoff 0x03d1.2
label_27b7:
0x27b7 DD=1: f8 00 20            L A, #0x2000
label_27ba:
0x27ba DD=1: 35 06               ST A, off 0x0306
0x27bc DD=1: 59 e5 08            JBR sbafix 0x02e5.1, label_27c7
0x27bf DD=1: 59 f3 05            JBR sbafix 0x02f3.1, label_27c7
0x27c2 DD=1: 5b f4 0d            JBR sbafix 0x02f4.3, label_27d2
0x27c5 DD=1: 04 03               SJ label_27ca
label_27c7:
0x27c7 DD=1: 5a e5 08            JBR sbafix 0x02e5.2, label_27d2
label_27ca:
0x27ca DD=1: b4 f4 12            MB C, fix 0x02f4.2
0x27cd DD=1: b4 f0 18            MB fix 0x02f0.0, C
0x27d0 DD=1: 04 29               SJ label_27fb
label_27d2:
0x27d2 DD=0: 94 d4               LB A, fix 0x02d4
0x27d4 DD=0: be 03               ANDB A, #0x03
0x27d6 DD=0: f6 17               JNE label_27ef
0x27d8 DD=0: 22 3d 80            MOV DP, #tbl_803d
0x27db DD=1: 84 34               L A, fix 0x0234
0x27dd DD=1: 44 a3               ACAL label_10a3
0x27df DD=1: 58 b0 11            JBS sbafix 0x02f0.0, label_27f3
0x27e2 DD=1: ae 04 00            ADD A, #0x0004
0x27e5 DD=1: f5 02               JGE label_27e9
0x27e7 DD=1: bc d7               FILL A
label_27e9:
0x27e9 DD=1: 35 0c               ST A, off 0x030c
0x27eb DD=1: 9c 4c               CMP A, fix 0x024c
0x27ed DD=1: f5 0c               JGE label_27fb
label_27ef:
0x27ef DD=1: 58 30               SB sbafix 0x02f0.0
0x27f1 DD=1: 04 08               SJ label_27fb
label_27f3:
0x27f3 DD=1: 35 0c               ST A, off 0x030c
0x27f5 DD=1: 9c 4c               CMP A, fix 0x024c
0x27f7 DD=1: f7 02               JLE label_27fb
0x27f9 DD=1: 58 70               RB sbafix 0x02f0.0
label_27fb:
0x27fb DD=1: fa                  CLR A
0x27fc DD=0: 94 78               LB A, fix 0x0278
0x27fe DD=0: 61 aa               MOV X2, A
0x2800 DD=1: f8 a8 03            L A, #0x03a8
0x2803 DD=1: 61 a9               MUL X2
0x2805 DD=1: 74                  L A, ER0
0x2806 DD=1: 58 b0 0d            JBS sbafix 0x02f0.0, label_2816
0x2809 DD=1: 22 10 b1            MOV DP, #tbl_b110
0x280c DD=1: 62 a4               ADD DP, A
0x280e DD=1: b4 62 71            MOVB R1, fix 0x0262
0x2811 DD=1: a4 60 72            MOV ER2, fix 0x0260
0x2814 DD=1: 04 0b               SJ label_2821
label_2816:
0x2816 DD=1: 22 50 ce            MOV DP, #tbl_ce50
0x2819 DD=1: 62 a4               ADD DP, A
0x281b DD=1: b4 3f 71            MOVB R1, fix 0x023f
0x281e DD=1: a4 40 72            MOV ER2, fix 0x0240
label_2821:
0x2821 DD=0: 94 38               LB A, fix 0x0238
0x2823 DD=0: a4 36 74            MOV X1, fix 0x0236
...
0x2835 DD=0: 94 78               LB A, fix 0x0278
...
0x2847 DD=0: 58 b0 14            JBS sbafix 0x02f0.0, label_285e
0x284a DD=0: b7 16 06 75         MOVB R5, 0x0616
0x284e DD=0: a7 12 06 73         MOV ER3, 0x0612
0x2852 DD=0: d4 70 00            CMPB fix 0x0270, #0x00
0x2855 DD=0: f5 07               JGE label_285e
0x2857 DD=0: 59 f0 04            JBR sbafix 0x02f0.1, label_285e
...
0x2898 DD=1: 22 10 b1            MOV DP, #tbl_b110
0x289b DD=1: b4 62 71            MOVB R1, fix 0x0262
0x289e DD=1: a4 60 72            MOV ER2, fix 0x0260
0x28a1 DD=1: 58 f0 09            JBR sbafix 0x02f0.0, label_28ad
0x28a4 DD=1: 22 50 ce            MOV DP, #tbl_ce50
0x28a7 DD=1: b4 3f 71            MOVB R1, fix 0x023f
0x28aa DD=1: a4 40 72            MOV ER2, fix 0x0240
label_28ad:
0x28ad DD=0: 94 38               LB A, fix 0x0238
0x28af DD=0: a4 36 74            MOV X1, fix 0x0236
0x28b2 DD=0: 16 12               MOVB R6, #0x12
0x28b4 DD=0: 46 56               ACAL label_1256
0x28b6 DD=0: 35 16               STB A, off 0x0316
0x28b8 DD=0: 5b e2 11            JBR sbafix 0x02e2.3, label_28cc
0x28bb DD=0: 5d e2 05            JBR sbafix 0x02e2.5, label_28c3
0x28be DD=0: b7 c2 06 2d 09      JBS 0x06c2.5, label_28cc
label_28c3:
0x28c3 DD=0: 59 a9 10            JBS sbafix 0x02e9.1, label_28d6
0x28c6 DD=0: a5 70 c7            CLR off 0x0370
0x28c9 DD=0: a5 72 c7            CLR off 0x0372
label_28cc:
0x28cc DD=0: b5 8d c7            CLRB off 0x038d
0x28cf DD=0: 4b 52               RB sbaoff 0x03d2.3
0x28d1 DD=0: 4b 53               RB sbaoff 0x03d3.3
0x28d3 DD=0: 03 dc 2a            J label_2adc
label_28d6:
0x28d6 DD=0: 68 c7               CLRB R0
0x28d8 DD=0: 22 82 80            MOV DP, #tbl_8082
0x28db DD=0: 5c e9 14            JBR sbafix 0x02e9.4, label_28f2
0x28de DD=1: 84 4e               L A, fix 0x024e
...
0x28f3 DD=0: b5 70 c8            XCHGB A, off 0x0370
0x28f6 DD=0: 68 a4               ADDB R0, A
0x28f8 DD=0: b5 71 c8            XCHGB A, off 0x0371
0x28fb DD=0: 68 a4               ADDB R0, A
0x28fd DD=0: b5 72 c8            XCHGB A, off 0x0372
0x2900 DD=0: 68 a4               ADDB R0, A
0x2902 DD=0: 35 73               STB A, off 0x0373
0x2904 DD=0: 68 87 74            MOVB off 0x0374, R0
0x2907 DD=0: 68 93 04            CMPB R0, #0x04
0x290a DD=0: fd                  CPL C
0x290b DD=0: b5 d2 1b            MB off 0x03d2.3, C
0x290e DD=0: 4d 93 29            JBS sbaoff 0x03d3.5, label_293a
0x2911 DD=0: 4c d3 13            JBR sbaoff 0x03d3.4, label_2927
0x2914 DD=0: 4b 13               SB sbaoff 0x03d3.3
0x2916 DD=0: 4c 12               SB sbaoff 0x03d2.4
0x2918 DD=0: a5 7c c7            CLR off 0x037c
0x291b DD=0: b5 75 c7            CLRB off 0x0375
0x291e DD=0: a5 78 87 7a         MOV off 0x037a, off 0x0378
0x2922 DD=0: a5 6a 76            MOV DP, off 0x036a
0x2925 DD=0: 04 1f               SJ label_2946
label_2927:
0x2927 DD=0: 95 d2               LB A, off 0x03d2
0x2929 DD=0: be 30               ANDB A, #0x30
0x292b DD=0: f6 23               JNE label_2950
0x292d DD=0: 4b d2 20            JBR sbaoff 0x03d2.3, label_2950
0x2930 DD=0: da                  DI
0x2931 DD=0: 95 d3               LB A, off 0x03d3
0x2933 DD=0: be 03               ANDB A, #0x03
0x2935 DD=0: f6 19               JNE label_2950
0x2937 DD=0: 49 d2 16            JBR sbaoff 0x03d2.1, label_2950
label_293a:
0x293a DD=0: 4d 12               SB sbaoff 0x03d2.5
0x293c DD=0: a5 7c c7            CLR off 0x037c
0x293f DD=0: a5 78 87 7a         MOV off 0x037a, off 0x0378
0x2943 DD=0: a5 68 76            MOV DP, off 0x0368
label_2946:
0x2946 DD=0: 62 a3 04 00         ADD DP, #0x0004
0x294a DD=0: 62 87 6c            MOV off 0x036c, DP
0x294d DD=0: d7 8b 04            MOVB off 0x038b, #0x04
label_2950:
0x2950 DD=0: db                  EI
0x2951 DD=0: 4d 92 03            JBS sbaoff 0x03d2.5, label_2957
0x2954 DD=0: 03 b3 29            J label_29b3
label_2957:
0x2957 DD=1: 84 4e               L A, fix 0x024e
0x2959 DD=1: 5c a9 09            JBS sbafix 0x02e9.4, label_2965
0x295c DD=1: a7 9a 80 95         CMP A, tbl_809a
0x2960 DD=1: f7 1c               JLE label_297e
0x2962 DD=1: 03 dc 2a            J label_2adc
label_2965:
0x2965 DD=1: 5e a9 16            JBS sbafix 0x02e9.6, label_297e
0x2968 DD=1: 4b d2 13            JBR sbaoff 0x03d2.3, label_297e
0x296b DD=1: a7 82 80 95         CMP A, tbl_8082
0x296f DD=1: f2 0d               JLT label_297e
0x2971 DD=1: 87 96 80            L A, tbl_8096
0x2974 DD=1: 5a f1 03            JBR sbafix 0x02f1.2, label_297a
0x2977 DD=1: 87 20 84            L A, tbl_8420
label_297a:
0x297a DD=1: 9c 34               CMP A, fix 0x0234
0x297c DD=1: f5 07               JGE label_2985
label_297e:
0x297e DD=1: b5 8b a6 25         TJNZB off 0x038b, label_29a7
0x2982 DD=1: 03 97 2a            J label_2a97
label_2985:
0x2985 DD=1: a5 6c 76            MOV DP, off 0x036c
0x2988 DD=0: 99 12               LB A, 18[DP]
0x298a DD=0: 35 8a               STB A, off 0x038a
0x298c DD=0: 35 86               STB A, off 0x0386
0x298e DD=0: 35 87               STB A, off 0x0387
0x2990 DD=0: 35 88               STB A, off 0x0388
0x2992 DD=0: 35 89               STB A, off 0x0389
0x2994 DD=1: 72                  L A, DP
0x2995 DD=1: ae 13 00            ADD A, #0x0013
0x2998 DD=1: 35 6e               ST A, off 0x036e
0x299a DD=1: 84 4e               L A, fix 0x024e
0x299c DD=1: 44 a3               ACAL label_10a3
0x299e DD=1: a5 7a a9            MUL off 0x037a
0x29a1 DD=1: 10 04               MOVB R0, #0x04
0x29a3 DD=1: 46 c5               ACAL label_12c5
0x29a5 DD=1: 35 7c               ST A, off 0x037c
label_29a7:
0x29a7 DD=0: 95 8b               LB A, off 0x038b
0x29a9 DD=0: f1 03               JEQ label_29ae
0x29ab DD=0: b5 8b d6            DECB off 0x038b
label_29ae:
0x29ae DD=1: 85 7c               L A, off 0x037c
0x29b0 DD=1: 03 6b 2a            J label_2a6b
label_29b3:
0x29b3 DD=0: 4c 92 03            JBS sbaoff 0x03d2.4, label_29b9
0x29b6 DD=0: 03 dc 2a            J label_2adc
label_29b9:
0x29b9 DD=0: 4b d3 51            JBR sbaoff 0x03d3.3, label_2a0d
0x29bc DD=0: a5 6c 74            MOV X1, off 0x036c
0x29bf DD=0: 95 75               LB A, off 0x0375
0x29c1 DD=0: b5 75 c6            INCB off 0x0375
...
0x29d2 DD=0: 35 8a               STB A, off 0x038a
0x29d4 DD=0: 35 86               STB A, off 0x0386
0x29d6 DD=0: 35 87               STB A, off 0x0387
0x29d8 DD=0: 35 88               STB A, off 0x0388
0x29da DD=0: 35 89               STB A, off 0x0389
0x29dc DD=0: 60 a3 09 00         ADD X1, #0x0009
0x29e0 DD=0: 60 87 6e            MOV off 0x036e, X1
0x29e3 DD=0: 5c e9 16            JBR sbafix 0x02e9.4, label_29fc
0x29e6 DD=0: 4b d2 13            JBR sbaoff 0x03d2.3, label_29fc
0x29e9 DD=1: 84 4e               L A, fix 0x024e
0x29eb DD=1: a7 9c 80 95         CMP A, tbl_809c
0x29ef DD=1: f2 0b               JLT label_29fc
0x29f1 DD=1: a5 6c 76            MOV DP, off 0x036c
...
label_2a00:
0x2a00 DD=0: d7 8f 02            MOVB off 0x038f, #0x02
0x2a03 DD=0: d7 8d 28            MOVB off 0x038d, #0x28
0x2a06 DD=0: 4b 53               RB sbaoff 0x03d3.3
0x2a08 DD=0: a5 6c a3 10 00      ADD off 0x036c, #0x0010
label_2a0d:
0x2a0d DD=1: 84 4e               L A, fix 0x024e
0x2a0f DD=1: 5c a9 0c            JBS sbafix 0x02e9.4, label_2a1e
0x2a12 DD=1: a7 9a 80 95         CMP A, tbl_809a
0x2a16 DD=1: f7 1f               JLE label_2a37
0x2a18 DD=1: b5 8d c7            CLRB off 0x038d
0x2a1b DD=1: 03 dc 2a            J label_2adc
label_2a1e:
0x2a1e DD=1: 5e a9 16            JBS sbafix 0x02e9.6, label_2a37
0x2a21 DD=1: 4b d2 13            JBR sbaoff 0x03d2.3, label_2a37
0x2a24 DD=1: a7 82 80 95         CMP A, tbl_8082
0x2a28 DD=1: f2 0d               JLT label_2a37
0x2a2a DD=1: 87 94 80            L A, tbl_8094
0x2a2d DD=1: 5a f1 03            JBR sbafix 0x02f1.2, label_2a33
0x2a30 DD=1: 87 1e 84            L A, tbl_841e
label_2a33:
0x2a33 DD=1: 9c 34               CMP A, fix 0x0234
0x2a35 DD=1: f5 07               JGE label_2a3e
label_2a37:
0x2a37 DD=1: b5 8b a6 27         TJNZB off 0x038b, label_2a62
...
0x2a47 DD=0: 35 86               STB A, off 0x0386
0x2a49 DD=0: 35 87               STB A, off 0x0387
0x2a4b DD=0: 35 88               STB A, off 0x0388
0x2a4d DD=0: 35 89               STB A, off 0x0389
0x2a4f DD=1: 72                  L A, DP
0x2a50 DD=1: ae 13 00            ADD A, #0x0013
0x2a53 DD=1: 35 6e               ST A, off 0x036e
0x2a55 DD=1: 84 4e               L A, fix 0x024e
0x2a57 DD=1: 44 a3               ACAL label_10a3
label_2a59:
0x2a59 DD=1: a5 7a a9            MUL off 0x037a
0x2a5c DD=1: 10 04               MOVB R0, #0x04
0x2a5e DD=1: 46 c5               ACAL label_12c5
0x2a60 DD=1: 35 7c               ST A, off 0x037c
label_2a62:
0x2a62 DD=0: 95 8b               LB A, off 0x038b
0x2a64 DD=0: f1 03               JEQ label_2a69
0x2a66 DD=0: b5 8b d6            DECB off 0x038b
label_2a69:
0x2a69 DD=1: 85 7c               L A, off 0x037c
label_2a6b:
0x2a6b DD=1: 60 c7               CLR X1
0x2a6d DD=1: 60 c8               XCHG A, X1
0x2a6f DD=1: b4 78 97            MOVB A, fix 0x0278
0x2a72 DD=1: 8f                  SLL A
0x2a73 DD=1: 60 c8               XCHG A, X1
0x2a75 DD=1: a8 16 03 70         MOV ER0, 0x0316[X1]
0x2a79 DD=1: 64 a9               MUL ER0
0x2a7b DD=1: a5 16 fb            DIVQ off 0x0316
0x2a7e DD=1: 9a 21 02            JBR PSWH.1, label_2a83
0x2a81 DD=1: bc d7               FILL A
label_2a83:
0x2a83 DD=1: 4b 93 0b            JBS sbaoff 0x03d3.3, label_2a91
...
0x2a98 DD=0: 94 78               LB A, fix 0x0278
...
0x2aa4 DD=1: a5 6e 76            MOV DP, off 0x036e
...
0x2ac4 DD=1: b5 8a 99 86 03      MOVB 0x0386[X2], off 0x038a
...
0x2ad2 DD=1: cd 7e               OR A, off 0x037e
0x2ad4 DD=1: cd 80               OR A, off 0x0380
0x2ad6 DD=1: cd 82               OR A, off 0x0382
0x2ad8 DD=1: cd 84               OR A, off 0x0384
0x2ada DD=1: f6 13               JNE label_2aef
label_2adc:
0x2adc DD=1: fa                  CLR A
0x2add DD=1: 35 7c               ST A, off 0x037c
0x2adf DD=1: 35 7e               ST A, off 0x037e
0x2ae1 DD=1: 35 80               ST A, off 0x0380
0x2ae3 DD=1: 35 82               ST A, off 0x0382
0x2ae5 DD=1: 35 84               ST A, off 0x0384
0x2ae7 DD=1: 4d 52               RB sbaoff 0x03d2.5
0x2ae9 DD=1: b5 8d a6 02         TJNZB off 0x038d, label_2aef
0x2aed DD=1: 4c 52               RB sbaoff 0x03d2.4
label_2aef:
0x2aef DD=0: 94 70               LB A, fix 0x0270
0x2af1 DD=0: 9e a1               CMPB A, #0xa1
0x2af3 DD=0: b5 d8 1a            MB off 0x03d8.2, C
0x2af6 DD=0: 9e 58               CMPB A, #0x58
0x2af8 DD=0: b5 d8 1b            MB off 0x03d8.3, C
0x2afb DD=0: 58 a2 21            JBS sbafix 0x02e2.0, label_2b1f
0x2afe DD=0: 20 64 87            MOV X1, #tbl_8764
0x2b01 DD=0: 4b 98 09            JBS sbaoff 0x03d8.3, label_2b0d
0x2b04 DD=0: 20 6c 87            MOV X1, #tbl_876c
0x2b07 DD=0: 4a 98 03            JBS sbaoff 0x03d8.2, label_2b0d
0x2b0a DD=0: 20 74 87            MOV X1, #tbl_8774
label_2b0d:
0x2b0d DD=1: 80                  L A, [X1]
0x2b0e DD=1: 49 90 03            JBS sbaoff 0x03d0.1, label_2b14
...
label_2b1f:
0x2b1f DD=0: 20 7c 87            MOV X1, #tbl_877c
0x2b22 DD=0: 4b 98 09            JBS sbaoff 0x03d8.3, label_2b2e
0x2b25 DD=0: 20 84 87            MOV X1, #tbl_8784
0x2b28 DD=0: 4a 98 03            JBS sbaoff 0x03d8.2, label_2b2e
0x2b2b DD=0: 20 8c 87            MOV X1, #tbl_878c
label_2b2e:
0x2b2e DD=1: 84 34               L A, fix 0x0234
0x2b30 DD=1: 38                  ST A, ER0
0x2b31 DD=1: 8d 62               SUB A, off 0x0362
0x2b33 DD=1: 64 87 62            MOV off 0x0362, ER0
...
0x2b47 DD=1: 35 64               ST A, off 0x0364
0x2b49 DD=1: 9c 34               CMP A, fix 0x0234
0x2b4b DD=1: b5 d0 19            MB off 0x03d0.1, C
0x2b4e DD=1: f2 07               JLT label_2b57
0x2b50 DD=1: a7 94 87 90 34      CMP tbl_8794, fix 0x0234
0x2b55 DD=1: f7 11               JLE label_2b68
label_2b57:
0x2b57 DD=1: fd                  CPL C
0x2b58 DD=1: bc d7               FILL A
0x2b5a DD=1: 4a 50               RB sbaoff 0x03d0.2
0x2b5c DD=1: f2 2e               JLT label_2b8c
0x2b5e DD=1: 59 e2 01            JBR sbafix 0x02e2.1, label_2b62
0x2b61 DD=1: fd                  CPL C
label_2b62:
0x2b62 DD=1: b5 d7 1f            MB off 0x03d7.7, C
0x2b65 DD=1: ca                  RC
0x2b66 DD=1: 04 24               SJ label_2b8c
label_2b68:
0x2b68 DD=1: 4a 90 1c            JBS sbaoff 0x03d0.2, label_2b87
0x2b6b DD=1: 87 96 87            L A, tbl_8796
0x2b6e DD=1: 6d c7               CLRB R5
0x2b70 DD=1: b4 78 74            MOVB R4, fix 0x0278
0x2b73 DD=1: 66 74               MOV X1, ER2
0x2b75 DD=1: b8 98 87 74         MOVB R4, tbl_8798[X1]
...
label_2b83:
0x2b83 DD=1: 35 60               ST A, off 0x0360
0x2b85 DD=1: 4a 10               SB sbaoff 0x03d0.2
label_2b87:
0x2b87 DD=1: 85 60               L A, off 0x0360
0x2b89 DD=1: bc 10               MB C, A.0
0x2b8b DD=1: bf                  ROR A
label_2b8c:
0x2b8c DD=1: 35 60               ST A, off 0x0360
0x2b8e DD=1: fd                  CPL C
0x2b8f DD=1: b5 d0 18            MB off 0x03d0.0, C
0x2b92 DD=1: 5a e2 1c            JBR sbafix 0x02e2.2, label_2bb1
0x2b95 DD=1: b5 d0 13            MB C, off 0x03d0.3
0x2b98 DD=1: b5 d0 1c            MB off 0x03d0.4, C
0x2b9b DD=1: 5c 94 13            JBS sbafix 0x02d4.4, label_2bb1
0x2b9e DD=1: 59 a9 10            JBS sbafix 0x02e9.1, label_2bb1
0x2ba1 DD=1: 84 34               L A, fix 0x0234
0x2ba3 DD=1: 9e ff ff            CMP A, #tbl_ffff
0x2ba6 DD=1: f0 09               JGT label_2bb1
0x2ba8 DD=1: 9e ff ff            CMP A, #tbl_ffff
0x2bab DD=1: f2 04               JLT label_2bb1
0x2bad DD=1: 4b 10               SB sbaoff 0x03d0.3
0x2baf DD=1: 04 02               SJ label_2bb3
label_2bb1:
0x2bb1 DD=1: 4b 50               RB sbaoff 0x03d0.3
label_2bb3:
0x2bb3 DD=1: ca                  RC
0x2bb4 DD=1: 59 97 1f            JBS sbafix 0x02d7.1, label_2bd6
0x2bb7 DD=1: 58 97 08            JBS sbafix 0x02d7.0, label_2bc2
0x2bba DD=1: 5b dc 0a            JBR sbafix 0x02dc.3, label_2bc7
0x2bbd DD=1: b5 93 a6 1c         TJNZB off 0x0393, label_2bdd
0x2bc1 DD=1: cb                  SC
label_2bc2:
0x2bc2 DD=1: b4 d1 1b            MB fix 0x02d1.3, C
0x2bc5 DD=1: 04 12               SJ label_2bd9
label_2bc7:
0x2bc7 DD=1: d7 93 14            MOVB off 0x0393, #0x14
0x2bca DD=0: f9 0c               LB A, #0x0c
0x2bcc DD=0: 9c a2               CMPB A, fix 0x02a2
0x2bce DD=0: f5 0d               JGE label_2bdd
0x2bd0 DD=0: 94 6f               LB A, fix 0x026f
0x2bd2 DD=0: 9e 1f               CMPB A, #0x1f
0x2bd4 DD=0: f5 07               JGE label_2bdd
label_2bd6:
0x2bd6 DD=0: b4 d1 1d            MB fix 0x02d1.5, C
label_2bd9:
0x2bd9 DD=0: b7 c2 06 09         SB 0x06c2.1
label_2bdd:
0x2bdd DD=0: 58 e4 31            JBR sbafix 0x02e4.0, label_2c11
0x2be0 DD=0: cb                  SC
0x2be1 DD=0: 5f 96 27            JBS sbafix 0x02d6.7, label_2c0b
0x2be4 DD=0: 22 a8 87            MOV DP, #tbl_87a8
0x2be7 DD=1: 84 34               L A, fix 0x0234
0x2be9 DD=1: 44 a3               ACAL label_10a3
0x2beb DD=1: 64 c7               CLR ER0
0x2bed DD=1: b5 57 70            MOVB R0, off 0x0357
0x2bf0 DD=1: 64 8c               SLL ER0, 1
0x2bf2 DD=1: 08                  SUB A, ER0
0x2bf3 DD=1: f5 01               JGE label_2bf6
0x2bf5 DD=1: fa                  CLR A
label_2bf6:
0x2bf6 DD=1: 35 58               ST A, off 0x0358
0x2bf8 DD=1: 9c 64               CMP A, fix 0x0264
0x2bfa DD=1: f5 0a               JGE label_2c06
0x2bfc DD=1: ca                  RC
0x2bfd DD=1: b7 b6 06 a6 0b      TJNZB 0x06b6, label_2c0d
0x2c02 DD=1: 5a 11               SB sbafix 0x02d1.2
0x2c04 DD=1: 04 0b               SJ label_2c11
label_2c06:
0x2c06 DD=1: b7 b6 06 ab 05      MOVB 0x06b6, #0x05
label_2c0b:
0x2c0b DD=1: 5a 51               RB sbafix 0x02d1.2
label_2c0d:
0x2c0d DD=1: b7 c2 06 1c         MB 0x06c2.4, C
label_2c11:
0x2c11 DD=0: 94 d7               LB A, fix 0x02d7
0x2c13 DD=0: be 03               ANDB A, #0x03
0x2c15 DD=0: f1 0a               JEQ label_2c21
0x2c17 DD=0: 4d 18               SB sbaoff 0x03d8.5
0x2c19 DD=0: 49 14               SB sbaoff 0x03d4.1
0x2c1b DD=0: b6 11 0b            SB P1.3
0x2c1e DD=0: 03 9e 2c            J label_2c9e
label_2c21:
0x2c21 DD=1: 84 d4               L A, fix 0x02d4
0x2c23 DD=1: b4 d7 14            MB C, fix 0x02d7.4
0x2c26 DD=1: bc 18               MB A.0, C
0x2c28 DD=1: b5 d8 17            MB C, off 0x03d8.7
0x2c2b DD=1: bc 19               MB A.1, C
0x2c2d DD=1: b4 d6 17            MB C, fix 0x02d6.7
0x2c30 DD=1: bc 1c               MB A.4, C
0x2c32 DD=1: be 3f 0f            AND A, #0x0f3f
0x2c35 DD=1: f1 07               JEQ label_2c3e
0x2c37 DD=1: 4d 18               SB sbaoff 0x03d8.5
0x2c39 DD=1: 4c 17               SB sbaoff 0x03d7.4
0x2c3b DD=1: 03 9e 2c            J label_2c9e
label_2c3e:
0x2c3e DD=1: 5c e7 19            JBR sbafix 0x02e7.4, label_2c5a
0x2c41 DD=0: f9 0c               LB A, #0x0c
0x2c43 DD=0: 9c a2               CMPB A, fix 0x02a2
0x2c45 DD=0: f5 13               JGE label_2c5a
0x2c47 DD=0: d4 6f 27            CMPB fix 0x026f, #0x27
0x2c4a DD=0: f2 05               JLT label_2c51
0x2c4c DD=0: d4 6e 07            CMPB fix 0x026e, #0x07
0x2c4f DD=0: f5 02               JGE label_2c53
label_2c51:
0x2c51 DD=0: 4c 17               SB sbaoff 0x03d7.4
label_2c53:
0x2c53 DD=0: b7 c2 06 19         MB 0x06c2.1, C
0x2c57 DD=0: b6 11 1b            MB P1.3, C
label_2c5a:
0x2c5a DD=0: 5d e7 41            JBR sbafix 0x02e7.5, label_2c9e
0x2c5d DD=1: 84 34               L A, fix 0x0234
0x2c5f DD=1: 9e 39 0e            CMP A, #0x0e39
0x2c62 DD=1: f7 30               JLE label_2c94
0x2c64 DD=1: 5a 9c 09            JBS sbafix 0x02dc.2, label_2c70
0x2c67 DD=1: b7 b2 06 a6 32      TJNZB 0x06b2, label_2c9e
0x2c6c DD=1: 49 14               SB sbaoff 0x03d4.1
...
0x2c7a DD=1: 59 9c 07            JBS sbafix 0x02dc.1, label_2c84
...
label_2c89:
0x2c89 DD=1: 4c 17               SB sbaoff 0x03d7.4
label_2c8b:
...
label_2c9e:
0x2c9e DD=1: ca                  RC
0x2c9f DD=1: 4c d7 49            JBR sbaoff 0x03d7.4, label_2ceb
0x2ca2 DD=1: 4e 98 1d            JBS sbaoff 0x03d8.6, label_2cc2
0x2ca5 DD=1: 84 34               L A, fix 0x0234
...
0x2cb9 DD=1: d7 90 28            MOVB off 0x0390, #0x28
label_2cbc:
0x2cbc DD=1: 69 87 91            MOVB off 0x0391, R1
label_2cbf:
0x2cbf DD=1: 68 87 92            MOVB off 0x0392, R0
label_2cc2:
0x2cc2 DD=1: cb                  SC
0x2cc3 DD=1: b5 92 a7 08         TJZB off 0x0392, label_2ccf
0x2cc7 DD=1: 22 d2 87            MOV DP, #tbl_87d2
0x2cca DD=1: d7 91 28            MOVB off 0x0391, #0x28
0x2ccd DD=1: 04 16               SJ label_2ce5
label_2ccf:
0x2ccf DD=1: b5 91 a7 08         TJZB off 0x0391, label_2cdb
0x2cd3 DD=1: 22 d6 87            MOV DP, #tbl_87d6
0x2cd6 DD=1: d7 90 28            MOVB off 0x0390, #0x28
0x2cd9 DD=1: 04 0a               SJ label_2ce5
label_2cdb:
0x2cdb DD=1: 22 de 87            MOV DP, #tbl_87de
0x2cde DD=1: b5 90 a7 03         TJZB off 0x0390, label_2ce5
0x2ce2 DD=1: 22 da 87            MOV DP, #tbl_87da
label_2ce5:
0x2ce5 DD=1: a3 87 5c            MOV off 0x035c, [DP+]
0x2ce8 DD=1: a2 87 5e            MOV off 0x035e, [DP]
label_2ceb:
0x2ceb DD=1: b5 d8 1e            MB off 0x03d8.6, C
0x2cee DD=1: 85 5e               L A, off 0x035e
0x2cf0 DD=1: 4b d4 06            JBR sbaoff 0x03d4.3, label_2cf9
0x2cf3 DD=1: 8e d8 02            SUB A, #0x02d8
0x2cf6 DD=1: f5 01               JGE label_2cf9
0x2cf8 DD=1: fa                  CLR A
label_2cf9:
0x2cf9 DD=1: 9c 34               CMP A, fix 0x0234
0x2cfb DD=1: b5 d4 1b            MB off 0x03d4.3, C
0x2cfe DD=1: 85 5c               L A, off 0x035c
0x2d00 DD=1: 4c 94 06            JBS sbaoff 0x03d4.4, label_2d09
0x2d03 DD=1: ae d8 02            ADD A, #0x02d8
0x2d06 DD=1: f5 01               JGE label_2d09
0x2d08 DD=1: fa                  CLR A
label_2d09:
0x2d09 DD=1: 9c 34               CMP A, fix 0x0234
0x2d0b DD=1: 9a 56               BOR C, PSWH.6
0x2d0d DD=1: b5 d4 1c            MB off 0x03d4.4, C
0x2d10 DD=1: ca                  RC
0x2d11 DD=1: 49 94 0a            JBS sbaoff 0x03d4.1, label_2d1e
0x2d14 DD=1: 4c d7 06            JBR sbaoff 0x03d7.4, label_2d1d
0x2d17 DD=1: 4b 94 04            JBS sbaoff 0x03d4.3, label_2d1e
0x2d1a DD=1: 4c 94 08            JBS sbaoff 0x03d4.4, label_2d25
label_2d1d:
0x2d1d DD=1: cb                  SC
label_2d1e:
0x2d1e DD=1: a5 5a d7            FILL off 0x035a
0x2d21 DD=1: 4a 54               RB sbaoff 0x03d4.2
0x2d23 DD=1: 04 22               SJ label_2d47
label_2d25:
0x2d25 DD=1: 4a 94 18            JBS sbaoff 0x03d4.2, label_2d40
0x2d28 DD=0: 94 78               LB A, fix 0x0278
0x2d2a DD=0: 20 a4 87            MOV X1, #tbl_87a4
0x2d2d DD=0: ba 74               MOVB R4, [X1+A]
0x2d2f DD=1: f8 ff ff            L A, #tbl_ffff
loop_2d32:
...
label_2d3c:
0x2d3c DD=1: 35 5a               ST A, off 0x035a
0x2d3e DD=1: 4a 14               SB sbaoff 0x03d4.2
label_2d40:
0x2d40 DD=1: 85 5a               L A, off 0x035a
0x2d42 DD=1: bc 10               MB C, A.0
0x2d44 DD=1: bf                  ROR A
0x2d45 DD=1: 35 5a               ST A, off 0x035a
label_2d47:
0x2d47 DD=1: fd                  CPL C
0x2d48 DD=1: b5 d4 18            MB off 0x03d4.0, C
0x2d4b DD=1: 5c dc 46            JBR sbafix 0x02dc.4, label_2d94
0x2d4e DD=1: 22 e2 87            MOV DP, #tbl_87e2
0x2d51 DD=1: 82                  L A, [DP]
0x2d52 DD=1: 4e 90 02            JBS sbaoff 0x03d0.6, label_2d57
0x2d55 DD=1: 89 02               L A, 2[DP]
label_2d57:
0x2d57 DD=1: 9c 34               CMP A, fix 0x0234
0x2d59 DD=1: b5 d0 1e            MB off 0x03d0.6, C
0x2d5c DD=1: f2 06               JLT label_2d64
0x2d5e DD=1: 8b 04 90 34         CMP 4[DP], fix 0x0234
0x2d62 DD=1: f7 07               JLE label_2d6b
label_2d64:
0x2d64 DD=1: fd                  CPL C
0x2d65 DD=1: bc d7               FILL A
0x2d67 DD=1: 4f 50               RB sbaoff 0x03d0.7
0x2d69 DD=1: 04 23               SJ label_2d8e
label_2d6b:
0x2d6b DD=1: 4f 90 1b            JBS sbaoff 0x03d0.7, label_2d89
0x2d6e DD=1: 89 06               L A, 6[DP]
0x2d70 DD=1: 6d c7               CLRB R5
0x2d72 DD=1: b4 78 74            MOVB R4, fix 0x0278
0x2d75 DD=1: 66 74               MOV X1, ER2
0x2d77 DD=1: b8 ea 87 74         MOVB R4, tbl_87ea[X1]
...
label_2d85:
0x2d85 DD=1: 35 66               ST A, off 0x0366
0x2d87 DD=1: 4f 10               SB sbaoff 0x03d0.7
label_2d89:
0x2d89 DD=1: 85 66               L A, off 0x0366
0x2d8b DD=1: bc 10               MB C, A.0
0x2d8d DD=1: bf                  ROR A
label_2d8e:
0x2d8e DD=1: 35 66               ST A, off 0x0366
0x2d90 DD=1: fd                  CPL C
0x2d91 DD=1: b5 d0 1d            MB off 0x03d0.5, C
label_2d94:
0x2d94 DD=1: b4 e8 12            MB C, fix 0x02e8.2
0x2d97 DD=1: b4 e8 1c            MB fix 0x02e8.4, C
0x2d9a DD=1: b5 d0 10            MB C, off 0x03d0.0
0x2d9d DD=1: b5 d0 53            BOR C, off 0x03d0.3
0x2da0 DD=1: b5 d4 50            BOR C, off 0x03d4.0
0x2da3 DD=1: b5 d0 55            BOR C, off 0x03d0.5
0x2da6 DD=1: b4 e8 1a            MB fix 0x02e8.2, C
0x2da9 DD=0: f9 80               LB A, #0x80
0x2dab DD=0: b5 55 70            MOVB R0, off 0x0355
0x2dae DD=0: 58 e3 33            JBR sbafix 0x02e3.0, label_2de4
0x2db1 DD=0: 5c 97 30            JBS sbafix 0x02d7.4, label_2de4
0x2db4 DD=0: 95 56               LB A, off 0x0356
0x2db6 DD=0: 48 96 17            JBS sbaoff 0x03d6.0, label_2dd0
...
0x2dcc DD=0: 49 56               RB sbaoff 0x03d6.1
0x2dce DD=0: 04 14               SJ label_2de4
label_2dd0:
0x2dd0 DD=0: 49 16               SB sbaoff 0x03d6.1
...
label_2de4:
0x2de4 DD=0: 68 87 55            MOVB off 0x0355, R0
0x2de7 DD=0: 35 56               STB A, off 0x0356
0x2de9 DD=0: f9 80               LB A, #0x80
0x2deb DD=0: 5a a7 0f            JBS sbafix 0x02e7.2, label_2dfd
0x2dee DD=0: 95 4e               LB A, off 0x034e
0x2df0 DD=0: 58 b0 0a            JBS sbafix 0x02f0.0, label_2dfd
0x2df3 DD=0: 95 4f               LB A, off 0x034f
0x2df5 DD=0: a4 56 91 4c         CMP fix 0x0256, off 0x034c
0x2df9 DD=0: f2 02               JLT label_2dfd
0x2dfb DD=0: 95 50               LB A, off 0x0350
label_2dfd:
0x2dfd DD=0: 35 4b               STB A, off 0x034b
0x2dff DD=0: 58 e7 05            JBR sbafix 0x02e7.0, label_2e07
0x2e02 DD=0: 14 40               MOVB R4, #0x40
0x2e04 DD=0: 03 85 2e            J label_2e85
label_2e07:
0x2e07 DD=0: 20 50 88            MOV X1, #tbl_8850
0x2e0a DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_2e10
0x2e0d DD=0: 20 e7 88            MOV X1, #tbl_88e7
label_2e10:
0x2e10 DD=1: 84 34               L A, fix 0x0234
0x2e12 DD=1: 60 76               MOV DP, X1
0x2e14 DD=1: 62 a3 0a 00         ADD DP, #0x000a
0x2e18 DD=1: 44 a3               ACAL label_10a3
0x2e1a DD=1: 48 97 04            JBS sbaoff 0x03d7.0, label_2e21
0x2e1d DD=1: a8 08 00 a5         ADD A, 0x0008[X1]
label_2e21:
0x2e21 DD=1: 9c 4c               CMP A, fix 0x024c
0x2e23 DD=1: b5 d7 18            MB off 0x03d7.0, C
0x2e26 DD=1: 84 34               L A, fix 0x0234
0x2e28 DD=1: 60 76               MOV DP, X1
0x2e2a DD=1: 62 a3 36 00         ADD DP, #0x0036
0x2e2e DD=1: 44 a3               ACAL label_10a3
0x2e30 DD=1: 49 97 04            JBS sbaoff 0x03d7.1, label_2e37
0x2e33 DD=1: a8 34 00 a5         ADD A, 0x0034[X1]
label_2e37:
0x2e37 DD=1: 9c 4c               CMP A, fix 0x024c
0x2e39 DD=1: 9a 56               BOR C, PSWH.6
0x2e3b DD=1: b5 d7 19            MB off 0x03d7.1, C
0x2e3e DD=1: 6d c7               CLRB R5
0x2e40 DD=1: b5 48 74            MOVB R4, off 0x0348
0x2e43 DD=1: 6f c7               CLRB R7
0x2e45 DD=1: f2 08               JLT label_2e4f
0x2e47 DD=1: b5 47 76            MOVB R6, off 0x0347
0x2e4a DD=1: 48 d7 09            JBR sbaoff 0x03d7.0, label_2e56
0x2e4d DD=1: 04 36               SJ label_2e85
label_2e4f:
0x2e4f DD=1: b5 49 76            MOVB R6, off 0x0349
0x2e52 DD=1: 60 a3 2c 00         ADD X1, #0x002c
label_2e56:
0x2e56 DD=1: a8 06 00 71         MOV ER1, 0x0006[X1]
0x2e5a DD=1: 84 34               L A, fix 0x0234
...
0x2e94 DD=1: 20 6c 89            MOV X1, #tbl_896c
label_2e97:
0x2e97 DD=1: b7 e8 05 20 10      JBR 0x05e8.0, label_2eac
0x2e9c DD=1: 4b 56               RB sbaoff 0x03d6.3
0x2e9e DD=1: 4a 16               SB sbaoff 0x03d6.2
0x2ea0 DD=1: b8 02 00 87 51      MOVB off 0x0351, 0x0002[X1]
0x2ea5 DD=1: b8 01 00 87 8c      MOVB off 0x038c, 0x0001[X1]
0x2eaa DD=1: 04 32               SJ label_2ede
label_2eac:
0x2eac DD=0: 4b 96 0a            JBS sbaoff 0x03d6.3, label_2eb9
0x2eaf DD=0: 97 e8 05            LB A, 0x05e8
0x2eb2 DD=0: be f0               ANDB A, #0xf0
0x2eb4 DD=0: f1 1e               JEQ label_2ed4
0x2eb6 DD=0: 4a d6 1b            JBR sbaoff 0x03d6.2, label_2ed4
label_2eb9:
0x2eb9 DD=0: b5 8c a6 21         TJNZB off 0x038c, label_2ede
0x2ebd DD=0: 95 51               LB A, off 0x0351
0x2ebf DD=0: b0 85               SUBB A, [X1]
0x2ec1 DD=0: f2 11               JLT label_2ed4
0x2ec3 DD=0: 9e 80               CMPB A, #0x80
0x2ec5 DD=0: f7 0d               JLE label_2ed4
0x2ec7 DD=0: 4b 16               SB sbaoff 0x03d6.3
0x2ec9 DD=0: 4a 16               SB sbaoff 0x03d6.2
0x2ecb DD=0: 35 51               STB A, off 0x0351
0x2ecd DD=0: b8 01 00 87 8c      MOVB off 0x038c, 0x0001[X1]
0x2ed2 DD=0: 04 0a               SJ label_2ede
label_2ed4:
0x2ed4 DD=0: 4b 56               RB sbaoff 0x03d6.3
0x2ed6 DD=0: 4a 56               RB sbaoff 0x03d6.2
0x2ed8 DD=0: d7 51 80            MOVB off 0x0351, #0x80
0x2edb DD=0: b5 8c c7            CLRB off 0x038c
label_2ede:
0x2ede DD=0: f9 40               LB A, #0x40
0x2ee0 DD=0: 58 e4 2b            JBR sbafix 0x02e4.0, label_2f0e
0x2ee3 DD=0: 5b a7 28            JBS sbafix 0x02e7.3, label_2f0e
0x2ee6 DD=0: 22 c3 89            MOV DP, #tbl_89c3
0x2ee9 DD=0: 94 6e               LB A, fix 0x026e
0x2eeb DD=0: 44 04               ACAL label_1004
0x2eed DD=0: 58 f0 1e            JBR sbafix 0x02f0.0, label_2f0e
0x2ef0 DD=0: 3a                  STB A, R2
0x2ef1 DD=1: 84 64               L A, fix 0x0264
...
0x2f0d DD=0: d8                  RDD
label_2f0e:
0x2f0e DD=0: 35 52               STB A, off 0x0352
0x2f10 DD=0: f9 80               LB A, #0x80
0x2f12 DD=0: 58 e4 1c            JBR sbafix 0x02e4.0, label_2f31
0x2f15 DD=0: 5f a7 19            JBS sbafix 0x02e7.7, label_2f31
0x2f18 DD=0: b7 c3 06 20 14      JBR 0x06c3.0, label_2f31
0x2f1d DD=1: fa                  CLR A
0x2f1e DD=1: b5 54 97            MOVB A, off 0x0354
0x2f21 DD=1: 4c d8 05            JBR sbaoff 0x03d8.4, label_2f29
0x2f24 DD=1: de ff 00            XOR A, #0x00ff
0x2f27 DD=1: 04 03               SJ label_2f2c
label_2f29:
0x2f29 DD=1: ae 00 01            ADD A, #0x0100
label_2f2c:
0x2f2c DD=1: 22 d2 89            MOV DP, #tbl_89d2
0x2f2f DD=1: 44 70               ACAL label_1070
label_2f31:
0x2f31 DD=1: 35 53               ST A, off 0x0353
0x2f33 DD=0: 95 4a               LB A, off 0x034a
0x2f35 DD=0: b5 46 a9            MULB off 0x0346
0x2f38 DD=0: 66 aa               MOV ER2, A
0x2f3a DD=0: 95 4b               LB A, off 0x034b
0x2f3c DD=0: b5 51 a9            MULB off 0x0351
0x2f3f DD=0: 66 a9               MUL ER2
0x2f41 DD=0: 66 aa               MOV ER2, A
0x2f43 DD=1: fa                  CLR A
0x2f44 DD=1: b5 52 96 07         MOVB ACCH, off 0x0352
0x2f48 DD=1: 66 a9               MUL ER2
0x2f4a DD=1: 3a                  ST A, ER2
0x2f4b DD=1: fa                  CLR A
0x2f4c DD=1: b5 56 96 07         MOVB ACCH, off 0x0356
0x2f50 DD=1: 66 a9               MUL ER2
0x2f52 DD=1: 3a                  ST A, ER2
0x2f53 DD=1: fa                  CLR A
0x2f54 DD=1: b5 53 96 07         MOVB ACCH, off 0x0353
0x2f58 DD=1: 66 a9               MUL ER2
0x2f5a DD=1: a5 06 a9            MUL off 0x0306
...
0x2f8f DD=1: ad 3c               ADD A, off 0x033c
0x2f91 DD=1: f5 02               JGE label_2f95
0x2f93 DD=1: bc d7               FILL A
label_2f95:
0x2f95 DD=1: 59 a8 14            JBS sbafix 0x02e8.1, label_2fac
0x2f98 DD=1: a8 7e 03 a5         ADD A, 0x037e[X1]
0x2f9c DD=1: f5 02               JGE label_2fa0
0x2f9e DD=1: bc d7               FILL A
label_2fa0:
0x2fa0 DD=1: 5a e8 01            JBR sbafix 0x02e8.2, label_2fa4
0x2fa3 DD=1: fa                  CLR A
label_2fa4:
0x2fa4 DD=1: 5b af 05            JBS sbafix 0x02ef.3, label_2fac
0x2fa7 DD=1: c8 3e 03            ST A, 0x033e[X1]
0x2faa DD=1: 04 08               SJ label_2fb4
label_2fac:
0x2fac DD=1: 35 3e               ST A, off 0x033e
0x2fae DD=1: 35 40               ST A, off 0x0340
0x2fb0 DD=1: 35 42               ST A, off 0x0342
0x2fb2 DD=1: 35 44               ST A, off 0x0344
label_2fb4:
0x2fb4 DD=1: 5d e6 4b            JBR sbafix 0x02e6.5, label_3002
0x2fb7 DD=1: 37 24 06            ST A, 0x0624
0x2fba DD=1: 22 77 8a            MOV DP, #tbl_8a77
0x2fbd DD=1: 44 70               ACAL label_1070
0x2fbf DD=1: 37 23 06            ST A, 0x0623
0x2fc2 DD=1: 5a a8 3d            JBS sbafix 0x02e8.2, label_3002
0x2fc5 DD=1: 10 01               MOVB R0, #0x01
0x2fc7 DD=1: 59 e8 02            JBR sbafix 0x02e8.1, label_2fcc
...
label_3002:
0x3002 DD=1: 5f 9c 63            JBS sbafix 0x02dc.7, label_3068
0x3005 DD=1: 58 9f 60            JBS sbafix 0x02df.0, label_3068
...
0x3013 DD=1: 8d 3c               SUB A, off 0x033c
...
0x3020 DD=1: 59 e8 1c            JBR sbafix 0x02e8.1, label_303f
...
0x3048 DD=1: b5 df ca            TBR off 0x03df.(AL)
0x304b DD=1: f1 1b               JEQ label_3068
0x304d DD=1: 5b af 18            JBS sbafix 0x02ef.3, label_3068
...
0x3065 DD=1: b4 d3 b8            SBR fix 0x02d3.(AL)
label_3068:
0x3068 DD=1: 59 68               RB sbafix 0x02e8.1
0x306a DD=1: da                  DI
0x306b DD=1: b4 79 a7 03         TJZB fix 0x0279, label_3072
0x306f DD=1: b6 42 0b            SB IRQ1L.3
label_3072:
0x3072 DD=1: 5d 6f               RB sbafix 0x02ef.5
0x3074 DD=1: 02                  RTI
adc1_vector:
0x3075 DD=0: b4 7f a6 03         TJNZB fix 0x027f, label_307c
...
0x3084 DD=0: b4 83 c8            XCHGB A, fix 0x0283
0x3087 DD=0: b4 82 c8            XCHGB A, fix 0x0282
0x308a DD=0: b4 81 c8            XCHGB A, fix 0x0281
0x308d DD=0: b4 80 c8            XCHGB A, fix 0x0280
0x3090 DD=0: dc                  DECB A
0x3091 DD=0: 34 7e               STB A, fix 0x027e
0x3093 DD=0: b4 7f d6            DECB fix 0x027f
0x3096 DD=0: 5e 2f               SB sbafix 0x02ef.6
0x3098 DD=0: db                  EI
0x3099 DD=1: fa                  CLR A
0x309a DD=1: 59 af 21            JBS sbafix 0x02ef.1, label_30be
0x309d DD=1: da                  DI
0x309e DD=1: a4 2e 73            MOV ER3, fix 0x022e
0x30a1 DD=1: b4 32 74            MOVB R4, fix 0x0232
0x30a4 DD=1: db                  EI
...
label_30be:
0x30be DD=1: 35 00               ST A, off 0x0500
0x30c0 DD=1: 38                  ST A, ER0
0x30c1 DD=1: 22 68 a0            MOV DP, #tbl_a068
0x30c4 DD=1: b5 04 74            MOVB R4, off 0x0504
0x30c7 DD=1: 15 1a               MOVB R5, #0x1a
0x30c9 DD=1: 45 d6               ACAL label_11d6
0x30cb DD=1: 6c 87 04            MOVB off 0x0504, R4
0x30ce DD=1: 35 02               ST A, off 0x0502
0x30d0 DD=1: da                  DI
0x30d1 DD=1: a4 3c 86 4c         MOV fix 0x024c, fix 0x023c
0x30d5 DD=1: a4 44 86 4e         MOV fix 0x024e, fix 0x0244
0x30d9 DD=1: b4 e9 13            MB C, fix 0x02e9.3
0x30dc DD=1: b4 e9 1c            MB fix 0x02e9.4, C
0x30df DD=1: b4 e9 10            MB C, fix 0x02e9.0
0x30e2 DD=1: b4 e9 19            MB fix 0x02e9.1, C
0x30e5 DD=1: db                  EI
0x30e6 DD=1: a4 4c 70            MOV ER0, fix 0x024c
0x30e9 DD=1: 22 20 a0            MOV DP, #tbl_a020
0x30ec DD=1: b4 3f 74            MOVB R4, fix 0x023f
0x30ef DD=1: 15 12               MOVB R5, #0x12
0x30f1 DD=1: 45 d6               ACAL label_11d6
0x30f3 DD=1: 6c 86 3f            MOVB fix 0x023f, R4
0x30f6 DD=1: 34 40               ST A, fix 0x0240
0x30f8 DD=1: f8 1d 07            L A, #0x071d
0x30fb DD=1: 48 a0 03            JBS sbaoff 0x05e0.0, label_3101
0x30fe DD=1: f8 f5 09            L A, #0x09f5
label_3101:
0x3101 DD=1: 9d 00               CMP A, off 0x0500
0x3103 DD=1: b5 e0 18            MB off 0x05e0.0, C
0x3106 DD=1: 4f e5 14            JBR sbaoff 0x05e5.7, label_311d
0x3109 DD=1: 85 06               L A, off 0x0506
0x310b DD=1: 58 a2 08            JBS sbafix 0x02e2.0, label_3116
0x310e DD=1: a5 08 76            MOV DP, off 0x0508
0x3111 DD=1: 83                  L A, [DP+]
0x3112 DD=1: 49 a0 01            JBS sbaoff 0x05e0.1, label_3116
0x3115 DD=1: 82                  L A, [DP]
label_3116:
0x3116 DD=1: 35 06               ST A, off 0x0506
0x3118 DD=1: 9d 00               CMP A, off 0x0500
0x311a DD=1: b5 e0 19            MB off 0x05e0.1, C
label_311d:
0x311d DD=1: fa                  CLR A
0x311e DD=0: 94 7e               LB A, fix 0x027e
0x3120 DD=0: 61 aa               MOV X2, A
0x3122 DD=0: 5c 94 03            JBS sbafix 0x02d4.4, label_3128
0x3125 DD=0: 5c d7 0f            JBR sbafix 0x02d7.4, label_3137
label_3128:
0x3128 DD=0: 20 9f 8a            MOV X1, #tbl_8a9f
0x312b DD=0: 95 04               LB A, off 0x0504
0x312d DD=0: aa 71               MOV ER1, [X1+A]
0x312f DD=0: a5 02 72            MOV ER2, off 0x0502
...
0x313d DD=1: 22 9c a0            MOV DP, #tbl_a09c
0x3140 DD=1: 62 a4               ADD DP, A
0x3142 DD=0: 95 04               LB A, off 0x0504
0x3144 DD=0: a5 02 74            MOV X1, off 0x0502
0x3147 DD=0: b4 3f 71            MOVB R1, fix 0x023f
0x314a DD=0: a4 40 72            MOV ER2, fix 0x0240
...
0x3167 DD=0: 20 ca 8a            MOV X1, #tbl_8aca
0x316a DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_3170
0x316d DD=0: 20 03 8b            MOV X1, #tbl_8b03
label_3170:
0x3170 DD=1: 85 00               L A, off 0x0500
0x3172 DD=1: 60 76               MOV DP, X1
0x3174 DD=1: 62 a3 0a 00         ADD DP, #0x000a
0x3178 DD=1: 44 a3               ACAL label_10a3
0x317a DD=1: 48 a9 04            JBS sbaoff 0x05e9.0, label_3181
0x317d DD=1: a8 08 00 a5         ADD A, 0x0008[X1]
label_3181:
0x3181 DD=1: 9c 4c               CMP A, fix 0x024c
0x3183 DD=1: 9a 56               BOR C, PSWH.6
0x3185 DD=1: b5 e9 18            MB off 0x05e9.0, C
0x3188 DD=1: 26 80 00            MOV ER2, #0x0080
0x318b DD=1: f5 34               JGE label_31c1
0x318d DD=1: a8 06 00 71         MOV ER1, 0x0006[X1]
0x3191 DD=1: 85 00               L A, off 0x0500
...
0x319c DD=1: b5 13 76            MOVB R6, off 0x0513
...
label_31c1:
0x31c1 DD=0: 6c 87 14            MOVB off 0x0514, R4
0x31c4 DD=0: 6c 2f 0b            JBS R4.7, label_31d2
0x31c7 DD=0: b8 25 00 87 70      MOVB off 0x0570, 0x0025[X1]
0x31cc DD=0: 4a 29               SB sbaoff 0x05e9.2
0x31ce DD=0: 49 69               RB sbaoff 0x05e9.1
0x31d0 DD=0: 04 59               SJ label_322b
label_31d2:
0x31d2 DD=1: b8 20 00 90 70      CMPB 0x0020[X1], fix 0x0270
0x31d7 DD=1: f2 0e               JLT label_31e7
0x31d9 DD=1: a8 21 00 91 00      CMP 0x0021[X1], off 0x0500
0x31de DD=1: f0 07               JGT label_31e7
0x31e0 DD=1: a8 23 00 90 4c      CMP 0x0023[X1], fix 0x024c
0x31e5 DD=1: f7 08               JLE label_31ef
label_31e7:
0x31e7 DD=1: b8 25 00 87 70      MOVB off 0x0570, 0x0025[X1]
0x31ec DD=1: ca                  RC
0x31ed DD=1: 04 08               SJ label_31f7
label_31ef:
0x31ef DD=1: ca                  RC
0x31f0 DD=0: 95 70               LB A, off 0x0570
0x31f2 DD=0: f6 03               JNE label_31f7
0x31f4 DD=0: 4a 69               RB sbaoff 0x05e9.2
0x31f6 DD=0: cb                  SC
label_31f7:
0x31f7 DD=0: b5 e9 19            MB off 0x05e9.1, C
0x31fa DD=0: 4a a9 2e            JBS sbaoff 0x05e9.2, label_322b
0x31fd DD=0: 95 12               LB A, off 0x0512
0x31ff DD=0: ae 80               ADDB A, #0x80
0x3201 DD=0: d5 68 00            CMPB off 0x0568, #0x00
0x3204 DD=0: f6 18               JNE label_321e
0x3206 DD=0: b8 26 00 87 68      MOVB off 0x0568, 0x0026[X1]
0x320b DD=0: 49 a9 0a            JBS sbaoff 0x05e9.1, label_3218
...
0x3229 DD=0: 4a 29               SB sbaoff 0x05e9.2
label_322b:
0x322b DD=0: 6c a3 80            ADDB R4, #0x80
0x322e DD=0: 6c 87 12            MOVB off 0x0512, R4
0x3231 DD=0: 20 46 8b            MOV X1, #tbl_8b46
0x3234 DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_323a
0x3237 DD=0: 20 a2 8b            MOV X1, #tbl_8ba2
label_323a:
0x323a DD=1: 85 00               L A, off 0x0500
0x323c DD=1: 60 76               MOV DP, X1
0x323e DD=1: 62 a3 0b 00         ADD DP, #0x000b
0x3242 DD=1: 44 a3               ACAL label_10a3
0x3244 DD=1: 4c a9 04            JBS sbaoff 0x05e9.4, label_324b
0x3247 DD=1: a8 09 00 a5         ADD A, 0x0009[X1]
label_324b:
0x324b DD=1: 9c 4c               CMP A, fix 0x024c
0x324d DD=1: 9a 56               BOR C, PSWH.6
0x324f DD=1: b5 e9 1c            MB off 0x05e9.4, C
0x3252 DD=1: 85 00               L A, off 0x0500
0x3254 DD=1: 60 76               MOV DP, X1
0x3256 DD=1: 62 a3 2b 00         ADD DP, #0x002b
0x325a DD=1: 44 a3               ACAL label_10a3
0x325c DD=1: 4b a9 04            JBS sbaoff 0x05e9.3, label_3263
0x325f DD=1: a8 29 00 a5         ADD A, 0x0029[X1]
label_3263:
0x3263 DD=1: 9c 4c               CMP A, fix 0x024c
0x3265 DD=1: 9a 56               BOR C, PSWH.6
0x3267 DD=1: b5 e9 1b            MB off 0x05e9.3, C
0x326a DD=1: b0 90 70            CMPB [X1], fix 0x0270
0x326d DD=1: f0 11               JGT label_3280
0x326f DD=1: 60 a3 21 00         ADD X1, #0x0021
0x3273 DD=1: 6f c7               CLRB R7
0x3275 DD=1: b5 17 76            MOVB R6, off 0x0517
0x3278 DD=1: 4b a9 13            JBS sbaoff 0x05e9.3, label_328e
0x327b DD=1: b5 16 76            MOVB R6, off 0x0516
0x327e DD=1: 04 0e               SJ label_328e
label_3280:
0x3280 DD=1: 60 a3 01 00         ADD X1, #0x0001
0x3284 DD=1: 6f c7               CLRB R7
0x3286 DD=1: b5 18 76            MOVB R6, off 0x0518
0x3289 DD=1: 4c a9 02            JBS sbaoff 0x05e9.4, label_328e
0x328c DD=1: 16 80               MOVB R6, #0x80
label_328e:
0x328e DD=1: 26 80 00            MOV ER2, #0x0080
0x3291 DD=1: a8 06 00 71         MOV ER1, 0x0006[X1]
0x3295 DD=1: 85 00               L A, off 0x0500
...
0x32c3 DD=1: 6c 87 15            MOVB off 0x0515, R4
0x32c6 DD=1: 48 e5 12            JBR sbaoff 0x05e5.0, label_32db
0x32c9 DD=1: 48 65               RB sbaoff 0x05e5.0
0x32cb DD=1: a5 3e 76            MOV DP, off 0x053e
0x32ce DD=1: b3 87 44            MOVB off 0x0544, [DP+]
0x32d1 DD=1: 62 87 40            MOV off 0x0540, DP
0x32d4 DD=1: b5 43 c7            CLRB off 0x0543
0x32d7 DD=1: 49 25               SB sbaoff 0x05e5.1
0x32d9 DD=1: 4a 25               SB sbaoff 0x05e5.2
label_32db:
0x32db DD=1: 22 81 8c            MOV DP, #tbl_8c81
0x32de DD=1: 44 00               ACAL label_1000
0x32e0 DD=1: 35 45               ST A, off 0x0545
0x32e2 DD=1: 49 e5 22            JBR sbaoff 0x05e5.1, label_3307
0x32e5 DD=1: 4a e5 19            JBR sbaoff 0x05e5.2, label_3301
0x32e8 DD=1: d5 43 04            CMPB off 0x0543, #0x04
0x32eb DD=1: f5 0f               JGE label_32fc
0x32ed DD=1: b5 43 70            MOVB R0, off 0x0543
0x32f0 DD=1: a5 40 74            MOV X1, off 0x0540
0x32f3 DD=1: bb 97               MOVB A, [X1+R0]
0x32f5 DD=1: b5 43 a3 01         ADDB off 0x0543, #0x01
0x32f9 DD=1: bc a6 0e            TJNZ A, label_330a
label_32fc:
0x32fc DD=1: 4a 65               RB sbaoff 0x05e5.2
0x32fe DD=1: b5 43 c7            CLRB off 0x0543
label_3301:
0x3301 DD=0: 95 42               LB A, off 0x0542
0x3303 DD=0: 8d 44               SUBB A, off 0x0544
0x3305 DD=0: f0 03               JGT label_330a
label_3307:
0x3307 DD=0: fb                  CLRB A
0x3308 DD=0: 49 65               RB sbaoff 0x05e5.1
label_330a:
0x330a DD=0: b5 45 a9            MULB off 0x0545
...
label_3319:
0x3319 DD=0: 35 42               STB A, off 0x0542
0x331b DD=0: 58 a3 06            JBS sbafix 0x02e3.0, label_3324
0x331e DD=0: b5 5e c7            CLRB off 0x055e
...
0x332c DD=0: 20 fa 8d            MOV X1, #tbl_8dfa
0x332f DD=0: 5c 97 13            JBS sbafix 0x02d7.4, label_3345
0x3332 DD=0: 90                  LB A, [X1]
0x3333 DD=0: 9c 70               CMPB A, fix 0x0270
0x3335 DD=0: f2 0e               JLT label_3345
0x3337 DD=1: 88 01 00            L A, 0x0001[X1]
0x333a DD=1: 9d 00               CMP A, off 0x0500
0x333c DD=1: f0 07               JGT label_3345
0x333e DD=1: 8a 2b 04            JBS PSWL.3, label_3345
0x3341 DD=1: 5c 11               SB sbafix 0x02d1.4
0x3343 DD=1: 04 02               SJ label_3347
label_3345:
0x3345 DD=0: 5c 51               RB sbafix 0x02d1.4
label_3347:
0x3347 DD=0: 4a aa 15            JBS sbaoff 0x05ea.2, label_335f
0x334a DD=1: 88 03 00            L A, 0x0003[X1]
0x334d DD=1: 9d 00               CMP A, off 0x0500
0x334f DD=1: f0 0e               JGT label_335f
0x3351 DD=1: 8a 23 0e            JBR PSWL.3, label_3362
0x3354 DD=0: 95 5f               LB A, off 0x055f
0x3356 DD=0: cc                  INCB A
0x3357 DD=0: b8 05 00 95         CMPB A, 0x0005[X1]
0x335b DD=0: f2 03               JLT label_3360
0x335d DD=0: 4a 2a               SB sbaoff 0x05ea.2
label_335f:
0x335f DD=0: fb                  CLRB A
label_3360:
0x3360 DD=0: 35 5f               STB A, off 0x055f
label_3362:
0x3362 DD=0: 20 09 8e            MOV X1, #tbl_8e09
0x3365 DD=1: 80                  L A, [X1]
0x3366 DD=1: 4b a5 03            JBS sbaoff 0x05e5.3, label_336c
0x3369 DD=1: 88 02 00            L A, 0x0002[X1]
label_336c:
0x336c DD=1: 9d 00               CMP A, off 0x0500
0x336e DD=1: b5 e5 1b            MB off 0x05e5.3, C
0x3371 DD=1: 88 04 00            L A, 0x0004[X1]
0x3374 DD=1: 4c a5 03            JBS sbaoff 0x05e5.4, label_337a
0x3377 DD=1: 88 06 00            L A, 0x0006[X1]
label_337a:
0x337a DD=1: 9d 00               CMP A, off 0x0500
0x337c DD=1: 9a 56               BOR C, PSWH.6
0x337e DD=1: b5 e5 1c            MB off 0x05e5.4, C
0x3381 DD=1: ca                  RC
0x3382 DD=1: 4a ea 12            JBR sbaoff 0x05ea.2, label_3397
0x3385 DD=1: 5c 97 0f            JBS sbafix 0x02d7.4, label_3397
0x3388 DD=1: 5c 94 0c            JBS sbafix 0x02d4.4, label_3397
0x338b DD=1: 4b e5 09            JBR sbaoff 0x05e5.3, label_3397
0x338e DD=1: 4c a5 06            JBS sbaoff 0x05e5.4, label_3397
0x3391 DD=0: 94 70               LB A, fix 0x0270
0x3393 DD=0: b8 08 00 95         CMPB A, 0x0008[X1]
label_3397:
0x3397 DD=0: b4 ec 18            MB fix 0x02ec.0, C
0x339a DD=0: 22 70 ee            MOV DP, #tbl_ee70
0x339d DD=0: 95 04               LB A, off 0x0504
0x339f DD=0: a5 02 74            MOV X1, off 0x0502
0x33a2 DD=0: b4 3f 71            MOVB R1, fix 0x023f
0x33a5 DD=0: a4 40 72            MOV ER2, fix 0x0240
0x33a8 DD=0: 16 12               MOVB R6, #0x12
0x33aa DD=0: 46 1d               ACAL label_121d
0x33ac DD=0: 35 60               STB A, off 0x0560
0x33ae DD=0: b5 5d a9            MULB off 0x055d
0x33b1 DD=1: d9                  SDD
0x33b2 DD=1: bc 8d               SLL A, 2
0x33b4 DD=1: f5 02               JGE label_33b8
0x33b6 DD=1: bc d7               FILL A
label_33b8:
0x33b8 DD=1: b6 07 86 a7         MOVB fix 0x02a7, ACCH
0x33bc DD=1: 59 6c               RB sbafix 0x02ec.1
0x33be DD=1: 9a 16               MB C, PSWH.6
0x33c0 DD=1: fd                  CPL C
0x33c1 DD=1: b5 e5 1d            MB off 0x05e5.5, C
0x33c4 DD=1: 5c 97 03            JBS sbafix 0x02d7.4, label_33ca
0x33c7 DD=1: 5c d4 04            JBR sbafix 0x02d4.4, label_33ce
label_33ca:
0x33ca DD=0: fb                  CLRB A
0x33cb DD=0: 03 85 34            J label_3485
label_33ce:
0x33ce DD=1: 4d e5 1d            JBR sbaoff 0x05e5.5, label_33ee
0x33d1 DD=0: f9 03               LB A, #0x03
0x33d3 DD=0: b5 5e a6 06         TJNZB off 0x055e, label_33dd
0x33d7 DD=0: b5 65 a6 02         TJNZB off 0x0565, label_33dd
0x33db DD=0: f9 03               LB A, #0x03
label_33dd:
0x33dd DD=0: 35 61               STB A, off 0x0561
0x33df DD=0: b5 64 c7            CLRB off 0x0564
0x33e2 DD=0: b5 62 c7            CLRB off 0x0562
0x33e5 DD=0: 4d 65               RB sbaoff 0x05e5.5
0x33e7 DD=0: 4e 25               SB sbaoff 0x05e5.6
0x33e9 DD=0: d7 65 0a            MOVB off 0x0565, #0x0a
...
0x33f8 DD=0: d5 64 ff            CMPB off 0x0564, #0xff
0x33fb DD=0: f1 03               JEQ label_3400
0x33fd DD=0: b5 64 c6            INCB off 0x0564
label_3400:
0x3400 DD=0: d5 64 20            CMPB off 0x0564, #0x20
0x3403 DD=0: f2 2e               JLT label_3433
0x3405 DD=0: 20 36 8e            MOV X1, #tbl_8e36
0x3408 DD=0: 22 1d 8e            MOV DP, #tbl_8e1d
0x340b DD=0: 14 02               MOVB R4, #0x02
0x340d DD=1: 84 4c               L A, fix 0x024c
loop_340f:
...
0x341b DD=1: 22 25 8e            MOV DP, #tbl_8e25
0x341e DD=1: 14 04               MOVB R4, #0x04
loop_3420:
0x3420 DD=1: 60 83 03 00         SUB X1, #0x0003
0x3424 DD=1: a1 91 00            CMP [DP-], off 0x0500
...
0x3430 DD=0: b5 64 c7            CLRB off 0x0564
label_3433:
0x3433 DD=0: b5 61 c7            CLRB off 0x0561
label_3436:
0x3436 DD=0: 35 62               STB A, off 0x0562
label_3438:
0x3438 DD=0: 20 36 8e            MOV X1, #tbl_8e36
0x343b DD=0: 95 04               LB A, off 0x0504
0x343d DD=0: aa 71               MOV ER1, [X1+A]
0x343f DD=0: a5 02 72            MOV ER2, off 0x0502
0x3442 DD=0: 45 17               ACAL label_1117
0x3444 DD=0: 35 63               STB A, off 0x0563
0x3446 DD=0: b5 65 70            MOVB R0, off 0x0565
0x3449 DD=0: 68 83 01            SUBB R0, #0x01
0x344c DD=0: f5 02               JGE label_3450
0x344e DD=0: 68 c7               CLRB R0
label_3450:
0x3450 DD=0: 68 87 65            MOVB off 0x0565, R0
0x3453 DD=0: 58 ac 06            JBS sbafix 0x02ec.0, label_345c
0x3456 DD=0: 4b e5 03            JBR sbaoff 0x05e5.3, label_345c
0x3459 DD=0: 4c e5 29            JBR sbaoff 0x05e5.4, label_3485
label_345c:
0x345c DD=0: 95 5e               LB A, off 0x055e
0x345e DD=0: ad 61               ADDB A, off 0x0561
0x3460 DD=0: f5 02               JGE label_3464
0x3462 DD=0: bc d7               FILLB A
label_3464:
0x3464 DD=0: 8d 62               SUBB A, off 0x0562
0x3466 DD=0: f5 01               JGE label_3469
0x3468 DD=0: fb                  CLRB A
label_3469:
0x3469 DD=0: 9d 63               CMPB A, off 0x0563
0x346b DD=0: 68 c7               CLRB R0
0x346d DD=0: f7 0a               JLE label_3479
0x346f DD=0: 95 63               LB A, off 0x0563
0x3471 DD=0: b5 66 70            MOVB R0, off 0x0566
0x3474 DD=0: c0                  INCB R0
0x3475 DD=0: f6 02               JNE label_3479
0x3477 DD=0: 68 d7               FILLB R0
label_3479:
0x3479 DD=0: 68 87 66            MOVB off 0x0566, R0
0x347c DD=0: 68 93 14            CMPB R0, #0x14
0x347f DD=0: f7 04               JLE label_3485
0x3481 DD=0: b7 d6 03 08         SB 0x03d6.0
label_3485:
0x3485 DD=0: 35 5e               STB A, off 0x055e
label_3487:
0x3487 DD=0: 95 46               LB A, off 0x0546
0x3489 DD=0: b5 47 70            MOVB R0, off 0x0547
0x348c DD=0: ca                  RC
0x348d DD=0: b7 c2 06 25 35      JBR 0x06c2.5, label_34c7
0x3492 DD=0: 4d aa 3a            JBS sbaoff 0x05ea.5, label_34cf
0x3495 DD=0: 4c aa 11            JBS sbaoff 0x05ea.4, label_34a9
...
label_34a2:
0x34a2 DD=0: 4c 2a               SB sbaoff 0x05ea.4
0x34a4 DD=0: 68 c7               CLRB R0
0x34a6 DD=0: d7 48 00            MOVB off 0x0548, #0x00
label_34a9:
0x34a9 DD=0: 68 91 48            CMPB R0, off 0x0548
...
label_34bd:
0x34bd DD=0: 6a 87 48            MOVB off 0x0548, R2
...
label_34c7:
0x34c7 DD=0: b5 ea 1d            MB off 0x05ea.5, C
0x34ca DD=0: 4c 6a               RB sbaoff 0x05ea.4
0x34cc DD=0: fb                  CLRB A
0x34cd DD=0: 68 c7               CLRB R0
label_34cf:
0x34cf DD=0: 35 46               STB A, off 0x0546
0x34d1 DD=0: 68 87 47            MOVB off 0x0547, R0
0x34d4 DD=0: f9 80               LB A, #0x80
0x34d6 DD=0: 11 0a               MOVB R1, #0x0a
0x34d8 DD=0: 59 e3 4e            JBR sbafix 0x02e3.1, label_3529
0x34db DD=0: b7 c2 06 25 49      JBR 0x06c2.5, label_3529
0x34e0 DD=0: b5 46 a6 45         TJNZB off 0x0546, label_3529
0x34e4 DD=1: f8 de 1d            L A, #0x1dde
0x34e7 DD=1: 8d 00               SUB A, off 0x0500
0x34e9 DD=1: 9a 56               BOR C, PSWH.6
0x34eb DD=1: b5 e9 1d            MB off 0x05e9.5, C
0x34ee DD=1: f5 01               JGE label_34f1
0x34f0 DD=1: cf                  NEG A
label_34f1:
0x34f1 DD=1: 35 4a               ST A, off 0x054a
0x34f3 DD=1: b5 4c 71            MOVB R1, off 0x054c
0x34f6 DD=1: 69 a7 03            TJZB R1, label_34fc
0x34f9 DD=1: d1                  DEC R1
0x34fa DD=1: 04 31               SJ label_352d
label_34fc:
0x34fc DD=1: 22 8b 8c            MOV DP, #tbl_8c8b
0x34ff DD=1: 9e ff 00            CMP A, #0x00ff
0x3502 DD=1: f5 05               JGE label_3509
0x3504 DD=1: 11 05               MOVB R1, #0x05
0x3506 DD=1: 22 8a 8c            MOV DP, #tbl_8c8a
label_3509:
0x3509 DD=1: b2 70               MOVB R0, [DP]
0x350b DD=0: 95 4d               LB A, off 0x054d
0x350d DD=0: 8e 80               SUBB A, #0x80
0x350f DD=0: 4d e9 06            JBR sbaoff 0x05e9.5, label_3518
...
0x352b DD=0: 35 4d               STB A, off 0x054d
label_352d:
0x352d DD=0: 69 87 4c            MOVB off 0x054c, R1
0x3530 DD=0: fb                  CLRB A
0x3531 DD=0: 58 e4 1e            JBR sbafix 0x02e4.0, label_3552
...
label_354b:
0x354b DD=1: 22 8c 8c            MOV DP, #tbl_8c8c
...
0x35e5 DD=0: b5 1e c7            CLRB off 0x051e
0x35e8 DD=0: 03 3d 36            J label_363d
label_35eb:
0x35eb DD=0: 95 e7               LB A, off 0x05e7
0x35ed DD=0: be f0               ANDB A, #0xf0
0x35ef DD=0: f6 41               JNE label_3632
0x35f1 DD=0: 4a a7 23            JBS sbaoff 0x05e7.2, label_3617
0x35f4 DD=0: 48 a7 15            JBS sbaoff 0x05e7.0, label_360c
0x35f7 DD=0: b5 1e c7            CLRB off 0x051e
0x35fa DD=0: 8a 2b 40            JBS PSWL.3, label_363d
0x35fd DD=0: c5 00 ff ff         CMP off 0x0500, #tbl_ffff
0x3601 DD=0: f7 3a               JLE label_363d
0x3603 DD=0: b5 6e a7 36         TJZB off 0x056e, label_363d
0x3607 DD=0: d7 6a 00            MOVB off 0x056a, #0x00
0x360a DD=0: 48 27               SB sbaoff 0x05e7.0
label_360c:
0x360c DD=0: b5 6a a6 2d         TJNZB off 0x056a, label_363d
0x3610 DD=0: 4a 27               SB sbaoff 0x05e7.2
0x3612 DD=0: 48 67               RB sbaoff 0x05e7.0
0x3614 DD=0: d7 6b c8            MOVB off 0x056b, #0xc8
label_3617:
0x3617 DD=0: 20 e3 8b            MOV X1, #tbl_8be3
0x361a DD=0: 95 04               LB A, off 0x0504
0x361c DD=0: aa 71               MOV ER1, [X1+A]
0x361e DD=0: a5 02 72            MOV ER2, off 0x0502
0x3621 DD=0: 45 17               ACAL label_1117
0x3623 DD=0: 35 1e               STB A, off 0x051e
0x3625 DD=0: b5 6b a6 14         TJNZB off 0x056b, label_363d
0x3629 DD=0: b5 e7 c3 f0         OR off 0x05e7, #0xf0
0x362d DD=0: 4a 67               RB sbaoff 0x05e7.2
0x362f DD=0: d7 6c 0a            MOVB off 0x056c, #0x0a
label_3632:
0x3632 DD=0: b5 6c a6 07         TJNZB off 0x056c, label_363d
0x3636 DD=0: d7 6c 0a            MOVB off 0x056c, #0x0a
0x3639 DD=0: b5 1e a3 01         ADDB off 0x051e, #0x01
label_363d:
0x363d DD=0: 5c e4 4d            JBR sbafix 0x02e4.4, label_368d
0x3640 DD=0: 20 fd 8b            MOV X1, #tbl_8bfd
0x3643 DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_3649
0x3646 DD=0: 20 ff 8b            MOV X1, #tbl_8bff
label_3649:
0x3649 DD=1: 84 4c               L A, fix 0x024c
0x364b DD=1: a0 95               CMP A, [X1]
0x364d DD=1: 48 aa 04            JBS sbaoff 0x05ea.0, label_3654
0x3650 DD=1: a8 02 00 95         CMP A, 0x0002[X1]
label_3654:
0x3654 DD=1: fd                  CPL C
0x3655 DD=1: b5 ea 18            MB off 0x05ea.0, C
0x3658 DD=1: a8 04 00 95         CMP A, 0x0004[X1]
0x365c DD=1: 49 aa 04            JBS sbaoff 0x05ea.1, label_3663
0x365f DD=1: a8 06 00 95         CMP A, 0x0006[X1]
label_3663:
0x3663 DD=1: fd                  CPL C
0x3664 DD=1: b5 ea 19            MB off 0x05ea.1, C
0x3667 DD=1: 85 00               L A, off 0x0500
0x3669 DD=1: a8 08 00 95         CMP A, 0x0008[X1]
0x366d DD=1: 4b a0 04            JBS sbaoff 0x05e0.3, label_3674
0x3670 DD=1: a8 0a 00 95         CMP A, 0x000a[X1]
label_3674:
0x3674 DD=1: fd                  CPL C
0x3675 DD=1: b5 e0 1b            MB off 0x05e0.3, C
0x3678 DD=1: a8 0c 00 95         CMP A, 0x000c[X1]
0x367c DD=1: 4c a0 04            JBS sbaoff 0x05e0.4, label_3683
...
label_3692:
0x3692 DD=1: b5 ea 10            MB C, off 0x05ea.0
0x3695 DD=1: b5 ea 49            BANDN C, off 0x05ea.1
0x3698 DD=1: b5 e0 43            BAND C, off 0x05e0.3
0x369b DD=1: b5 e0 4c            BANDN C, off 0x05e0.4
0x369e DD=1: f5 1f               JGE label_36bf
0x36a0 DD=1: b8 10 00 90 70      CMPB 0x0010[X1], fix 0x0270
0x36a5 DD=1: f2 18               JLT label_36bf
0x36a7 DD=1: b8 11 00 90 6e      CMPB 0x0011[X1], fix 0x026e
0x36ac DD=1: f2 11               JLT label_36bf
0x36ae DD=0: 95 04               LB A, off 0x0504
0x36b0 DD=0: ae 14               ADDB A, #0x14
0x36b2 DD=0: aa 71               MOV ER1, [X1+A]
0x36b4 DD=0: a5 02 72            MOV ER2, off 0x0502
...
0x36c1 DD=0: 95 e8               LB A, off 0x05e8
0x36c3 DD=0: 39                  STB A, R1
0x36c4 DD=0: f1 15               JEQ label_36db
0x36c6 DD=0: 48 e8 02            JBR sbaoff 0x05e8.0, label_36cb
0x36c9 DD=0: 11 f0               MOVB R1, #0xf0
label_36cb:
0x36cb DD=0: 95 1f               LB A, off 0x051f
0x36cd DD=0: b5 69 70            MOVB R0, off 0x0569
...
label_36db:
0x36db DD=0: 69 87 e8            MOVB off 0x05e8, R1
0x36de DD=0: 35 1f               STB A, off 0x051f
0x36e0 DD=0: 68 87 69            MOVB off 0x0569, R0
0x36e3 DD=0: 20 ba 8c            MOV X1, #tbl_8cba
0x36e6 DD=0: 95 04               LB A, off 0x0504
0x36e8 DD=0: aa 71               MOV ER1, [X1+A]
0x36ea DD=0: a5 02 72            MOV ER2, off 0x0502
0x36ed DD=0: 45 17               ACAL label_1117
0x36ef DD=0: 35 20               STB A, off 0x0520
0x36f1 DD=1: fa                  CLR A
0x36f2 DD=0: 94 7e               LB A, fix 0x027e
0x36f4 DD=0: 61 aa               MOV X2, A
0x36f6 DD=0: 4a a7 18            JBS sbaoff 0x05e7.2, label_3711
0x36f9 DD=0: 48 a8 2d            JBS sbaoff 0x05e8.0, label_3729
0x36fc DD=0: b9 1a 05 71         MOVB R1, 0x051a[X2]
0x3700 DD=0: ae 04               ADDB A, #0x04
0x3702 DD=0: b5 e7 ca            TBR off 0x05e7.(AL)
0x3705 DD=0: f1 13               JEQ label_371a
0x3707 DD=0: 69 91 1e            CMPB R1, off 0x051e
0x370a DD=0: f0 05               JGT label_3711
0x370c DD=0: b5 e7 b9            RBR off 0x05e7.(AL)
0x370f DD=0: 04 03               SJ label_3714
label_3711:
0x3711 DD=0: b5 1e 71            MOVB R1, off 0x051e
label_3714:
0x3714 DD=0: b5 e8 b3 0e         ANDB off 0x05e8, #0x0e
0x3718 DD=0: 04 16               SJ label_3730
label_371a:
0x371a DD=0: b5 e8 ca            TBR off 0x05e8.(AL)
0x371d DD=0: f1 11               JEQ label_3730
0x371f DD=0: 69 91 1f            CMPB R1, off 0x051f
0x3722 DD=0: f0 05               JGT label_3729
0x3724 DD=0: b5 e8 b9            RBR off 0x05e8.(AL)
0x3727 DD=0: 04 03               SJ label_372c
label_3729:
0x3729 DD=0: b5 1f 71            MOVB R1, off 0x051f
label_372c:
0x372c DD=0: b5 e7 b3 00         ANDB off 0x05e7, #0x00
label_3730:
0x3730 DD=0: 69 91 20            CMPB R1, off 0x0520
0x3733 DD=0: f5 03               JGE label_3738
0x3735 DD=0: b5 20 71            MOVB R1, off 0x0520
label_3738:
0x3738 DD=0: 69 99 21 05         MOVB 0x0521[X2], R1
0x373c DD=0: 22 d4 8c            MOV DP, #tbl_8cd4
0x373f DD=1: 85 00               L A, off 0x0500
0x3741 DD=1: 44 70               ACAL label_1070
0x3743 DD=1: 35 25               ST A, off 0x0525
0x3745 DD=1: fa                  CLR A
0x3746 DD=0: 94 7e               LB A, fix 0x027e
0x3748 DD=0: 61 aa               MOV X2, A
0x374a DD=0: 95 25               LB A, off 0x0525
...
label_377a:
0x377a DD=1: 35 2c               ST A, off 0x052c
0x377c DD=0: 95 26               LB A, off 0x0526
0x377e DD=0: 26 09 00            MOV ER2, #0x0009
0x3781 DD=0: 9e 9c               CMPB A, #0x9c
0x3783 DD=0: f5 0a               JGE label_378f
0x3785 DD=0: 26 0a aa            MOV ER2, #tbl_aa0a
...
0x3792 DD=0: 94 7e               LB A, fix 0x027e
0x3794 DD=0: 60 aa               MOV X1, A
0x3796 DD=0: 61 aa               MOV X2, A
0x3798 DD=0: 61 8c               SLL X2, 1
0x379a DD=0: da                  DI
0x379b DD=0: b5 26 98 27 05      MOVB 0x0527[X1], off 0x0526
0x37a0 DD=0: a5 2c 99 2e 05      MOV 0x052e[X2], off 0x052c
0x37a5 DD=0: 66 99 36 05         MOV 0x0536[X2], ER2
0x37a9 DD=0: b5 e0 10            MB C, off 0x05e0.0
0x37ac DD=0: b8 e1 05 18         MB 0x05e1[X1].0, C
0x37b0 DD=0: b5 e0 11            MB C, off 0x05e0.1
0x37b3 DD=0: b8 e1 05 19         MB 0x05e1[X1].1, C
0x37b7 DD=0: db                  EI
0x37b8 DD=0: d6 03 06            MOVB LRBH, #0x06
0x37bb DD=0: 5d e4 36            JBR sbafix 0x02e4.5, label_37f4
0x37be DD=0: 94 7e               LB A, fix 0x027e
0x37c0 DD=0: f6 2e               JNE label_37f0
0x37c2 DD=1: 85 84               L A, off 0x0684
0x37c4 DD=1: a5 86 70            MOV ER0, off 0x0686
0x37c7 DD=1: b5 88 76            MOVB R6, off 0x0688
...
0x37df DD=1: 35 82               ST A, off 0x0682
0x37e1 DD=1: 4e 08               SB sbaoff 0x06c8.6
0x37e3 DD=1: fa                  CLR A
0x37e4 DD=1: 64 c7               CLR ER0
0x37e6 DD=1: 6e c7               CLRB R6
label_37e8:
0x37e8 DD=1: 35 84               ST A, off 0x0684
0x37ea DD=1: 64 87 86            MOV off 0x0686, ER0
0x37ed DD=1: 6e 87 88            MOVB off 0x0688, R6
label_37f0:
0x37f0 DD=1: b5 c8 3e 03         JBSR off 0x06c8.6, label_37f7
label_37f4:
0x37f4 DD=1: 03 91 38            J label_3891
label_37f7:
0x37f7 DD=1: 22 6e 8e            MOV DP, #tbl_8e6e
0x37fa DD=1: 44 00               ACAL label_1000
0x37fc DD=1: 35 89               ST A, off 0x0689
0x37fe DD=1: 22 5f 8e            MOV DP, #tbl_8e5f
0x3801 DD=1: 44 00               ACAL label_1000
0x3803 DD=1: 35 8a               ST A, off 0x068a
0x3805 DD=0: 94 71               LB A, fix 0x0271
0x3807 DD=0: 22 7d 8e            MOV DP, #tbl_8e7d
0x380a DD=0: 45 33               ACAL label_1133
0x380c DD=0: 35 8b               STB A, off 0x068b
0x380e DD=0: b7 ee 05 2c 3f      JBS 0x05ee.4, label_3852
0x3813 DD=1: 84 d4               L A, fix 0x02d4
0x3815 DD=1: be 13 00            AND A, #0x0013
0x3818 DD=1: f6 0a               JNE label_3824
0x381a DD=1: 84 d6               L A, fix 0x02d6
0x381c DD=1: be 00 80            AND A, #0x8000
0x381f DD=1: f6 03               JNE label_3824
0x3821 DD=1: 5f d0 31            JBR sbafix 0x02d0.7, label_3855
label_3824:
...
0x3847 DD=1: b5 8d c7            CLRB off 0x068d
0x384a DD=1: b5 8e c7            CLRB off 0x068e
...
0x3859 DD=1: b5 90 70            MOVB R0, off 0x0690
0x385c DD=1: 5b ef 06            JBR sbafix 0x02ef.3, label_3865
0x385f DD=1: 10 1e               MOVB R0, #0x1e
0x3861 DD=0: 95 89               LB A, off 0x0689
...
label_386b:
0x386b DD=1: d4 70 7c            CMPB fix 0x0270, #0x7c
0x386e DD=0: fb                  CLRB A
0x386f DD=0: f2 0c               JLT label_387d
0x3871 DD=0: 95 8a               LB A, off 0x068a
label_3873:
0x3873 DD=0: ad 8b               ADDB A, off 0x068b
0x3875 DD=0: f2 04               JLT label_387b
0x3877 DD=0: ad 8c               ADDB A, off 0x068c
0x3879 DD=0: f5 02               JGE label_387d
label_387b:
0x387b DD=0: bc d7               FILLB A
label_387d:
0x387d DD=0: 35 8d               STB A, off 0x068d
label_387f:
0x387f DD=0: 68 87 90            MOVB off 0x0690, R0
label_3882:
0x3882 DD=0: 22 50 8e            MOV DP, #tbl_8e50
0x3885 DD=0: 44 00               ACAL label_1000
0x3887 DD=0: 35 8f               STB A, off 0x068f
0x3889 DD=0: 9d 8d               CMPB A, off 0x068d
0x388b DD=0: f7 02               JLE label_388f
0x388d DD=0: 95 8d               LB A, off 0x068d
label_388f:
0x388f DD=0: 35 8e               STB A, off 0x068e
label_3891:
0x3891 DD=0: b4 7f a7 03         TJZB fix 0x027f, label_3898
0x3895 DD=0: b6 42 0a            SB IRQ1L.2
label_3898:
0x3898 DD=0: 5e 6f               RB sbafix 0x02ef.6
label_389a:
0x389a DD=0: 02                  RTI
label_389b:
0x389b DD=1: 86 f8               L A, ADCR20
0x389d DD=1: b6 07 86 74         MOVB fix 0x0274, ACCH
0x38a1 DD=1: 86 f9               L A, ADCR21
0x38a3 DD=1: b6 07 86 75         MOVB fix 0x0275, ACCH
0x38a7 DD=1: 86 fa               L A, ADCR22
0x38a9 DD=1: b6 07 86 76         MOVB fix 0x0276, ACCH
0x38ad DD=1: 86 fb               L A, ADCR23
0x38af DD=1: b6 07 86 77         MOVB fix 0x0277, ACCH
...
label_3912:
0x3912 DD=1: b4 2a ab c1         MOVB fix 0x022a, #0xc1
0x3916 DD=0: ff                  BRK
label_3917:
...
label_3930:
0x3930 DD=1: b4 2a ab c5         MOVB fix 0x022a, #0xc5
0x3934 DD=0: ff                  BRK
label_3935:
0x3935 DD=1: 20 08 00            MOV X1, #0x0008
0x3938 DD=1: 85 0e               L A, off 0x060e
...
0x3953 DD=0: 95 10               LB A, off 0x0610
...
0x395d DD=0: 35 10               STB A, off 0x0610
0x395f DD=1: d9                  SDD
0x3960 DD=1: 60 ea d8            DJNZ X1L, label_393b
0x3963 DD=1: 72                  L A, DP
0x3964 DD=1: 35 0e               ST A, off 0x060e
0x3966 DD=1: f6 11               JNE label_3979
0x3968 DD=1: b7 14 a0 2f 0c      JBS tbl_a014.7, label_3979
0x396d DD=0: 95 10               LB A, off 0x0610
0x396f DD=0: f1 08               JEQ label_3979
0x3971 DD=0: b5 10 c7            CLRB off 0x0610
0x3974 DD=0: b4 2a ab c2         MOVB fix 0x022a, #0xc2
0x3978 DD=0: ff                  BRK
label_3979:
...
0x3987 DD=1: a6 46 93 0d 80      CMP IE0, #tbl_800d
0x398c DD=1: f6 3a               JNE label_39c8
0x398e DD=1: a6 48 93 4e 80      CMP IE1, #tbl_804e
...
label_39c8:
0x39c8 DD=0: b4 2a ab c0         MOVB fix 0x022a, #0xc0
0x39cc DD=0: ff                  BRK
label_39cd:
...
0x39dc DD=0: ac a5               ADDB A, fix 0x02a5
0x39de DD=0: f5 44               JGE label_3a24
0x39e0 DD=0: b5 b2 2e 49         JBS off 0x08b2.6, label_3a2d
0x39e4 DD=0: b5 b0 01            RB off 0x08b0.1
0x39e7 DD=0: f1 37               JEQ label_3a20
0x39e9 DD=0: d5 a3 48            CMPB off 0x08a3, #0x48
0x39ec DD=0: f6 05               JNE label_39f3
0x39ee DD=0: d5 a4 77            CMPB off 0x08a4, #0x77
0x39f1 DD=0: f1 01               JEQ label_39f4
label_39f3:
0x39f3 DD=0: ff                  BRK
label_39f4:
0x39f4 DD=0: da                  DI
0x39f5 DD=0: b5 b0 0a            SB off 0x08b0.2
...
label_3a20:
0x3a20 DD=0: b5 b0 28 03         JBS off 0x08b0.0, label_3a27
label_3a24:
0x3a24 DD=0: b5 a3 c7            CLRB off 0x08a3
label_3a27:
0x3a27 DD=0: b5 a4 c7            CLRB off 0x08a4
0x3a2a DD=0: b5 b0 02            RB off 0x08b0.2
label_3a2d:
0x3a2d DD=0: b5 b3 20 05         JBR off 0x08b3.0, label_3a36
0x3a31 DD=0: b7 6e 90 87 bb      MOVB off 0x08bb, tbl_906e
label_3a36:
0x3a36 DD=0: b5 b9 a6 07         TJNZB off 0x08b9, label_3a41
0x3a3a DD=0: b5 bb a6 03         TJNZB off 0x08bb, label_3a41
0x3a3e DD=0: b5 b3 05            RB off 0x08b3.5
label_3a41:
...
0x3a82 DD=0: 34 88               STB A, fix 0x0288
0x3a84 DD=0: 34 89               STB A, fix 0x0289
0x3a86 DD=0: 34 8a               STB A, fix 0x028a
0x3a88 DD=0: 34 8b               STB A, fix 0x028b
0x3a8a DD=0: b4 8c c7            CLRB fix 0x028c
0x3a8d DD=0: 5b 74               RB sbafix 0x02f4.3
0x3a8f DD=0: b4 e5 13            MB C, fix 0x02e5.3
0x3a92 DD=0: b4 f4 1a            MB fix 0x02f4.2, C
...
label_3aa3:
0x3aa3 DD=0: 58 a5 0f            JBS sbafix 0x02e5.0, label_3ab5
...
label_3ab5:
0x3ab5 DD=0: 94 74               LB A, fix 0x0274
0x3ab7 DD=0: 9f                  SRLB A
0x3ab8 DD=0: ae c0               ADDB A, #0xc0
0x3aba DD=0: 37 0e 05            STB A, 0x050e
0x3abd DD=0: 94 75               LB A, fix 0x0275
0x3abf DD=0: 9f                  SRLB A
0x3ac0 DD=0: ae c0               ADDB A, #0xc0
0x3ac2 DD=0: 37 0f 05            STB A, 0x050f
0x3ac5 DD=0: fb                  CLRB A
0x3ac6 DD=0: 5c a5 05            JBS sbafix 0x02e5.4, label_3ace
0x3ac9 DD=0: 94 76               LB A, fix 0x0276
0x3acb DD=0: 9f                  SRLB A
0x3acc DD=0: ae c0               ADDB A, #0xc0
label_3ace:
0x3ace DD=0: 37 10 05            STB A, 0x0510
0x3ad1 DD=0: 94 77               LB A, fix 0x0277
0x3ad3 DD=0: 9f                  SRLB A
0x3ad4 DD=0: ae c0               ADDB A, #0xc0
0x3ad6 DD=0: 37 11 05            STB A, 0x0511
label_3ad9:
0x3ad9 DD=0: f9 40               LB A, #0x40
0x3adb DD=0: 5c e5 02            JBR sbafix 0x02e5.4, label_3ae0
0x3ade DD=0: 94 76               LB A, fix 0x0276
label_3ae0:
0x3ae0 DD=0: 37 5d 05            STB A, 0x055d
0x3ae3 DD=0: fb                  CLRB A
0x3ae4 DD=0: 5f e5 02            JBR sbafix 0x02e5.7, label_3ae9
0x3ae7 DD=0: 94 77               LB A, fix 0x0277
label_3ae9:
0x3ae9 DD=0: 35 8c               STB A, off 0x068c
0x3aeb DD=0: 5c 94 10            JBS sbafix 0x02d4.4, label_3afe
...
label_3afe:
0x3afe DD=1: 5c 50               RB sbafix 0x02d0.4
0x3b00 DD=1: 04 02               SJ label_3b04
label_3b02:
0x3b02 DD=1: 5c 10               SB sbafix 0x02d0.4
label_3b04:
0x3b04 DD=1: 58 94 10            JBS sbafix 0x02d4.0, label_3b17
...
label_3b17:
0x3b17 DD=1: 58 50               RB sbafix 0x02d0.0
0x3b19 DD=1: 04 02               SJ label_3b1d
label_3b1b:
0x3b1b DD=1: 58 10               SB sbafix 0x02d0.0
label_3b1d:
0x3b1d DD=1: 58 e4 13            JBR sbafix 0x02e4.0, label_3b33
0x3b20 DD=1: 5d 96 10            JBS sbafix 0x02d6.5, label_3b33
...
0x3b71 DD=1: 9d 14               CMP A, off 0x0614
...
0x3b88 DD=1: 9d 12               CMP A, off 0x0612
0x3b8a DD=1: f2 03               JLT label_3b8f
label_3b8c:
0x3b8c DD=1: 65 87 12            MOV off 0x0612, ER1
label_3b8f:
0x3b8f DD=1: e0                  VCAL 0x0
0x3b90 DD=1: da                  DI
0x3b91 DD=1: d4 2d 02            CMPB fix 0x022d, #0x02
0x3b94 DD=1: f5 09               JGE label_3b9f
0x3b96 DD=1: 58 af 03            JBS sbafix 0x02ef.0, label_3b9c
0x3b99 DD=1: 59 af 03            JBS sbafix 0x02ef.1, label_3b9f
label_3b9c:
0x3b9c DD=1: 03 95 3c            J label_3c95
label_3b9f:
0x3b9f DD=1: 58 2f               SB sbafix 0x02ef.0
0x3ba1 DD=0: fb                  CLRB A
0x3ba2 DD=0: 34 2d               STB A, fix 0x022d
0x3ba4 DD=0: 34 e8               STB A, fix 0x02e8
0x3ba6 DD=0: 34 e9               STB A, fix 0x02e9
0x3ba8 DD=0: 34 ea               STB A, fix 0x02ea
0x3baa DD=0: 34 eb               STB A, fix 0x02eb
0x3bac DD=0: 34 ec               STB A, fix 0x02ec
0x3bae DD=0: 34 ed               STB A, fix 0x02ed
0x3bb0 DD=0: 34 ee               STB A, fix 0x02ee
0x3bb2 DD=0: 37 c0 04            STB A, 0x04c0
0x3bb5 DD=0: 37 c6 04            STB A, 0x04c6
0x3bb8 DD=0: 34 2c               STB A, fix 0x022c
0x3bba DD=0: 37 00 04            STB A, 0x0400
0x3bbd DD=0: 37 10 04            STB A, 0x0410
0x3bc0 DD=0: 37 18 04            STB A, 0x0418
0x3bc3 DD=1: fa                  CLR A
0x3bc4 DD=1: 34 44               ST A, fix 0x0244
0x3bc6 DD=1: 34 4e               ST A, fix 0x024e
0x3bc8 DD=1: 34 34               ST A, fix 0x0234
...
0x3bdc DD=1: b4 32 ab 17         MOVB fix 0x0232, #0x17
0x3be0 DD=1: a4 2e ab e8 ff      MOV fix 0x022e, #tbl_ffe8
...
0x3c13 DD=0: 97 45 8a            LB A, tbl_8a45
...
0x3c88 DD=0: 35 c0               STB A, off 0x06c0
0x3c8a DD=0: 35 c1               STB A, off 0x06c1
0x3c8c DD=0: d7 b7 05            MOVB off 0x06b7, #0x05
0x3c8f DD=0: d7 a8 0a            MOVB off 0x06a8, #0x0a
0x3c92 DD=0: b6 10 02            RB P0.2
label_3c95:
0x3c95 DD=0: 59 6f               RB sbafix 0x02ef.1
0x3c97 DD=0: db                  EI
0x3c98 DD=0: cb                  SC
0x3c99 DD=0: 58 af 0b            JBS sbafix 0x02ef.0, label_3ca7
0x3c9c DD=1: 84 34               L A, fix 0x0234
0x3c9e DD=1: 9e 65 07            CMP A, #0x0765
0x3ca1 DD=1: 5b af 03            JBS sbafix 0x02ef.3, label_3ca7
0x3ca4 DD=1: 9e 1c 07            CMP A, #0x071c
label_3ca7:
0x3ca7 DD=1: b4 ef 1b            MB fix 0x02ef.3, C
0x3caa DD=1: f5 12               JGE label_3cbe
0x3cac DD=1: b4 a1 c7            CLRB fix 0x02a1
0x3caf DD=1: b4 a2 c7            CLRB fix 0x02a2
0x3cb2 DD=1: d7 b2 0f            MOVB off 0x06b2, #0x0f
0x3cb5 DD=1: d7 b3 32            MOVB off 0x06b3, #0x32
0x3cb8 DD=1: 58 af 03            JBS sbafix 0x02ef.0, label_3cbe
0x3cbb DD=1: 5a 94 03            JBS sbafix 0x02d4.2, label_3cc1
label_3cbe:
0x3cbe DD=1: d7 ab 63            MOVB off 0x06ab, #0x63
label_3cc1:
0x3cc1 DD=1: ca                  RC
0x3cc2 DD=1: 5b 94 17            JBS sbafix 0x02d4.3, label_3cdc
0x3cc5 DD=1: 11 6e               MOVB R1, #0x6e
0x3cc7 DD=1: a6 eb 97            MOV A, ADCR11
0x3cca DD=0: 96 07               LB A, ACCH
0x3ccc DD=0: b7 c8 8e 94         CMPB tbl_8ec8, A
0x3cd0 DD=0: f2 07               JLT label_3cd9
0x3cd2 DD=0: b7 c7 8e 95         CMPB A, tbl_8ec7
0x3cd6 DD=0: f2 01               JLT label_3cd9
0x3cd8 DD=0: 39                  STB A, R1
label_3cd9:
0x3cd9 DD=0: 69 86 6f            MOVB fix 0x026f, R1
label_3cdc:
0x3cdc DD=0: b4 d0 1b            MB fix 0x02d0.3, C
0x3cdf DD=0: 11 58               MOVB R1, #0x58
0x3ce1 DD=0: 5a 94 37            JBS sbafix 0x02d4.2, label_3d1b
0x3ce4 DD=0: a6 f2 97            MOV A, ADCR14
0x3ce7 DD=0: 96 07               LB A, ACCH
0x3ce9 DD=0: b7 d3 8e 94         CMPB tbl_8ed3, A
0x3ced DD=0: f2 04               JLT label_3cf3
0x3cef DD=0: b7 d2 8e 95         CMPB A, tbl_8ed2
label_3cf3:
0x3cf3 DD=0: b4 d0 1f            MB fix 0x02d0.7, C
0x3cf6 DD=0: f2 3c               JLT label_3d34
0x3cf8 DD=0: 39                  STB A, R1
0x3cf9 DD=0: 8d 18               SUBB A, off 0x0618
0x3cfb DD=0: f5 01               JGE label_3cfe
0x3cfd DD=0: cf                  NEGB A
label_3cfe:
0x3cfe DD=0: 9e 03               CMPB A, #0x03
0x3d00 DD=0: f5 14               JGE label_3d16
0x3d02 DD=0: 95 ac               LB A, off 0x06ac
0x3d04 DD=0: f6 36               JNE label_3d3c
0x3d06 DD=0: 79                  LB A, R1
0x3d07 DD=0: 58 af 04            JBS sbafix 0x02ef.0, label_3d0e
0x3d0a DD=0: 9d 19               CMPB A, off 0x0619
...
label_3d16:
0x3d16 DD=0: 69 87 18            MOVB off 0x0618, R1
0x3d19 DD=0: 04 1c               SJ label_3d37
label_3d1b:
0x3d1b DD=0: 5f 50               RB sbafix 0x02d0.7
0x3d1d DD=0: 5b ef 14            JBR sbafix 0x02ef.3, label_3d34
0x3d20 DD=1: fa                  CLR A
0x3d21 DD=0: 95 ab               LB A, off 0x06ab
0x3d23 DD=0: b7 d7 8e 70         MOVB R0, tbl_8ed7
0x3d27 DD=0: 68 a8               DIVB R0
0x3d29 DD=0: 9e 05               CMPB A, #0x05
0x3d2b DD=0: f2 02               JLT label_3d2f
0x3d2d DD=0: f9 04               LB A, #0x04
label_3d2f:
0x3d2f DD=0: 20 d8 8e            MOV X1, #tbl_8ed8
0x3d32 DD=0: ba 71               MOVB R1, [X1+A]
label_3d34:
0x3d34 DD=0: 69 86 70            MOVB fix 0x0270, R1
label_3d37:
0x3d37 DD=0: b7 d4 8e 87 ac      MOVB off 0x06ac, tbl_8ed4
label_3d3c:
0x3d3c DD=0: 22 11 88            MOV DP, #tbl_8811
0x3d3f DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_3d45
0x3d42 DD=0: 22 a8 88            MOV DP, #tbl_88a8
label_3d45:
...
0x3d67 DD=0: db                  EI
0x3d68 DD=0: 22 2b 8b            MOV DP, #tbl_8b2b
0x3d6b DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_3d71
0x3d6e DD=0: 22 87 8b            MOV DP, #tbl_8b87
label_3d71:
...
0x3d90 DD=0: 22 84 89            MOV DP, #tbl_8984
0x3d93 DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_3d99
0x3d96 DD=0: 22 ae 89            MOV DP, #tbl_89ae
label_3d99:
0x3d99 DD=0: 44 00               ACAL label_1000
0x3d9b DD=0: 37 77 03            STB A, 0x0377
0x3d9e DD=0: 4c 84 0b            JBS sbaoff 0x06c4.4, label_3dac
0x3da1 DD=0: 22 6e 8e            MOV DP, #tbl_8e6e
0x3da4 DD=0: 44 00               ACAL label_1000
0x3da6 DD=0: 35 89               STB A, off 0x0689
0x3da8 DD=0: 35 8e               STB A, off 0x068e
0x3daa DD=0: 4c 04               SB sbaoff 0x06c4.4
label_3dac:
0x3dac DD=0: e0                  VCAL 0x0
0x3dad DD=0: f9 94               LB A, #0x94
0x3daf DD=0: 22 6e 02            MOV DP, #0x026e
0x3db2 DD=0: 5d 94 11            JBS sbafix 0x02d4.5, label_3dc6
...
0x3dc7 DD=0: ca                  RC
label_3dc8:
0x3dc8 DD=0: b4 d0 1d            MB fix 0x02d0.5, C
0x3dcb DD=0: f9 80               LB A, #0x80
0x3dcd DD=0: 59 a7 25            JBS sbafix 0x02e7.1, label_3df5
0x3dd0 DD=0: 22 3f 89            MOV DP, #tbl_893f
0x3dd3 DD=1: 84 34               L A, fix 0x0234
...
label_3df1:
0x3df1 DD=0: 94 6e               LB A, fix 0x026e
0x3df3 DD=0: 44 04               ACAL label_1004
label_3df5:
0x3df5 DD=0: 37 4a 03            STB A, 0x034a
0x3df8 DD=0: 22 b9 8a            MOV DP, #tbl_8ab9
0x3dfb DD=0: 5a f1 03            JBR sbafix 0x02f1.2, label_3e01
0x3dfe DD=0: 22 f2 8a            MOV DP, #tbl_8af2
label_3e01:
0x3e01 DD=0: 94 6e               LB A, fix 0x026e
0x3e03 DD=0: 44 04               ACAL label_1004
0x3e05 DD=0: 37 13 05            STB A, 0x0513
0x3e08 DD=0: e0                  VCAL 0x0
0x3e09 DD=0: 5a a6 03            JBS sbafix 0x02e6.2, label_3e0f
0x3e0c DD=0: 03 4a 3e            J label_3e4a
label_3e0f:
0x3e0f DD=0: 95 1b               LB A, off 0x061b
0x3e11 DD=0: 58 ef 31            JBR sbafix 0x02ef.0, label_3e45
0x3e14 DD=0: f9 f9               LB A, #0xf9
0x3e16 DD=0: 58 94 2c            JBS sbafix 0x02d4.0, label_3e45
0x3e19 DD=0: 59 94 29            JBS sbafix 0x02d4.1, label_3e45
0x3e1c DD=1: 86 e1               L A, ADCR1
0x3e1e DD=1: 58 a4 10            JBS sbafix 0x02e4.0, label_3e31
...
0x3e44 DD=0: d8                  RDD
label_3e45:
0x3e45 DD=0: 35 1b               STB A, off 0x061b
0x3e47 DD=0: 5b e6 38            JBR sbafix 0x02e6.3, label_3e82
label_3e4a:
0x3e4a DD=0: 22 1a 06            MOV DP, #0x061a
0x3e4d DD=0: f9 f9               LB A, #0xf9
0x3e4f DD=0: 5e 94 26            JBS sbafix 0x02d4.6, label_3e78
0x3e52 DD=1: 86 e3               L A, ADCR3
0x3e54 DD=1: 5a a6 0d            JBS sbafix 0x02e6.2, label_3e64
...
0x3e71 DD=1: df                  SWAP
0x3e72 DD=0: d8                  RDD
0x3e73 DD=0: 5a a6 02            JBS sbafix 0x02e6.2, label_3e78
0x3e76 DD=0: 47 03               ACAL label_1303
label_3e78:
0x3e78 DD=0: 32                  STB A, [DP]
0x3e79 DD=0: ca                  RC
label_3e7a:
0x3e7a DD=0: b4 d0 1e            MB fix 0x02d0.6, C
0x3e7d DD=0: 95 1a               LB A, off 0x061a
0x3e7f DD=0: 5a e6 02            JBR sbafix 0x02e6.2, label_3e84
label_3e82:
0x3e82 DD=0: 95 1b               LB A, off 0x061b
label_3e84:
0x3e84 DD=0: 34 71               STB A, fix 0x0271
0x3e86 DD=0: 22 ee 87            MOV DP, #tbl_87ee
0x3e89 DD=0: 94 71               LB A, fix 0x0271
0x3e8b DD=0: 44 04               ACAL label_1004
0x3e8d DD=0: 37 4f 03            STB A, 0x034f
0x3e90 DD=0: 22 fb 87            MOV DP, #tbl_87fb
0x3e93 DD=0: 94 71               LB A, fix 0x0271
0x3e95 DD=0: 44 04               ACAL label_1004
0x3e97 DD=0: 37 50 03            STB A, 0x0350
0x3e9a DD=0: 22 08 88            MOV DP, #tbl_8808
0x3e9d DD=0: 94 71               LB A, fix 0x0271
0x3e9f DD=0: 44 04               ACAL label_1004
0x3ea1 DD=0: 37 4e 03            STB A, 0x034e
0x3ea4 DD=1: fa                  CLR A
0x3ea5 DD=1: b4 71 97            MOVB A, fix 0x0271
...
0x3ee8 DD=0: 34 72               STB A, fix 0x0272
0x3eea DD=0: 5f e6 23            JBR sbafix 0x02e6.7, label_3f10
0x3eed DD=0: 5c e6 20            JBR sbafix 0x02e6.4, label_3f10
0x3ef0 DD=0: fb                  CLRB A
0x3ef1 DD=0: a7 e8 8e a9         MUL tbl_8ee8
...
0x3f03 DD=0: a7 ea 8e fb         DIVQ tbl_8eea
0x3f07 DD=0: 9a 29 04            JBS PSWH.1, label_3f0e
0x3f0a DD=0: b6 07 a7 02         TJZB ACCH, label_3f10
label_3f0e:
0x3f0e DD=0: bc d7               FILLB A
label_3f10:
0x3f10 DD=0: 34 73               STB A, fix 0x0273
0x3f12 DD=0: 94 73               LB A, fix 0x0273
0x3f14 DD=0: 22 e9 89            MOV DP, #tbl_89e9
0x3f17 DD=0: 44 30               ACAL label_1030
0x3f19 DD=0: 37 3c 03            STB A, 0x033c
0x3f1c DD=0: 94 73               LB A, fix 0x0273
0x3f1e DD=0: 22 0c 8d            MOV DP, #tbl_8d0c
...
0x3f2a DD=0: 5c d4 03            JBR sbafix 0x02d4.4, label_3f30
0x3f2d DD=0: 03 98 3f            J label_3f98
label_3f30:
0x3f30 DD=0: 58 af 23            JBS sbafix 0x02ef.0, label_3f56
...
label_3f56:
0x3f56 DD=0: 48 45               RB sbaoff 0x06c5.0
...
0x3f63 DD=0: 48 85 0c            JBS sbaoff 0x06c5.0, label_3f72
0x3f66 DD=0: 10 13               MOVB R0, #0x13
0x3f68 DD=0: 8a 2b 02            JBS PSWL.3, label_3f6d
0x3f6b DD=0: 10 be               MOVB R0, #0xbe
label_3f6d:
0x3f6d DD=0: 68 87 a9            MOVB off 0x06a9, R0
0x3f70 DD=0: 48 05               SB sbaoff 0x06c5.0
label_3f72:
0x3f72 DD=0: b5 a9 a6 1c         TJNZB off 0x06a9, label_3f92
0x3f76 DD=0: 8a 2e 19            JBS PSWL.6, label_3f92
0x3f79 DD=0: 32                  STB A, [DP]
0x3f7a DD=0: 49 85 15            JBS sbaoff 0x06c5.1, label_3f92
0x3f7d DD=0: 49 05               SB sbaoff 0x06c5.1
0x3f7f DD=0: 35 91               STB A, off 0x0691
0x3f81 DD=0: a5 94 71            MOV ER1, off 0x0694
0x3f84 DD=0: 65 a3 01 00         ADD ER1, #0x0001
0x3f88 DD=0: f2 03               JLT label_3f8d
0x3f8a DD=0: 65 87 94            MOV off 0x0694, ER1
label_3f8d:
0x3f8d DD=0: 65 87 96            MOV off 0x0696, ER1
0x3f90 DD=0: 5b 36               SB sbafix 0x02f6.3
label_3f92:
...
0x3f9c DD=0: ca                  RC
0x3f9d DD=0: 4c 85 1e            JBS sbaoff 0x06c5.4, label_3fbe
0x3fa0 DD=0: 58 94 1b            JBS sbafix 0x02d4.0, label_3fbe
0x3fa3 DD=0: 59 94 18            JBS sbafix 0x02d4.1, label_3fbe
0x3fa6 DD=0: 94 a5               LB A, fix 0x02a5
0x3fa8 DD=0: ae 20               ADDB A, #0x20
0x3faa DD=0: f5 03               JGE label_3faf
0x3fac DD=0: 58 ef 0f            JBR sbafix 0x02ef.0, label_3fbe
label_3faf:
0x3faf DD=1: 87 12 04            L A, 0x0412
0x3fb2 DD=0: 95 1c               LB A, off 0x061c
...
label_3fbe:
0x3fbe DD=0: 4c 05               SB sbaoff 0x06c5.4
0x3fc0 DD=0: ca                  RC
0x3fc1 DD=0: 04 04               SJ label_3fc7
label_3fc3:
0x3fc3 DD=0: f9 30               LB A, #0x30
0x3fc5 DD=0: 9c a1               CMPB A, fix 0x02a1
label_3fc7:
0x3fc7 DD=0: b4 d0 19            MB fix 0x02d0.1, C
0x3fca DD=0: 58 e4 30            JBR sbafix 0x02e4.0, label_3ffd
0x3fcd DD=0: 58 a6 2d            JBS sbafix 0x02e6.0, label_3ffd
0x3fd0 DD=0: 4e 85 2a            JBS sbaoff 0x06c5.6, label_3ffd
0x3fd3 DD=0: 5d 96 27            JBS sbafix 0x02d6.5, label_3ffd
0x3fd6 DD=0: 5e 96 24            JBS sbafix 0x02d6.6, label_3ffd
0x3fd9 DD=0: 94 a5               LB A, fix 0x02a5
...
label_3ffd:
0x3ffd DD=0: 4e 05               SB sbaoff 0x06c5.6
label_3fff:
0x3fff DD=0: ca                  RC
0x4000 DD=0: 04 04               SJ label_4006
label_4002:
0x4002 DD=0: f9 30               LB A, #0x30
0x4004 DD=0: 9c a1               CMPB A, fix 0x02a1
label_4006:
0x4006 DD=0: b4 d1 19            MB fix 0x02d1.1, C
0x4009 DD=0: ca                  RC
0x400a DD=0: 94 d5               LB A, fix 0x02d5
0x400c DD=0: be 0f               ANDB A, #0x0f
0x400e DD=0: f6 06               JNE label_4016
0x4010 DD=0: 94 a5               LB A, fix 0x02a5
0x4012 DD=0: ae 14               ADDB A, #0x14
0x4014 DD=0: f2 04               JLT label_401a
label_4016:
0x4016 DD=0: b4 ef 10            MB C, fix 0x02ef.0
0x4019 DD=0: fd                  CPL C
label_401a:
0x401a DD=0: b6 10 18            MB P0.0, C
0x401d DD=0: 8a 03               RB PSWL.3
0x401f DD=0: 58 af 16            JBS sbafix 0x02ef.0, label_4038
0x4022 DD=1: 84 34               L A, fix 0x0234
0x4024 DD=1: a4 3c 72            MOV ER2, fix 0x023c
0x4027 DD=1: 4d c2 12            JBR sbaoff 0x06c2.5, label_403c
0x402a DD=1: 5e dc 0b            JBR sbafix 0x02dc.6, label_4038
...
label_403c:
0x403c DD=1: 4e 82 1a            JBS sbaoff 0x06c2.6, label_4059
0x403f DD=1: b5 35 c7            CLRB off 0x0635
...
label_4050:
0x4050 DD=1: b5 b5 a6 5b         TJNZB off 0x06b5, label_40af
0x4054 DD=1: d7 b4 32            MOVB off 0x06b4, #0x32
0x4057 DD=1: 4e 02               SB sbaoff 0x06c2.6
label_4059:
0x4059 DD=1: b5 a6 a6 43         TJNZB off 0x06a6, label_40a0
0x405d DD=1: d7 a6 0a            MOVB off 0x06a6, #0x0a
0x4060 DD=1: 84 34               L A, fix 0x0234
0x4062 DD=1: d5 35 04            CMPB off 0x0635, #0x04
0x4065 DD=1: f2 24               JLT label_408b
0x4067 DD=1: 38                  ST A, ER0
0x4068 DD=1: fa                  CLR A
0x4069 DD=1: 64 a1 38            ADD ER0, off 0x0638
0x406c DD=1: bc f3 00 00         ADC A, #0x0000
0x4070 DD=1: 64 a1 3a            ADD ER0, off 0x063a
0x4073 DD=1: bc f3 00 00         ADC A, #0x0000
0x4077 DD=1: 64 a1 3c            ADD ER0, off 0x063c
0x407a DD=1: bc f3 00 00         ADC A, #0x0000
0x407e DD=1: 64 a1 3e            ADD ER0, off 0x063e
0x4081 DD=1: bc f3 00 00         ADC A, #0x0000
0x4085 DD=1: 6b c7               CLRB R3
0x4087 DD=1: 12 05               MOVB R2, #0x05
0x4089 DD=1: 65 fb               DIVQ ER1
label_408b:
0x408b DD=1: 35 36               ST A, off 0x0636
0x408d DD=1: a5 38 c8            XCHG A, off 0x0638
0x4090 DD=1: a5 3a c8            XCHG A, off 0x063a
0x4093 DD=1: a5 3c c8            XCHG A, off 0x063c
0x4096 DD=1: 35 3e               ST A, off 0x063e
0x4098 DD=1: b5 35 c6            INCB off 0x0635
0x409b DD=1: f6 03               JNE label_40a0
0x409d DD=1: b5 35 d7            FILLB off 0x0635
label_40a0:
0x40a0 DD=1: 66 93 33 00         CMP ER2, #0x0033
0x40a4 DD=1: f7 0c               JLE label_40b2
0x40a6 DD=1: 22 ec 8e            MOV DP, #tbl_8eec
0x40a9 DD=1: 85 36               L A, off 0x0636
0x40ab DD=1: 44 70               ACAL label_1070
0x40ad DD=1: 35 b4               ST A, off 0x06b4
label_40af:
0x40af DD=1: 03 e4 40            J label_40e4
label_40b2:
0x40b2 DD=1: ca                  RC
0x40b3 DD=1: b5 b4 a7 22         TJZB off 0x06b4, label_40d9
0x40b7 DD=1: 4f 82 08            JBS sbaoff 0x06c2.7, label_40c2
0x40ba DD=1: 5e 9c 11            JBS sbafix 0x02dc.6, label_40ce
0x40bd DD=1: d7 a7 64            MOVB off 0x06a7, #0x64
0x40c0 DD=1: 4f 02               SB sbaoff 0x06c2.7
label_40c2:
0x40c2 DD=1: 8a 0b               SB PSWL.3
0x40c4 DD=1: b5 a7 a6 06         TJNZB off 0x06a7, label_40ce
0x40c8 DD=1: 5e dc 03            JBR sbafix 0x02dc.6, label_40ce
0x40cb DD=1: cb                  SC
0x40cc DD=1: 4f 42               RB sbaoff 0x06c2.7
label_40ce:
0x40ce DD=1: b5 c3 1f            MB off 0x06c3.7, C
label_40d1:
0x40d1 DD=1: b5 c2 1d            MB off 0x06c2.5, C
0x40d4 DD=1: b6 11 19            MB P1.1, C
0x40d7 DD=1: 04 03               SJ label_40dc
label_40d9:
0x40d9 DD=1: b5 c2 1f            MB off 0x06c2.7, C
label_40dc:
0x40dc DD=1: 8a 2b 05            JBS PSWL.3, label_40e4
0x40df DD=1: 4e 42               RB sbaoff 0x06c2.6
0x40e1 DD=1: d7 b5 0f            MOVB off 0x06b5, #0x0f
label_40e4:
0x40e4 DD=1: ca                  RC
0x40e5 DD=1: 5c dc 23            JBR sbafix 0x02dc.4, label_410b
0x40e8 DD=1: b7 d0 03 2d 0a      JBS 0x03d0.5, label_40f7
0x40ed DD=1: b5 b9 a6 09         TJNZB off 0x06b9, label_40fa
0x40f1 DD=1: cb                  SC
0x40f2 DD=1: d7 ba 0a            MOVB off 0x06ba, #0x0a
0x40f5 DD=1: 04 14               SJ label_410b
label_40f7:
0x40f7 DD=1: d7 b9 14            MOVB off 0x06b9, #0x14
label_40fa:
0x40fa DD=1: b5 ba a7 05         TJZB off 0x06ba, label_4103
0x40fe DD=1: d7 bb 0a            MOVB off 0x06bb, #0x0a
0x4101 DD=1: 04 08               SJ label_410b
label_4103:
0x4103 DD=1: cb                  SC
0x4104 DD=1: b5 bb a6 03         TJNZB off 0x06bb, label_410b
0x4108 DD=1: d7 ba 0a            MOVB off 0x06ba, #0x0a
label_410b:
...
0x4120 DD=1: 59 b9 03            JBS sbafix 0x02f9.1, label_4126
0x4123 DD=1: 03 de 41            J label_41de
label_4126:
0x4126 DD=1: e0                  VCAL 0x0
0x4127 DD=1: a4 d0 70            MOV ER0, fix 0x02d0
...
0x4134 DD=0: 8d 9e               SUBB A, off 0x069e
0x4136 DD=0: f6 03               JNE label_413b
0x4138 DD=0: 35 9e               STB A, off 0x069e
0x413a DD=0: 32                  STB A, [DP]
label_413b:
0x413b DD=0: 7f                  LB A, R7
0x413c DD=0: 8d 9f               SUBB A, off 0x069f
0x413e DD=0: f6 0b               JNE label_414b
0x4140 DD=0: 35 9f               STB A, off 0x069f
0x4142 DD=0: 04 07               SJ label_414b
label_4144:
0x4144 DD=0: 95 9e               LB A, off 0x069e
...
0x415a DD=0: 35 9e               STB A, off 0x069e
0x415c DD=0: 20 b9 8f            MOV X1, #tbl_8fb9
0x415f DD=0: ba 8a               MOVB [DP], [X1+A]
label_4161:
0x4161 DD=1: fa                  CLR A
0x4162 DD=1: a4 d2 c8            XCHG A, fix 0x02d2
...
0x4195 DD=0: 95 9f               LB A, off 0x069f
0x4197 DD=0: f6 05               JNE label_419e
0x4199 DD=0: 6f 87 9f            MOVB off 0x069f, R7
0x419c DD=0: 04 11               SJ label_41af
label_419e:
0x419e DD=0: 0f                  SUBB A, R7
0x419f DD=0: f6 0e               JNE label_41af
0x41a1 DD=0: 35 9f               STB A, off 0x069f
0x41a3 DD=0: 7f                  LB A, R7
0x41a4 DD=0: 20 d9 8f            MOV X1, #tbl_8fd9
...
label_41af:
0x41af DD=0: 94 d4               LB A, fix 0x02d4
0x41b1 DD=0: ac d5               ADDB A, fix 0x02d5
0x41b3 DD=0: ac d6               ADDB A, fix 0x02d6
0x41b5 DD=0: ac d7               ADDB A, fix 0x02d7
0x41b7 DD=0: 9c 9f               CMPB A, fix 0x029f
0x41b9 DD=0: f6 11               JNE label_41cc
0x41bb DD=0: fb                  CLRB A
0x41bc DD=0: b4 d4 d5            XORB A, fix 0x02d4
0x41bf DD=0: b4 d5 d5            XORB A, fix 0x02d5
0x41c2 DD=0: b4 d6 d5            XORB A, fix 0x02d6
0x41c5 DD=0: b4 d7 d5            XORB A, fix 0x02d7
0x41c8 DD=0: 9c a0               CMPB A, fix 0x02a0
0x41ca DD=0: f1 12               JEQ label_41de
label_41cc:
0x41cc DD=1: fa                  CLR A
0x41cd DD=1: 34 d4               ST A, fix 0x02d4
0x41cf DD=1: 34 d6               ST A, fix 0x02d6
0x41d1 DD=1: 5d 75               RB sbafix 0x02f5.5
0x41d3 DD=0: d8                  RDD
0x41d4 DD=0: 34 9f               STB A, fix 0x029f
0x41d6 DD=0: 34 a0               STB A, fix 0x02a0
0x41d8 DD=0: 35 2f               STB A, off 0x062f
0x41da DD=0: 35 30               STB A, off 0x0630
0x41dc DD=0: 35 ad               STB A, off 0x06ad
label_41de:
0x41de DD=0: d6 03 0c            MOVB LRBH, #0x0c
0x41e1 DD=1: 87 19 90            L A, tbl_9019
0x41e4 DD=1: a4 34 a9            MUL fix 0x0234
0x41e7 DD=1: 37 06 0c            ST A, 0x0c06
0x41ea DD=1: 86 e0               L A, ADCR0
0x41ec DD=1: b6 07 87 08         MOVB off 0x0c08, ACCH
0x41f0 DD=1: bc 9f               SRL A, 4
0x41f2 DD=1: bc 9d               SRL A, 2
0x41f4 DD=1: 64 c7               CLR ER0
0x41f6 DD=1: b4 42 70            MOVB R0, fix 0x0242
0x41f9 DD=1: 08                  SUB A, ER0
0x41fa DD=1: f5 01               JGE label_41fd
0x41fc DD=1: fa                  CLR A
label_41fd:
0x41fd DD=1: a7 1b 90 70         MOV ER0, tbl_901b
0x4201 DD=1: 64 a9               MUL ER0
0x4203 DD=0: d8                  RDD
0x4204 DD=0: b6 07 a7 02         TJZB ACCH, label_420a
0x4208 DD=0: bc d7               FILLB A
label_420a:
0x420a DD=0: 35 09               STB A, off 0x0c09
0x420c DD=1: 86 eb               L A, ADCR11
0x420e DD=0: 96 07               LB A, ACCH
0x4210 DD=0: 35 0a               STB A, off 0x0c0a
0x4212 DD=0: 22 1d 90            MOV DP, #tbl_901d
0x4215 DD=0: 44 04               ACAL label_1004
0x4217 DD=0: 35 0b               STB A, off 0x0c0b
0x4219 DD=1: 86 ea               L A, ADCR10
0x421b DD=0: 96 07               LB A, ACCH
0x421d DD=0: 35 0c               STB A, off 0x0c0c
0x421f DD=0: 22 32 90            MOV DP, #tbl_9032
0x4222 DD=0: 44 04               ACAL label_1004
0x4224 DD=0: 35 0d               STB A, off 0x0c0d
0x4226 DD=1: 86 e1               L A, ADCR1
0x4228 DD=1: b6 07 87 0e         MOVB off 0x0c0e, ACCH
0x422c DD=1: bc 9f               SRL A, 4
0x422e DD=1: bc 9d               SRL A, 2
0x4230 DD=1: a7 47 90 85         SUB A, tbl_9047
0x4234 DD=1: f5 01               JGE label_4237
0x4236 DD=1: fa                  CLR A
label_4237:
0x4237 DD=1: a7 49 90 70         MOV ER0, tbl_9049
0x423b DD=1: 64 a9               MUL ER0
0x423d DD=0: d8                  RDD
0x423e DD=0: b6 07 a7 02         TJZB ACCH, label_4244
0x4242 DD=0: bc d7               FILLB A
label_4244:
0x4244 DD=0: 35 0f               STB A, off 0x0c0f
0x4246 DD=1: f8 ff ff            L A, #tbl_ffff
0x4249 DD=1: b6 07 87 10         MOVB off 0x0c10, ACCH
0x424d DD=1: bc 9f               SRL A, 4
0x424f DD=1: bc 9d               SRL A, 2
0x4251 DD=1: a7 4b 90 85         SUB A, tbl_904b
0x4255 DD=1: f5 01               JGE label_4258
0x4257 DD=1: fa                  CLR A
label_4258:
0x4258 DD=1: a7 4d 90 70         MOV ER0, tbl_904d
0x425c DD=1: 64 a9               MUL ER0
0x425e DD=0: d8                  RDD
0x425f DD=0: b6 07 a7 02         TJZB ACCH, label_4265
0x4263 DD=0: bc d7               FILLB A
label_4265:
0x4265 DD=0: d7 11 ff            MOVB off 0x0c11, #0xff
0x4268 DD=1: 86 e6               L A, ADCR6
0x426a DD=1: bc 9f               SRL A, 4
0x426c DD=1: bc 9d               SRL A, 2
0x426e DD=1: a7 4f 90 70         MOV ER0, tbl_904f
0x4272 DD=1: 64 a9               MUL ER0
0x4274 DD=0: d8                  RDD
0x4275 DD=0: b6 07 a7 02         TJZB ACCH, label_427b
0x4279 DD=0: bc d7               FILLB A
label_427b:
0x427b DD=0: 35 12               STB A, off 0x0c12
0x427d DD=1: fa                  CLR A
0x427e DD=1: 58 af 05            JBS sbafix 0x02ef.0, label_4286
0x4281 DD=1: 87 3e 03            L A, 0x033e
0x4284 DD=1: bc 9d               SRL A, 2
label_4286:
0x4286 DD=1: 35 14               ST A, off 0x0c14
0x4288 DD=0: f9 80               LB A, #0x80
0x428a DD=0: 58 af 1f            JBS sbafix 0x02ef.0, label_42ac
0x428d DD=0: b7 e1 05 29 1a      JBS 0x05e1.1, label_42ac
0x4292 DD=0: 97 51 90            LB A, tbl_9051
0x4295 DD=0: b7 e1 05 20 12      JBR 0x05e1.0, label_42ac
0x429a DD=1: fa                  CLR A
0x429b DD=0: 97 21 05            LB A, 0x0521
0x429e DD=0: a7 52 90 70         MOV ER0, tbl_9052
0x42a2 DD=0: 64 a9               MUL ER0
0x42a4 DD=0: b7 54 90 a5         ADDB A, tbl_9054
0x42a8 DD=0: f5 02               JGE label_42ac
0x42aa DD=0: bc d7               FILLB A
label_42ac:
0x42ac DD=0: 35 16               STB A, off 0x0c16
0x42ae DD=0: b7 54 05 87 17      MOVB off 0x0c17, 0x0554
0x42b3 DD=1: 86 f2               L A, ADCR14
0x42b5 DD=0: 96 07               LB A, ACCH
0x42b7 DD=0: 35 18               STB A, off 0x0c18
0x42b9 DD=0: 22 55 90            MOV DP, #tbl_9055
0x42bc DD=0: 44 04               ACAL label_1004
0x42be DD=0: 35 19               STB A, off 0x0c19
0x42c0 DD=1: 86 e2               L A, ADCR2
0x42c2 DD=1: b6 07 87 1a         MOVB off 0x0c1a, ACCH
0x42c6 DD=1: bc 9f               SRL A, 4
0x42c8 DD=1: bc 9d               SRL A, 2
0x42ca DD=1: a7 6a 90 85         SUB A, tbl_906a
0x42ce DD=1: f5 01               JGE label_42d1
0x42d0 DD=1: fa                  CLR A
label_42d1:
0x42d1 DD=1: a7 6c 90 70         MOV ER0, tbl_906c
0x42d5 DD=1: 64 a9               MUL ER0
0x42d7 DD=0: d8                  RDD
0x42d8 DD=0: b6 07 a7 02         TJZB ACCH, label_42de
0x42dc DD=0: bc d7               FILLB A
label_42de:
0x42de DD=0: 35 1b               STB A, off 0x0c1b
...
label_4308:
0x4308 DD=0: 35 22               STB A, off 0x0c22
0x430a DD=1: 86 f1               L A, ADCR13
0x430c DD=1: b6 07 87 23         MOVB off 0x0c23, ACCH
0x4310 DD=1: b7 5e 05 87 24      MOVB off 0x0c24, 0x055e
0x4315 DD=1: 86 f3               L A, ADCR15
0x4317 DD=1: b6 07 87 25         MOVB off 0x0c25, ACCH
0x431b DD=1: b5 26 c7            CLRB off 0x0c26
0x431e DD=0: fb                  CLRB A
0x431f DD=0: b4 dc 10            MB C, fix 0x02dc.0
0x4322 DD=0: bc 1a               MB A.2, C
0x4324 DD=0: 35 27               STB A, off 0x0c27
0x4326 DD=0: fb                  CLRB A
0x4327 DD=0: b4 dc 17            MB C, fix 0x02dc.7
0x432a DD=0: fd                  CPL C
0x432b DD=0: bc 19               MB A.1, C
0x432d DD=0: b4 dc 12            MB C, fix 0x02dc.2
0x4330 DD=0: bc 1a               MB A.2, C
0x4332 DD=0: b4 dc 11            MB C, fix 0x02dc.1
0x4335 DD=0: bc 1b               MB A.3, C
0x4337 DD=0: b4 dc 13            MB C, fix 0x02dc.3
0x433a DD=0: bc 1c               MB A.4, C
0x433c DD=0: b4 dc 14            MB C, fix 0x02dc.4
0x433f DD=0: bc 1d               MB A.5, C
0x4341 DD=0: b4 dc 16            MB C, fix 0x02dc.6
0x4344 DD=0: bc 1e               MB A.6, C
0x4346 DD=0: b4 df 10            MB C, fix 0x02df.0
0x4349 DD=0: bc 1f               MB A.7, C
0x434b DD=0: 35 28               STB A, off 0x0c28
0x434d DD=0: fb                  CLRB A
0x434e DD=0: 35 29               STB A, off 0x0c29
0x4350 DD=0: fb                  CLRB A
0x4351 DD=0: 35 2a               STB A, off 0x0c2a
0x4353 DD=0: fb                  CLRB A
0x4354 DD=0: b6 10 10            MB C, P0.0
0x4357 DD=0: bc 18               MB A.0, C
0x4359 DD=0: 35 2b               STB A, off 0x0c2b
0x435b DD=0: fb                  CLRB A
0x435c DD=0: b7 c2 06 15         MB C, 0x06c2.5
0x4360 DD=0: bc 19               MB A.1, C
0x4362 DD=0: 35 2c               STB A, off 0x0c2c
...
0x4374 DD=0: 95 96               LB A, off 0x0c96
0x4376 DD=0: f1 03               JEQ label_437b
label_4378:
0x4378 DD=0: 03 eb 43            J label_43eb
label_437b:
0x437b DD=0: a5 06 87 80         MOV off 0x0c80, off 0x0c06
0x437f DD=0: b5 08 87 82         MOVB off 0x0c82, off 0x0c08
0x4383 DD=0: b5 09 87 83         MOVB off 0x0c83, off 0x0c09
0x4387 DD=0: b5 0a 87 84         MOVB off 0x0c84, off 0x0c0a
0x438b DD=0: b5 0b 87 85         MOVB off 0x0c85, off 0x0c0b
0x438f DD=0: b5 0c 87 86         MOVB off 0x0c86, off 0x0c0c
0x4393 DD=0: b5 0d 87 87         MOVB off 0x0c87, off 0x0c0d
0x4397 DD=0: b5 0e 87 88         MOVB off 0x0c88, off 0x0c0e
0x439b DD=0: b5 0f 87 89         MOVB off 0x0c89, off 0x0c0f
0x439f DD=0: b5 10 87 8a         MOVB off 0x0c8a, off 0x0c10
0x43a3 DD=0: b5 11 87 8b         MOVB off 0x0c8b, off 0x0c11
0x43a7 DD=0: b5 12 87 8c         MOVB off 0x0c8c, off 0x0c12
0x43ab DD=0: b5 13 87 8d         MOVB off 0x0c8d, off 0x0c13
0x43af DD=0: a5 14 87 8e         MOV off 0x0c8e, off 0x0c14
0x43b3 DD=0: b5 16 87 90         MOVB off 0x0c90, off 0x0c16
0x43b7 DD=0: b5 17 87 91         MOVB off 0x0c91, off 0x0c17
0x43bb DD=0: b5 18 87 92         MOVB off 0x0c92, off 0x0c18
0x43bf DD=0: b5 19 87 93         MOVB off 0x0c93, off 0x0c19
0x43c3 DD=0: b5 1a 87 94         MOVB off 0x0c94, off 0x0c1a
0x43c7 DD=0: b5 1b 87 95         MOVB off 0x0c95, off 0x0c1b
0x43cb DD=0: b5 1c 87 98         MOVB off 0x0c98, off 0x0c1c
0x43cf DD=0: b5 1d 87 99         MOVB off 0x0c99, off 0x0c1d
0x43d3 DD=0: b5 1e 87 9a         MOVB off 0x0c9a, off 0x0c1e
0x43d7 DD=0: b5 1f 87 9c         MOVB off 0x0c9c, off 0x0c1f
0x43db DD=0: b5 20 87 9d         MOVB off 0x0c9d, off 0x0c20
0x43df DD=0: b5 21 87 9e         MOVB off 0x0c9e, off 0x0c21
0x43e3 DD=0: 94 8d               LB A, fix 0x028d
0x43e5 DD=0: f1 02               JEQ label_43e9
0x43e7 DD=0: 5f 38               SB sbafix 0x02f8.7
label_43e9:
0x43e9 DD=0: 35 96               STB A, off 0x0c96
label_43eb:
...
0x444c DD=1: a7 22 01 ab f3 f3   MOV 0x0122, #tbl_f3f3
...
0x4470 DD=1: c6 82 00 f0         MOV PWINTQ0, #tbl_f000
0x4474 DD=1: c6 84 00 f0         MOV PWINTQ1, #tbl_f000
...
0x4484 DD=1: da                  DI
0x4485 DD=1: c6 46 0d 80         MOV IE0, #tbl_800d
0x4489 DD=1: c6 48 4e 80         MOV IE1, #tbl_804e
...
0x449e DD=0: b5 b1 29 03         JBS off 0x08b1.1, label_44a5
0x44a2 DD=0: 03 38 48            J label_4838
label_44a5:
0x44a5 DD=0: 95 78               LB A, off 0x0878
0x44a7 DD=0: dc                  DECB A
0x44a8 DD=0: 3c                  STB A, R4
0x44a9 DD=0: 95 76               LB A, off 0x0876
...
0x44ba DD=1: 85 64               L A, off 0x0864
0x44bc DD=1: b5 b1 0f            SB off 0x08b1.7
0x44bf DD=1: 9e fe 04            CMP A, #0x04fe
0x44c2 DD=1: f6 1c               JNE label_44e0
0x44c4 DD=0: 95 66               LB A, off 0x0866
...
0x44d7 DD=0: b5 b1 07            RB off 0x08b1.7
label_44da:
0x44da DD=0: b5 b3 0d            SB off 0x08b3.5
label_44dd:
0x44dd DD=0: 03 15 48            J label_4815
label_44e0:
0x44e0 DD=1: b5 b3 2d 03         JBS off 0x08b3.5, label_44e7
...
label_44f4:
0x44f4 DD=0: 95 66               LB A, off 0x0866
0x44f6 DD=0: 9e 60               CMPB A, #0x60
0x44f8 DD=0: f6 32               JNE label_452c
0x44fa DD=0: 95 67               LB A, off 0x0867
...
0x4509 DD=0: b5 b4 70            MOVB R0, off 0x08b4
...
0x4534 DD=0: b5 b6 20 0a         JBR off 0x08b6.0, label_4542
...
0x454c DD=0: 95 67               LB A, off 0x0867
0x454e DD=0: 33                  STB A, [DP+]
0x454f DD=0: b5 b6 20 0c         JBR off 0x08b6.0, label_455f
...
label_455f:
0x455f DD=0: b5 b1 07            RB off 0x08b1.7
...
0x4570 DD=0: b5 b6 20 29         JBR off 0x08b6.0, label_459d
0x4574 DD=0: 95 69               LB A, off 0x0869
...
0x457e DD=0: b5 68 70            MOVB R0, off 0x0868
...
0x45a7 DD=0: 95 67               LB A, off 0x0867
0x45a9 DD=0: 33                  STB A, [DP+]
0x45aa DD=0: 95 68               LB A, off 0x0868
0x45ac DD=0: 33                  STB A, [DP+]
0x45ad DD=0: b5 b6 20 1d         JBR off 0x08b6.0, label_45ce
...
label_45ce:
0x45ce DD=0: b5 b1 07            RB off 0x08b1.7
...
label_45db:
0x45db DD=0: 95 67               LB A, off 0x0867
...
0x45f7 DD=1: 20 75 90            MOV X1, #tbl_9075
...
0x4619 DD=1: b5 a7 c7            CLRB off 0x08a7
label_461c:
0x461c DD=0: 95 a7               LB A, off 0x08a7
...
0x4628 DD=0: 6a 91 67            CMPB R2, off 0x0867
...
0x4643 DD=1: 20 75 90            MOV X1, #tbl_9075
...
label_464e:
0x464e DD=0: b5 a7 c6            INCB off 0x08a7
0x4651 DD=0: 04 c9               SJ label_461c
label_4653:
0x4653 DD=0: d7 80 01            MOVB off 0x0880, #0x01
label_4656:
0x4656 DD=0: b5 b1 07            RB off 0x08b1.7
0x4659 DD=0: 03 8d 46            J label_468d
label_465c:
0x465c DD=0: 9e 00               CMPB A, #0x00
0x465e DD=0: f6 2d               JNE label_468d
0x4660 DD=0: 95 67               LB A, off 0x0867
0x4662 DD=0: 9e f1               CMPB A, #0xf1
0x4664 DD=0: f6 14               JNE label_467a
0x4666 DD=0: b5 b3 09            SB off 0x08b3.1
0x4669 DD=0: b5 b3 00            RB off 0x08b3.0
0x466c DD=0: b5 b3 05            RB off 0x08b3.5
...
0x46a8 DD=0: 95 66               LB A, off 0x0866
0x46aa DD=0: f6 12               JNE label_46be
0x46ac DD=0: b3 ab 05            MOVB [DP+], #0x05
0x46af DD=0: 95 67               LB A, off 0x0867
0x46b1 DD=0: df                  SWAP
0x46b2 DD=0: 95 68               LB A, off 0x0868
...
0x46eb DD=0: b5 b0 08            SB off 0x08b0.0
0x46ee DD=0: d7 b7 64            MOVB off 0x08b7, #0x64
0x46f1 DD=0: b5 67 87 a3         MOVB off 0x08a3, off 0x0867
0x46f5 DD=0: 04 42               SJ label_4739
label_46f7:
0x46f7 DD=0: 95 b7               LB A, off 0x08b7
...
0x4715 DD=0: b5 b0 00            RB off 0x08b0.0
0x4718 DD=0: b5 a3 c7            CLRB off 0x08a3
0x471b DD=0: b5 a4 c7            CLRB off 0x08a4
...
0x472c DD=0: b5 b0 00            RB off 0x08b0.0
0x472f DD=0: b5 b7 c7            CLRB off 0x08b7
0x4732 DD=0: b5 67 87 a4         MOVB off 0x08a4, off 0x0867
0x4736 DD=0: b5 b0 09            SB off 0x08b0.1
label_4739:
0x4739 DD=0: b5 b1 07            RB off 0x08b1.7
label_473c:
...
label_4747:
0x4747 DD=1: b5 b5 29 0b         JBS off 0x08b5.1, label_4756
0x474b DD=1: b3 ab 0d            MOVB [DP+], #0x0d
0x474e DD=1: 42                  INC DP
0x474f DD=1: 85 66               L A, off 0x0866
...
0x475c DD=0: 95 68               LB A, off 0x0868
0x475e DD=0: f6 1b               JNE label_477b
0x4760 DD=0: 97 4e 92            LB A, tbl_924e
0x4763 DD=0: 33                  STB A, [DP+]
0x4764 DD=0: 97 4f 92            LB A, tbl_924f
0x4767 DD=0: 33                  STB A, [DP+]
0x4768 DD=0: 97 50 92            LB A, tbl_9250
0x476b DD=0: 33                  STB A, [DP+]
0x476c DD=0: 97 51 92            LB A, tbl_9251
0x476f DD=0: 33                  STB A, [DP+]
0x4770 DD=0: 97 52 92            LB A, tbl_9252
0x4773 DD=0: 33                  STB A, [DP+]
0x4774 DD=0: 97 53 92            LB A, tbl_9253
...
0x479a DD=0: 95 aa               LB A, off 0x08aa
0x479c DD=0: 33                  STB A, [DP+]
0x479d DD=0: 95 ab               LB A, off 0x08ab
0x479f DD=0: 33                  STB A, [DP+]
0x47a0 DD=0: 95 ac               LB A, off 0x08ac
0x47a2 DD=0: 33                  STB A, [DP+]
0x47a3 DD=0: 95 ad               LB A, off 0x08ad
0x47a5 DD=0: 33                  STB A, [DP+]
0x47a6 DD=0: 95 ae               LB A, off 0x08ae
...
0x47af DD=0: 35 7d               STB A, off 0x087d
0x47b1 DD=0: b5 b1 07            RB off 0x08b1.7
label_47b4:
...
label_47bf:
0x47bf DD=1: b5 b5 29 52         JBS off 0x08b5.1, label_4815
0x47c3 DD=0: 95 66               LB A, off 0x0866
...
0x47f4 DD=1: 85 68               L A, off 0x0868
0x47f6 DD=1: 9e 2d 46            CMP A, #0x462d
0x47f9 DD=1: f6 1a               JNE label_4815
0x47fb DD=0: 95 6a               LB A, off 0x086a
0x47fd DD=0: 9e 49               CMPB A, #0x49
0x47ff DD=0: f6 14               JNE label_4815
0x4801 DD=0: f9 1f               LB A, #0x1f
0x4803 DD=0: b5 b5 22 0a         JBR off 0x08b5.2, label_4811
0x4807 DD=0: f9 11               LB A, #0x11
0x4809 DD=0: b5 ba a7 04         TJZB off 0x08ba, label_4811
0x480d DD=0: b5 b5 09            SB off 0x08b5.1
0x4810 DD=0: fb                  CLRB A
label_4811:
0x4811 DD=0: 33                  STB A, [DP+]
label_4812:
0x4812 DD=0: b5 b1 07            RB off 0x08b1.7
label_4815:
0x4815 DD=0: b5 b1 2f 1c         JBS off 0x08b1.7, label_4835
0x4819 DD=0: 95 7d               LB A, off 0x087d
...
0x4827 DD=0: b5 7d 87 79         MOVB off 0x0879, off 0x087d
0x482b DD=0: d7 78 01            MOVB off 0x0878, #0x01
0x482e DD=0: b5 b2 0e            SB off 0x08b2.6
0x4831 DD=0: b5 7c 96 26         MOVB S1BUF, off 0x087c
label_4835:
0x4835 DD=0: b5 b1 01            RB off 0x08b1.1
label_4838:
0x4838 DD=0: d6 03 06            MOVB LRBH, #0x06
0x483b DD=0: 58 f5 17            JBR sbafix 0x02f5.0, label_4855
...
label_4855:
0x4855 DD=1: 48 48               RB sbaoff 0x06c8.0
...
0x4890 DD=1: b5 b5 29 03         JBS off 0x08b5.1, label_4897
0x4894 DD=1: d7 ba 32            MOVB off 0x08ba, #0x32
label_4897:
...
label_48bc:
0x48bc DD=1: b5 b5 20 07         JBR off 0x08b5.0, label_48c7
0x48c0 DD=1: b5 b5 24 07         JBR off 0x08b5.4, label_48cb
label_48c4:
0x48c4 DD=1: 00                  NOP
0x48c5 DD=1: 04 fd               SJ label_48c4
label_48c7:
0x48c7 DD=1: b5 b5 24 06         JBR off 0x08b5.4, label_48d1
label_48cb:
0x48cb DD=1: b5 b5 00            RB off 0x08b5.0
0x48ce DD=1: b5 b5 04            RB off 0x08b5.4
label_48d1:
0x48d1 DD=1: 58 af 05            JBS sbafix 0x02ef.0, label_48d9
0x48d4 DD=1: b5 b3 02            RB off 0x08b3.2
0x48d7 DD=1: 04 71               SJ label_494a
label_48d9:
0x48d9 DD=1: b5 b3 14            MB C, off 0x08b3.4
0x48dc DD=1: b5 b3 1b            MB off 0x08b3.3, C
0x48df DD=1: b6 16 12            MB C, P6.2
0x48e2 DD=1: b5 b3 1c            MB off 0x08b3.4, C
0x48e5 DD=0: 95 bb               LB A, off 0x08bb
0x48e7 DD=0: f6 61               JNE label_494a
0x48e9 DD=0: b5 b3 2a 10         JBS off 0x08b3.2, label_48fd
0x48ed DD=0: b5 b3 2c 59         JBS off 0x08b3.4, label_494a
0x48f1 DD=0: b5 b3 23 55         JBR off 0x08b3.3, label_494a
0x48f5 DD=0: b5 b3 0a            SB off 0x08b3.2
0x48f8 DD=0: b5 a6 c7            CLRB off 0x08a6
0x48fb DD=0: 04 4d               SJ label_494a
label_48fd:
0x48fd DD=0: 95 a6               LB A, off 0x08a6
0x48ff DD=0: cc                  INCB A
0x4900 DD=0: 35 a6               STB A, off 0x08a6
0x4902 DD=0: b7 72 90 95         CMPB A, tbl_9072
0x4906 DD=0: f5 21               JGE label_4929
0x4908 DD=0: b7 6f 90 95         CMPB A, tbl_906f
0x490c DD=0: f0 06               JGT label_4914
0x490e DD=0: b5 b3 2c 12         JBS off 0x08b3.4, label_4924
0x4912 DD=0: 04 36               SJ label_494a
label_4914:
0x4914 DD=0: b7 70 90 95         CMPB A, tbl_9070
0x4918 DD=0: f0 30               JGT label_494a
0x491a DD=0: b7 71 90 95         CMPB A, tbl_9071
0x491e DD=0: f2 2a               JLT label_494a
0x4920 DD=0: b5 b3 2c 26         JBS off 0x08b3.4, label_494a
label_4924:
0x4924 DD=0: b5 b3 02            RB off 0x08b3.2
0x4927 DD=0: 04 21               SJ label_494a
label_4929:
0x4929 DD=0: da                  DI
0x492a DD=0: b7 39 01 07         RB 0x0139.7
0x492e DD=0: a7 22 01 ab f4 f4   MOV 0x0122, #tbl_f4f4
0x4934 DD=0: b6 27 b3 fc         ANDB S1STAT, #0xfc
0x4938 DD=0: 96 26               LB A, S1BUF
0x493a DD=0: b7 39 01 0f         SB 0x0139.7
0x493e DD=0: b5 b3 02            RB off 0x08b3.2
0x4941 DD=0: b7 73 90 87 b9      MOVB off 0x08b9, tbl_9073
0x4946 DD=0: b5 b1 0a            SB off 0x08b1.2
0x4949 DD=0: db                  EI
label_494a:
0x494a DD=0: d6 03 06            MOVB LRBH, #0x06
0x494d DD=0: 5b 73               RB sbafix 0x02f3.3
0x494f DD=0: f6 08               JNE label_4959
0x4951 DD=0: 95 a3               LB A, off 0x06a3
0x4953 DD=0: f6 09               JNE label_495e
0x4955 DD=0: 59 73               RB sbafix 0x02f3.1
0x4957 DD=0: 04 05               SJ label_495e
label_4959:
0x4959 DD=1: 59 33               SB sbafix 0x02f3.1
0x495b DD=1: d7 a3 64            MOVB off 0x06a3, #0x64
label_495e:
0x495e DD=1: 85 a0               L A, off 0x06a0
0x4960 DD=1: dc                  DEC A
0x4961 DD=1: f6 0e               JNE label_4971
0x4963 DD=1: b5 c8 15            MB C, off 0x06c8.5
0x4966 DD=1: b5 c9 55            BOR C, off 0x06c9.5
0x4969 DD=1: b5 c9 1d            MB off 0x06c9.5, C
0x496c DD=1: 4d 08               SB sbaoff 0x06c8.5
0x496e DD=1: f8 e8 03            L A, #0x03e8
label_4971:
0x4971 DD=1: 35 a0               ST A, off 0x06a0
0x4973 DD=1: 10 0a               MOVB R0, #0x0a
0x4975 DD=1: 68 a8               DIVB R0
0x4977 DD=1: 69 a6 29            TJNZB R1, label_49a3
0x497a DD=1: b5 c8 12            MB C, off 0x06c8.2
0x497d DD=1: b5 c9 52            BOR C, off 0x06c9.2
0x4980 DD=1: b5 c9 1a            MB off 0x06c9.2, C
0x4983 DD=1: 4a 08               SB sbaoff 0x06c8.2
0x4985 DD=1: 68 a8               DIVB R0
0x4987 DD=1: 69 a6 19            TJNZB R1, label_49a3
0x498a DD=1: b5 c8 13            MB C, off 0x06c8.3
0x498d DD=1: b5 c9 53            BOR C, off 0x06c9.3
0x4990 DD=1: b5 c9 1b            MB off 0x06c9.3, C
0x4993 DD=1: 4b 08               SB sbaoff 0x06c8.3
0x4995 DD=1: 9f                  SRL A
0x4996 DD=1: f2 0b               JLT label_49a3
0x4998 DD=1: b5 c8 14            MB C, off 0x06c8.4
0x499b DD=1: b5 c9 54            BOR C, off 0x06c9.4
0x499e DD=1: b5 c9 1c            MB off 0x06c9.4, C
0x49a1 DD=1: 4c 08               SB sbaoff 0x06c8.4
label_49a3:
0x49a3 DD=1: 58 f5 03            JBR sbafix 0x02f5.0, label_49a9
0x49a6 DD=1: 03 ee 4b            J label_4bee
label_49a9:
0x49a9 DD=1: 4d c7 03            JBR sbaoff 0x06c7.5, label_49af
...
label_49c5:
0x49c5 DD=0: 5a 36               SB sbafix 0x02f6.2
...
0x49dc DD=1: 5f 38               SB sbafix 0x02f8.7
label_49de:
0x49de DD=1: b7 b4 08 21 05      JBR 0x08b4.1, label_49e8
0x49e3 DD=1: d7 91 67            MOVB off 0x0691, #0x67
0x49e6 DD=1: 5b 36               SB sbafix 0x02f6.3
label_49e8:
0x49e8 DD=1: 5f 78               RB sbafix 0x02f8.7
0x49ea DD=1: f1 1a               JEQ label_4a06
0x49ec DD=1: b7 b2 08 2b 03      JBS 0x08b2.3, label_49f4
0x49f1 DD=1: 59 f9 12            JBR sbafix 0x02f9.1, label_4a06
label_49f4:
...
label_4a06:
0x4a06 DD=1: 59 76               RB sbafix 0x02f6.1
0x4a08 DD=1: f1 11               JEQ label_4a1b
0x4a0a DD=1: 59 f9 0e            JBR sbafix 0x02f9.1, label_4a1b
0x4a0d DD=1: b7 0d 90 87 9a      MOVB off 0x069a, tbl_900d
0x4a12 DD=1: a7 a0 0c 87 98      MOV off 0x0698, 0x0ca0
0x4a17 DD=1: 59 37               SB sbafix 0x02f7.1
0x4a19 DD=1: 04 24               SJ label_4a3f
label_4a1b:
0x4a1b DD=1: 5a 76               RB sbafix 0x02f6.2
0x4a1d DD=1: f1 0c               JEQ label_4a2b
0x4a1f DD=1: b7 0d 90 87 9a      MOVB off 0x069a, tbl_900d
0x4a24 DD=1: a5 98 c7            CLR off 0x0698
0x4a27 DD=1: 5a 37               SB sbafix 0x02f7.2
0x4a29 DD=1: 04 14               SJ label_4a3f
label_4a2b:
0x4a2b DD=1: 5b 76               RB sbafix 0x02f6.3
0x4a2d DD=1: f6 03               JNE label_4a32
0x4a2f DD=1: 03 ee 4b            J label_4bee
label_4a32:
0x4a32 DD=1: b7 04 90 87 9a      MOVB off 0x069a, tbl_9004
0x4a37 DD=1: fa                  CLR A
0x4a38 DD=1: b5 91 97            MOVB A, off 0x0691
0x4a3b DD=1: 35 98               ST A, off 0x0698
0x4a3d DD=1: 5b 37               SB sbafix 0x02f7.3
label_4a3f:
0x4a3f DD=1: b5 9a b3 1f         ANDB off 0x069a, #0x1f
0x4a43 DD=1: 4c 07               SB sbaoff 0x06c7.4
label_4a45:
0x4a45 DD=1: d7 9b 03            MOVB off 0x069b, #0x03
0x4a48 DD=1: 4d 07               SB sbaoff 0x06c7.5
label_4a4a:
0x4a4a DD=1: b7 b3 08 2f 23      JBS 0x08b3.7, label_4a72
0x4a4f DD=0: 95 9b               LB A, off 0x069b
0x4a51 DD=0: f6 1c               JNE label_4a6f
0x4a53 DD=0: b5 9a 72            MOVB R2, off 0x069a
0x4a56 DD=0: 57 54               ACAL label_1754
0x4a58 DD=0: f2 04               JLT label_4a5e
0x4a5a DD=0: 9d 98               CMPB A, off 0x0698
0x4a5c DD=0: f1 06               JEQ label_4a64
label_4a5e:
0x4a5e DD=0: b7 fa 8f 76         MOVB R6, tbl_8ffa
0x4a62 DD=0: 54 2a               ACAL label_142a
label_4a64:
0x4a64 DD=0: 4c 47               RB sbaoff 0x06c7.4
0x4a66 DD=0: f1 0a               JEQ label_4a72
0x4a68 DD=0: d7 9b 03            MOVB off 0x069b, #0x03
0x4a6b DD=0: b5 9a c3 20         OR off 0x069a, #0x20
label_4a6f:
0x4a6f DD=0: 03 dc 4b            J label_4bdc
label_4a72:
0x4a72 DD=1: 5b f7 27            JBR sbafix 0x02f7.3, label_4a9c
0x4a75 DD=1: b7 b4 08 21 13      JBR 0x08b4.1, label_4a8d
0x4a7a DD=1: b4 42 ab 67         MOVB fix 0x0242, #0x67
0x4a7e DD=1: b4 43 ab 85         MOVB fix 0x0243, #0x85
0x4a82 DD=1: 48 45               RB sbaoff 0x06c5.0
0x4a84 DD=1: 49 45               RB sbaoff 0x06c5.1
0x4a86 DD=1: b5 a9 c7            CLRB off 0x06a9
0x4a89 DD=1: b7 b4 08 01         RB 0x08b4.1
label_4a8d:
0x4a8d DD=1: 5b 77               RB sbafix 0x02f7.3
0x4a8f DD=1: 4d 47               RB sbaoff 0x06c7.5
0x4a91 DD=1: 56 92               ACAL label_1692
0x4a93 DD=1: b7 05 90 72         MOVB R2, tbl_9005
0x4a97 DD=1: 85 96               L A, off 0x0696
0x4a99 DD=1: 03 ec 4b            J label_4bec
label_4a9c:
0x4a9c DD=1: 5c f7 3c            JBR sbafix 0x02f7.4, label_4adb
0x4a9f DD=1: 87 96 0c            L A, 0x0c96
0x4aa2 DD=1: b7 10 90 72         MOVB R2, tbl_9010
0x4aa6 DD=1: a5 9c 76            MOV DP, off 0x069c
...
0x4ab5 DD=1: 5d 37               SB sbafix 0x02f7.5
0x4ab7 DD=1: 5c 77               RB sbafix 0x02f7.4
0x4ab9 DD=1: 4d 47               RB sbaoff 0x06c7.5
0x4abb DD=1: b7 b4 08 28 02      JBS 0x08b4.0, label_4ac2
0x4ac0 DD=1: 5d 35               SB sbafix 0x02f5.5
label_4ac2:
0x4ac2 DD=1: 03 ee 4b            J label_4bee
label_4ac5:
0x4ac5 DD=1: 82                  L A, [DP]
0x4ac6 DD=1: b5 9a 72            MOVB R2, off 0x069a
0x4ac9 DD=1: 6a a3 03            ADDB R2, #0x03
label_4acc:
0x4acc DD=1: 35 98               ST A, off 0x0698
0x4ace DD=1: 6a 87 9a            MOVB off 0x069a, R2
0x4ad1 DD=1: 42                  INC DP
0x4ad2 DD=1: 42                  INC DP
0x4ad3 DD=1: 62 87 9c            MOV off 0x069c, DP
0x4ad6 DD=1: 4c 47               RB sbaoff 0x06c7.4
0x4ad8 DD=1: 03 d9 4b            J label_4bd9
label_4adb:
0x4adb DD=1: 59 f7 28            JBR sbafix 0x02f7.1, label_4b06
0x4ade DD=0: 97 0f 90            LB A, tbl_900f
0x4ae1 DD=0: 9d 9a               CMPB A, off 0x069a
0x4ae3 DD=0: f6 09               JNE label_4aee
0x4ae5 DD=0: 59 38               SB sbafix 0x02f8.1
0x4ae7 DD=0: 59 77               RB sbafix 0x02f7.1
0x4ae9 DD=0: 4d 47               RB sbaoff 0x06c7.5
0x4aeb DD=0: 03 ee 4b            J label_4bee
label_4aee:
0x4aee DD=0: a7 a4 0c 70         MOV ER0, 0x0ca4
0x4af2 DD=0: b7 0e 90 72         MOVB R2, tbl_900e
0x4af6 DD=0: 6a 91 9a            CMPB R2, off 0x069a
0x4af9 DD=0: f1 05               JEQ label_4b00
0x4afb DD=0: a7 a2 0c 70         MOV ER0, 0x0ca2
0x4aff DD=0: 7a                  LB A, R2
label_4b00:
0x4b00 DD=0: 64 87 98            MOV off 0x0698, ER0
0x4b03 DD=0: 03 d3 4b            J label_4bd3
label_4b06:
0x4b06 DD=0: 97 0f 90            LB A, tbl_900f
0x4b09 DD=0: 9d 9a               CMPB A, off 0x069a
...
0x4b1f DD=0: b7 fc 8f 72         MOVB R2, tbl_8ffc
...
0x4b3d DD=1: 34 d4               ST A, fix 0x02d4
0x4b3f DD=1: 34 d6               ST A, fix 0x02d6
0x4b41 DD=1: 34 d0               ST A, fix 0x02d0
0x4b43 DD=1: 34 d2               ST A, fix 0x02d2
0x4b45 DD=1: 34 d8               ST A, fix 0x02d8
0x4b47 DD=1: 34 da               ST A, fix 0x02da
...
0x4b54 DD=1: 20 ca 8f            MOV X1, #tbl_8fca
...
0x4b61 DD=0: 34 9f               STB A, fix 0x029f
0x4b63 DD=0: 34 a0               STB A, fix 0x02a0
0x4b65 DD=0: 34 8d               STB A, fix 0x028d
0x4b67 DD=0: 5c 75               RB sbafix 0x02f5.4
0x4b69 DD=0: 5d 75               RB sbafix 0x02f5.5
0x4b6b DD=0: 5e 75               RB sbafix 0x02f5.6
0x4b6d DD=0: 58 34               SB sbafix 0x02f4.0
0x4b6f DD=0: 35 9e               STB A, off 0x069e
0x4b71 DD=0: 35 9f               STB A, off 0x069f
0x4b73 DD=0: 35 b0               STB A, off 0x06b0
0x4b75 DD=0: 35 b1               STB A, off 0x06b1
0x4b77 DD=0: 35 ad               STB A, off 0x06ad
0x4b79 DD=0: 35 ae               STB A, off 0x06ae
0x4b7b DD=0: 35 2f               STB A, off 0x062f
0x4b7d DD=0: 35 30               STB A, off 0x0630
0x4b7f DD=0: 35 af               STB A, off 0x06af
0x4b81 DD=0: b7 b2 08 04         RB 0x08b2.4
0x4b85 DD=0: b4 2a c7            CLRB fix 0x022a
0x4b88 DD=0: b4 28 c7            CLRB fix 0x0228
0x4b8b DD=0: b4 2b c7            CLRB fix 0x022b
0x4b8e DD=0: b4 29 ab 02         MOVB fix 0x0229, #0x02
0x4b92 DD=0: d7 b6 05            MOVB off 0x06b6, #0x05
0x4b95 DD=0: 4c 42               RB sbaoff 0x06c2.4
0x4b97 DD=0: b7 93 03 ab 14      MOVB 0x0393, #0x14
0x4b9c DD=0: 49 42               RB sbaoff 0x06c2.1
0x4b9e DD=0: b6 11 03            RB P1.3
0x4ba1 DD=0: d7 b2 0f            MOVB off 0x06b2, #0x0f
0x4ba4 DD=0: d7 b3 32            MOVB off 0x06b3, #0x32
0x4ba7 DD=0: 48 42               RB sbaoff 0x06c2.0
0x4ba9 DD=0: 4b 42               RB sbaoff 0x06c2.3
...
label_4bbe:
0x4bbe DD=0: 5a 38               SB sbafix 0x02f8.2
0x4bc0 DD=0: 5a 77               RB sbafix 0x02f7.2
0x4bc2 DD=0: 4d 47               RB sbaoff 0x06c7.5
0x4bc4 DD=0: 04 28               SJ label_4bee
label_4bc6:
0x4bc6 DD=0: b7 0e 90 72         MOVB R2, tbl_900e
0x4bca DD=0: 6a 91 9a            CMPB R2, off 0x069a
0x4bcd DD=0: f1 01               JEQ label_4bd0
0x4bcf DD=0: 7a                  LB A, R2
label_4bd0:
0x4bd0 DD=0: a5 98 c7            CLR off 0x0698
label_4bd3:
0x4bd3 DD=0: be 1f               ANDB A, #0x1f
0x4bd5 DD=0: 35 9a               STB A, off 0x069a
0x4bd7 DD=0: 4c 07               SB sbaoff 0x06c7.4
label_4bd9:
0x4bd9 DD=0: d7 9b 03            MOVB off 0x069b, #0x03
label_4bdc:
0x4bdc DD=0: 56 92               ACAL label_1692
0x4bde DD=0: b5 9a 72            MOVB R2, off 0x069a
0x4be1 DD=0: f9 03               LB A, #0x03
0x4be3 DD=0: 8d 9b               SUBB A, off 0x069b
0x4be5 DD=0: b5 9b d6            DECB off 0x069b
0x4be8 DD=0: 6a a4               ADDB R2, A
0x4bea DD=1: 85 98               L A, off 0x0698
label_4bec:
0x4bec DD=1: 57 13               ACAL label_1713
label_4bee:
0x4bee DD=1: b5 a0 28 20         JBS off 0x06a0.0, label_4c12
...
0x4c0e DD=1: b5 a0 21 03         JBR off 0x06a0.1, label_4c15
label_4c12:
0x4c12 DD=1: 03 7f 50            J label_507f
label_4c15:
0x4c15 DD=1: 58 e4 03            JBR sbafix 0x02e4.0, label_4c1b
0x4c18 DD=1: 58 ef 06            JBR sbafix 0x02ef.0, label_4c21
label_4c1b:
0x4c1b DD=1: 48 43               RB sbaoff 0x06c3.0
0x4c1d DD=1: fa                  CLR A
0x4c1e DD=1: 03 7d 50            J label_507d
label_4c21:
0x4c21 DD=1: 5b af 06            JBS sbafix 0x02ef.3, label_4c2a
0x4c24 DD=0: 94 d4               LB A, fix 0x02d4
0x4c26 DD=0: be 37               ANDB A, #0x37
0x4c28 DD=0: f1 08               JEQ label_4c32
label_4c2a:
0x4c2a DD=0: 48 43               RB sbaoff 0x06c3.0
0x4c2c DD=0: d7 52 00            MOVB off 0x0652, #0x00
...
0x4c46 DD=0: d7 b7 1e            MOVB off 0x06b7, #0x1e
0x4c49 DD=0: 04 07               SJ label_4c52
label_4c4b:
0x4c4b DD=0: b5 b7 a7 0c         TJZB off 0x06b7, label_4c5b
0x4c4f DD=0: 5e 9c 05            JBS sbafix 0x02dc.6, label_4c57
label_4c52:
0x4c52 DD=0: d7 a8 0a            MOVB off 0x06a8, #0x0a
0x4c55 DD=0: 04 0b               SJ label_4c62
label_4c57:
0x4c57 DD=0: b5 a8 a6 07         TJNZB off 0x06a8, label_4c62
label_4c5b:
0x4c5b DD=0: 48 00               SB sbaoff 0x06c0.0
0x4c5d DD=0: 49 40               RB sbaoff 0x06c0.1
0x4c5f DD=0: d7 b8 0b            MOVB off 0x06b8, #0x0b
label_4c62:
...
0x4c75 DD=0: 5e 9c 0b            JBS sbafix 0x02dc.6, label_4c83
0x4c78 DD=0: b5 b8 70            MOVB R0, off 0x06b8
0x4c7b DD=0: 68 a6 05            TJNZB R0, label_4c83
0x4c7e DD=0: 49 00               SB sbaoff 0x06c0.1
0x4c80 DD=0: d7 b7 1e            MOVB off 0x06b7, #0x1e
label_4c83:
0x4c83 DD=0: 68 87 b8            MOVB off 0x06b8, R0
0x4c86 DD=0: 04 05               SJ label_4c8d
label_4c88:
0x4c88 DD=0: 49 40               RB sbaoff 0x06c0.1
0x4c8a DD=0: d7 b8 0b            MOVB off 0x06b8, #0x0b
label_4c8d:
0x4c8d DD=0: 58 e3 47            JBR sbafix 0x02e3.0, label_4cd7
0x4c90 DD=0: fb                  CLRB A
0x4c91 DD=0: 48 87 03            JBS sbaoff 0x06c7.0, label_4c97
0x4c94 DD=0: 48 83 42            JBS sbaoff 0x06c3.0, label_4cd9
label_4c97:
0x4c97 DD=0: 35 40               STB A, off 0x0640
0x4c99 DD=0: b7 e5 05 3e 0f      JBSR 0x05e5.6, label_4cad
0x4c9e DD=0: 35 41               STB A, off 0x0641
0x4ca0 DD=0: b5 42 c6            INCB off 0x0642
0x4ca3 DD=0: d5 42 02            CMPB off 0x0642, #0x02
0x4ca6 DD=0: f2 18               JLT label_4cc0
0x4ca8 DD=0: d7 40 1d            MOVB off 0x0640, #0x1d
0x4cab DD=0: 04 11               SJ label_4cbe
label_4cad:
0x4cad DD=0: 10 0f               MOVB R0, #0x0f
0x4caf DD=0: b5 43 a6 02         TJNZB off 0x0643, label_4cb5
0x4cb3 DD=0: 10 0f               MOVB R0, #0x0f
label_4cb5:
0x4cb5 DD=0: 68 87 41            MOVB off 0x0641, R0
0x4cb8 DD=0: 48 07               SB sbaoff 0x06c7.0
0x4cba DD=0: 35 47               STB A, off 0x0647
0x4cbc DD=0: 35 46               STB A, off 0x0646
label_4cbe:
0x4cbe DD=0: 35 42               STB A, off 0x0642
label_4cc0:
0x4cc0 DD=0: 95 43               LB A, off 0x0643
0x4cc2 DD=0: ad 41               ADDB A, off 0x0641
0x4cc4 DD=0: f5 02               JGE label_4cc8
0x4cc6 DD=0: bc d7               FILLB A
label_4cc8:
0x4cc8 DD=0: 8d 40               SUBB A, off 0x0640
0x4cca DD=0: f0 03               JGT label_4ccf
0x4ccc DD=0: fb                  CLRB A
0x4ccd DD=0: 48 47               RB sbaoff 0x06c7.0
label_4ccf:
0x4ccf DD=0: 9e 80               CMPB A, #0x80
0x4cd1 DD=0: f7 02               JLE label_4cd5
0x4cd3 DD=0: f9 80               LB A, #0x80
label_4cd5:
0x4cd5 DD=0: 35 43               STB A, off 0x0643
label_4cd7:
0x4cd7 DD=0: 04 40               SJ label_4d19
label_4cd9:
0x4cd9 DD=0: 35 44               STB A, off 0x0644
0x4cdb DD=0: b7 e5 05 3e 0f      JBSR 0x05e5.6, label_4cef
0x4ce0 DD=0: 35 45               STB A, off 0x0645
0x4ce2 DD=0: b5 46 c6            INCB off 0x0646
0x4ce5 DD=0: d5 46 64            CMPB off 0x0646, #0x64
0x4ce8 DD=0: f2 18               JLT label_4d02
0x4cea DD=0: d7 44 01            MOVB off 0x0644, #0x01
0x4ced DD=0: 04 11               SJ label_4d00
label_4cef:
0x4cef DD=0: 10 0f               MOVB R0, #0x0f
0x4cf1 DD=0: b5 47 a6 02         TJNZB off 0x0647, label_4cf7
0x4cf5 DD=0: 10 0f               MOVB R0, #0x0f
label_4cf7:
0x4cf7 DD=0: 68 87 45            MOVB off 0x0645, R0
0x4cfa DD=0: 49 07               SB sbaoff 0x06c7.1
0x4cfc DD=0: 35 43               STB A, off 0x0643
0x4cfe DD=0: 35 42               STB A, off 0x0642
label_4d00:
0x4d00 DD=0: 35 46               STB A, off 0x0646
label_4d02:
0x4d02 DD=0: 95 47               LB A, off 0x0647
0x4d04 DD=0: ad 45               ADDB A, off 0x0645
0x4d06 DD=0: f5 02               JGE label_4d0a
0x4d08 DD=0: bc d7               FILLB A
label_4d0a:
0x4d0a DD=0: 8d 44               SUBB A, off 0x0644
0x4d0c DD=0: f0 03               JGT label_4d11
0x4d0e DD=0: fb                  CLRB A
0x4d0f DD=0: 49 47               RB sbaoff 0x06c7.1
label_4d11:
0x4d11 DD=0: 9e 43               CMPB A, #0x43
0x4d13 DD=0: f7 02               JLE label_4d17
0x4d15 DD=0: f9 43               LB A, #0x43
label_4d17:
0x4d17 DD=0: 35 47               STB A, off 0x0647
label_4d19:
0x4d19 DD=0: a5 48 87 4a         MOV off 0x064a, off 0x0648
0x4d1d DD=0: 24 03 00            MOV ER0, #0x0003
0x4d20 DD=1: 84 3c               L A, fix 0x023c
0x4d22 DD=1: 39                  ST A, ER1
0x4d23 DD=1: 8d 48               SUB A, off 0x0648
...
0x4d2e DD=1: 65 87 48            MOV off 0x0648, ER1
label_4d31:
0x4d31 DD=1: 22 72 ec            MOV DP, #tbl_ec72
0x4d34 DD=1: 15 0a               MOVB R5, #0x0a
0x4d36 DD=1: a5 48 70            MOV ER0, off 0x0648
0x4d39 DD=1: b5 51 74            MOVB R4, off 0x0651
0x4d3c DD=1: 45 d6               ACAL label_11d6
0x4d3e DD=1: 6c 87 51            MOVB off 0x0651, R4
0x4d41 DD=1: 35 4e               ST A, off 0x064e
0x4d43 DD=1: 22 54 ec            MOV DP, #tbl_ec54
0x4d46 DD=1: 15 0f               MOVB R5, #0x0f
0x4d48 DD=1: a4 34 70            MOV ER0, fix 0x0234
0x4d4b DD=1: b5 50 74            MOVB R4, off 0x0650
0x4d4e DD=1: 45 d6               ACAL label_11d6
0x4d50 DD=1: 6c 87 50            MOVB off 0x0650, R4
0x4d53 DD=1: 35 4c               ST A, off 0x064c
0x4d55 DD=1: 22 86 ec            MOV DP, #tbl_ec86
0x4d58 DD=1: 3c                  ST A, X1
0x4d59 DD=0: 7c                  LB A, R4
0x4d5a DD=0: a5 4e 72            MOV ER2, off 0x064e
0x4d5d DD=0: b5 51 71            MOVB R1, off 0x0651
0x4d60 DD=0: 16 0a               MOVB R6, #0x0a
0x4d62 DD=0: 46 1d               ACAL label_121d
0x4d64 DD=0: 35 52               STB A, off 0x0652
0x4d66 DD=0: 5d e5 0d            JBR sbafix 0x02e5.5, label_4d76
0x4d69 DD=1: 86 f8               L A, ADCR20
0x4d6b DD=0: 96 07               LB A, ACCH
0x4d6d DD=0: 35 66               STB A, off 0x0666
0x4d6f DD=0: 35 53               STB A, off 0x0653
0x4d71 DD=0: 48 03               SB sbaoff 0x06c3.0
0x4d73 DD=0: 03 c5 4e            J label_4ec5
label_4d76:
0x4d76 DD=0: 22 3a ed            MOV DP, #tbl_ed3a
0x4d79 DD=0: b4 6e 70            MOVB R0, fix 0x026e
0x4d7c DD=0: 15 0a               MOVB R5, #0x0a
0x4d7e DD=0: b5 59 74            MOVB R4, off 0x0659
0x4d81 DD=0: 45 8d               ACAL label_118d
0x4d83 DD=0: 6c 87 59            MOVB off 0x0659, R4
0x4d86 DD=0: 35 56               STB A, off 0x0656
0x4d88 DD=0: 22 1c ed            MOV DP, #tbl_ed1c
0x4d8b DD=0: a4 34 70            MOV ER0, fix 0x0234
0x4d8e DD=0: 15 0f               MOVB R5, #0x0f
0x4d90 DD=0: b5 58 74            MOVB R4, off 0x0658
0x4d93 DD=0: 45 d6               ACAL label_11d6
0x4d95 DD=0: 6c 87 58            MOVB off 0x0658, R4
0x4d98 DD=0: 35 54               STB A, off 0x0654
0x4d9a DD=0: 22 1c 8d            MOV DP, #tbl_8d1c
0x4d9d DD=1: 84 34               L A, fix 0x0234
0x4d9f DD=1: 44 70               ACAL label_1070
0x4da1 DD=1: 35 62               ST A, off 0x0662
0x4da3 DD=1: 22 44 ed            MOV DP, #tbl_ed44
0x4da6 DD=1: a5 54 74            MOV X1, off 0x0654
0x4da9 DD=0: 95 58               LB A, off 0x0658
0x4dab DD=0: a5 56 72            MOV ER2, off 0x0656
0x4dae DD=0: b5 59 71            MOVB R1, off 0x0659
0x4db1 DD=0: 16 0a               MOVB R6, #0x0a
0x4db3 DD=0: 46 1d               ACAL label_121d
0x4db5 DD=0: 35 5a               STB A, off 0x065a
0x4db7 DD=0: 3c                  STB A, R4
0x4db8 DD=0: 22 7a 8d            MOV DP, #tbl_8d7a
0x4dbb DD=0: 94 70               LB A, fix 0x0270
0x4dbd DD=0: 44 04               ACAL label_1004
0x4dbf DD=0: 35 5c               STB A, off 0x065c
0x4dc1 DD=0: 1c                  CMPB A, R4
0x4dc2 DD=0: f7 01               JLE label_4dc5
0x4dc4 DD=0: 7c                  LB A, R4
label_4dc5:
0x4dc5 DD=0: 9d 62               CMPB A, off 0x0662
0x4dc7 DD=0: f7 02               JLE label_4dcb
0x4dc9 DD=0: 95 62               LB A, off 0x0662
label_4dcb:
0x4dcb DD=0: 35 60               STB A, off 0x0660
0x4dcd DD=0: 22 4b 8d            MOV DP, #tbl_8d4b
0x4dd0 DD=1: 84 34               L A, fix 0x0234
0x4dd2 DD=1: 44 70               ACAL label_1070
0x4dd4 DD=1: 35 63               ST A, off 0x0663
0x4dd6 DD=1: 22 da ed            MOV DP, #tbl_edda
0x4dd9 DD=1: a5 54 74            MOV X1, off 0x0654
0x4ddc DD=0: 95 58               LB A, off 0x0658
0x4dde DD=0: a5 56 72            MOV ER2, off 0x0656
0x4de1 DD=0: b5 59 71            MOVB R1, off 0x0659
0x4de4 DD=0: 16 0a               MOVB R6, #0x0a
0x4de6 DD=0: 46 1d               ACAL label_121d
0x4de8 DD=0: 35 5b               STB A, off 0x065b
0x4dea DD=0: 3c                  STB A, R4
0x4deb DD=0: 22 89 8d            MOV DP, #tbl_8d89
0x4dee DD=0: 94 70               LB A, fix 0x0270
0x4df0 DD=0: 44 04               ACAL label_1004
0x4df2 DD=0: 35 5d               STB A, off 0x065d
0x4df4 DD=0: 1c                  CMPB A, R4
0x4df5 DD=0: f7 01               JLE label_4df8
0x4df7 DD=0: 7c                  LB A, R4
label_4df8:
0x4df8 DD=0: 9d 63               CMPB A, off 0x0663
0x4dfa DD=0: f7 02               JLE label_4dfe
0x4dfc DD=0: 95 63               LB A, off 0x0663
label_4dfe:
0x4dfe DD=0: 35 61               STB A, off 0x0661
0x4e00 DD=0: 3a                  STB A, R2
0x4e01 DD=0: b5 60 73            MOVB R3, off 0x0660
0x4e04 DD=0: 10 a0               MOVB R0, #0xa0
0x4e06 DD=0: 11 d8               MOVB R1, #0xd8
0x4e08 DD=0: 94 71               LB A, fix 0x0271
0x4e0a DD=0: 44 cf               ACAL label_10cf
0x4e0c DD=0: 5b e4 05            JBR sbafix 0x02e4.3, label_4e14
0x4e0f DD=0: 8d 47               SUBB A, off 0x0647
0x4e11 DD=0: f5 01               JGE label_4e14
0x4e13 DD=0: fb                  CLRB A
label_4e14:
0x4e14 DD=0: 5a a3 4f            JBS sbafix 0x02e3.2, label_4e66
0x4e17 DD=0: 5b e3 4c            JBR sbafix 0x02e3.3, label_4e66
0x4e1a DD=0: 38                  STB A, R0
0x4e1b DD=0: f9 a0               LB A, #0xa0
0x4e1d DD=0: 12 40               MOVB R2, #0x40
0x4e1f DD=0: 6b c7               CLRB R3
0x4e21 DD=0: 48 c0 39            JBR sbaoff 0x06c0.0, label_4e5d
0x4e24 DD=0: 49 80 02            JBS sbaoff 0x06c0.1, label_4e29
0x4e27 DD=0: 04 2e               SJ label_4e57
label_4e29:
0x4e29 DD=0: 95 5f               LB A, off 0x065f
0x4e2b DD=0: b5 64 72            MOVB R2, off 0x0664
0x4e2e DD=0: b5 65 73            MOVB R3, off 0x0665
...
label_4e53:
0x4e53 DD=0: 48 40               RB sbaoff 0x06c0.0
0x4e55 DD=0: 49 40               RB sbaoff 0x06c0.1
label_4e57:
0x4e57 DD=0: 68 84               SUBB R0, A
0x4e59 DD=0: f5 02               JGE label_4e5d
0x4e5b DD=0: 68 c7               CLRB R0
label_4e5d:
0x4e5d DD=0: 35 5f               STB A, off 0x065f
0x4e5f DD=0: 78                  LB A, R0
0x4e60 DD=0: 6a 87 64            MOVB off 0x0664, R2
0x4e63 DD=0: 6b 87 65            MOVB off 0x0665, R3
label_4e66:
0x4e66 DD=0: 35 5e               STB A, off 0x065e
0x4e68 DD=0: 8d 60               SUBB A, off 0x0660
0x4e6a DD=0: f5 01               JGE label_4e6d
0x4e6c DD=0: cf                  NEGB A
label_4e6d:
0x4e6d DD=0: 37 57 03            STB A, 0x0357
0x4e70 DD=0: 95 5e               LB A, off 0x065e
0x4e72 DD=0: 48 83 04            JBS sbaoff 0x06c3.0, label_4e79
0x4e75 DD=0: 35 53               STB A, off 0x0653
0x4e77 DD=0: 04 0f               SJ label_4e88
label_4e79:
0x4e79 DD=0: 9d 53               CMPB A, off 0x0653
0x4e7b DD=0: f1 08               JEQ label_4e85
0x4e7d DD=0: f5 04               JGE label_4e83
0x4e7f DD=0: b5 a4 a6 05         TJNZB off 0x06a4, label_4e88
label_4e83:
0x4e83 DD=0: 35 53               STB A, off 0x0653
label_4e85:
0x4e85 DD=0: d7 a4 00            MOVB off 0x06a4, #0x00
label_4e88:
0x4e88 DD=0: 48 87 34            JBS sbaoff 0x06c7.0, label_4ebf
0x4e8b DD=0: b5 c3 10            MB C, off 0x06c3.0
0x4e8e DD=0: b5 c3 19            MB off 0x06c3.1, C
0x4e91 DD=0: 22 98 8d            MOV DP, #tbl_8d98
0x4e94 DD=1: 84 34               L A, fix 0x0234
...
label_4ea5:
0x4ea5 DD=0: 95 a5               LB A, off 0x06a5
0x4ea7 DD=0: f6 1c               JNE label_4ec5
0x4ea9 DD=0: 48 83 05            JBS sbaoff 0x06c3.0, label_4eb1
0x4eac DD=0: d7 a5 14            MOVB off 0x06a5, #0x14
0x4eaf DD=0: 04 12               SJ label_4ec3
label_4eb1:
0x4eb1 DD=1: 85 4a               L A, off 0x064a
0x4eb3 DD=1: 8d 48               SUB A, off 0x0648
0x4eb5 DD=1: f2 0c               JLT label_4ec3
0x4eb7 DD=1: 9e 00 01            CMP A, #0x0100
0x4eba DD=1: f2 07               JLT label_4ec3
0x4ebc DD=1: d7 a5 14            MOVB off 0x06a5, #0x14
label_4ebf:
0x4ebf DD=1: 48 43               RB sbaoff 0x06c3.0
0x4ec1 DD=1: 04 02               SJ label_4ec5
label_4ec3:
0x4ec3 DD=0: 48 03               SB sbaoff 0x06c3.0
label_4ec5:
0x4ec5 DD=0: b5 c3 12            MB C, off 0x06c3.2
0x4ec8 DD=0: b5 c3 1b            MB off 0x06c3.3, C
0x4ecb DD=0: 95 53               LB A, off 0x0653
0x4ecd DD=0: 8c 63               SUBB A, fix 0x0263
0x4ecf DD=0: b5 c3 1a            MB off 0x06c3.2, C
0x4ed2 DD=0: f5 01               JGE label_4ed5
0x4ed4 DD=0: cf                  NEGB A
label_4ed5:
0x4ed5 DD=0: 35 67               STB A, off 0x0667
0x4ed7 DD=0: 22 b0 8d            MOV DP, #tbl_8db0
0x4eda DD=1: 84 34               L A, fix 0x0234
0x4edc DD=1: 44 70               ACAL label_1070
0x4ede DD=1: 35 69               ST A, off 0x0669
0x4ee0 DD=1: 39                  ST A, ER1
0x4ee1 DD=1: 22 ad 8d            MOV DP, #tbl_8dad
0x4ee4 DD=1: 4a 83 03            JBS sbaoff 0x06c3.2, label_4eea
0x4ee7 DD=1: 22 aa 8d            MOV DP, #tbl_8daa
label_4eea:
0x4eea DD=0: 93                  LB A, [DP+]
0x4eeb DD=0: 69 a9               MULB R1
0x4eed DD=0: a5 6a aa            MOV off 0x066a, A
0x4ef0 DD=0: 93                  LB A, [DP+]
0x4ef1 DD=0: 69 a9               MULB R1
0x4ef3 DD=0: a5 6e aa            MOV off 0x066e, A
0x4ef6 DD=0: 92                  LB A, [DP]
0x4ef7 DD=0: 69 a9               MULB R1
0x4ef9 DD=0: a5 72 aa            MOV off 0x0672, A
0x4efc DD=1: fa                  CLR A
0x4efd DD=1: b5 67 96 07         MOVB ACCH, off 0x0667
0x4f01 DD=1: a5 6a a9            MUL off 0x066a
0x4f04 DD=1: 10 02               MOVB R0, #0x02
0x4f06 DD=1: 46 c5               ACAL label_12c5
0x4f08 DD=1: a5 76 70            MOV ER0, off 0x0676
0x4f0b DD=1: 4a 83 08            JBS sbaoff 0x06c3.2, label_4f16
...
label_4f2b:
0x4f2b DD=1: 35 6c               ST A, off 0x066c
0x4f2d DD=1: fa                  CLR A
0x4f2e DD=1: b5 67 96 07         MOVB ACCH, off 0x0667
0x4f32 DD=1: a5 6e a9            MUL off 0x066e
0x4f35 DD=1: 10 02               MOVB R0, #0x02
0x4f37 DD=1: 46 c5               ACAL label_12c5
0x4f39 DD=1: 35 70               ST A, off 0x0670
0x4f3b DD=0: 95 67               LB A, off 0x0667
0x4f3d DD=0: b5 68 70            MOVB R0, off 0x0668
0x4f40 DD=0: 4a 83 05            JBS sbaoff 0x06c3.2, label_4f48
0x4f43 DD=0: 4b 83 05            JBS sbaoff 0x06c3.3, label_4f4b
0x4f46 DD=0: 04 12               SJ label_4f5a
label_4f48:
0x4f48 DD=0: 4b 83 0d            JBS sbaoff 0x06c3.3, label_4f58
label_4f4b:
0x4f4b DD=0: b5 c3 12            MB C, off 0x06c3.2
0x4f4e DD=0: b5 c3 1c            MB off 0x06c3.4, C
...
label_4fc4:
0x4fc4 DD=0: 64 87 76            MOV off 0x0676, ER0
0x4fc7 DD=0: b5 67 87 68         MOVB off 0x0668, off 0x0667
0x4fcb DD=0: 38                  STB A, R0
0x4fcc DD=0: 95 79               LB A, off 0x0679
0x4fce DD=0: 11 ff               MOVB R1, #0xff
0x4fd0 DD=0: b5 7a 72            MOVB R2, off 0x067a
0x4fd3 DD=0: b5 7b 73            MOVB R3, off 0x067b
0x4fd6 DD=0: 5a e3 08            JBR sbafix 0x02e3.2, label_4fe1
0x4fd9 DD=0: 48 c0 05            JBR sbaoff 0x06c0.0, label_4fe1
0x4fdc DD=0: 49 80 09            JBS sbaoff 0x06c0.1, label_4fe8
...
0x5012 DD=0: 48 40               RB sbaoff 0x06c0.0
0x5014 DD=0: 49 40               RB sbaoff 0x06c0.1
label_5016:
0x5016 DD=0: 6a 87 7a            MOVB off 0x067a, R2
0x5019 DD=0: 6b 87 7b            MOVB off 0x067b, R3
0x501c DD=0: 35 79               STB A, off 0x0679
...
label_5029:
0x5029 DD=0: 35 78               STB A, off 0x0678
0x502b DD=1: fa                  CLR A
0x502c DD=1: 5c 94 4c            JBS sbafix 0x02d4.4, label_507b
0x502f DD=1: 5c 97 49            JBS sbafix 0x02d7.4, label_507b
0x5032 DD=1: 5f 96 46            JBS sbafix 0x02d6.7, label_507b
0x5035 DD=1: 4b 82 43            JBS sbaoff 0x06c2.3, label_507b
0x5038 DD=1: 5c 9c 40            JBS sbafix 0x02dc.4, label_507b
0x503b DD=0: 95 78               LB A, off 0x0678
0x503d DD=0: 22 c7 8d            MOV DP, #tbl_8dc7
0x5040 DD=0: 44 30               ACAL label_1030
0x5042 DD=0: 35 7c               STB A, off 0x067c
0x5044 DD=0: 94 72               LB A, fix 0x0272
0x5046 DD=0: b7 ed 8d 70         MOVB R0, tbl_8ded
0x504a DD=0: 68 94               CMPB R0, A
0x504c DD=0: 8a 1b               MB PSWL.3, C
0x504e DD=0: 22 e6 8d            MOV DP, #tbl_8de6
0x5051 DD=0: f2 03               JLT label_5056
0x5053 DD=0: 22 ed 8d            MOV DP, #tbl_8ded
label_5056:
0x5056 DD=0: 44 30               ACAL label_1030
0x5058 DD=0: 8a 23 01            JBR PSWL.3, label_505c
0x505b DD=0: cf                  NEGB A
label_505c:
0x505c DD=0: 35 7e               STB A, off 0x067e
0x505e DD=0: ad 7c               ADDB A, off 0x067c
...
0x506d DD=1: f8 58 98            L A, #tbl_9858
...
label_507b:
0x507b DD=1: 35 80               ST A, off 0x0680
label_507d:
0x507d DD=1: 36 68               ST A, PWR0
label_507f:
0x507f DD=1: 01                  RT
label_5080:
0x5080 DD=1: 4a 48               RB sbaoff 0x06c8.2
...
0x50b6 DD=0: 94 a1               LB A, fix 0x02a1
0x50b8 DD=0: cc                  INCB A
0x50b9 DD=0: f1 02               JEQ label_50bd
0x50bb DD=0: 34 a1               STB A, fix 0x02a1
label_50bd:
0x50bd DD=0: 5b f9 06            JBR sbafix 0x02f9.3, label_50c6
0x50c0 DD=0: b6 10 09            SB P0.1
0x50c3 DD=0: 03 82 51            J label_5182
label_50c6:
0x50c6 DD=0: 59 f9 36            JBR sbafix 0x02f9.1, label_50ff
0x50c9 DD=0: 5d f5 1f            JBR sbafix 0x02f5.5, label_50eb
0x50cc DD=0: 59 74               RB sbafix 0x02f4.1
0x50ce DD=0: f6 03               JNE label_50d3
0x50d0 DD=0: 58 f4 22            JBR sbafix 0x02f4.0, label_50f5
label_50d3:
0x50d3 DD=0: 5d 9c 1f            JBS sbafix 0x02dc.5, label_50f5
0x50d6 DD=0: b5 2f c7            CLRB off 0x062f
0x50d9 DD=0: b5 30 c7            CLRB off 0x0630
0x50dc DD=0: b5 ad c7            CLRB off 0x06ad
0x50df DD=0: 58 b4 05            JBS sbafix 0x02f4.0, label_50e7
0x50e2 DD=0: d7 ae 17            MOVB off 0x06ae, #0x17
0x50e5 DD=0: 58 34               SB sbafix 0x02f4.0
label_50e7:
0x50e7 DD=0: b5 ae a7 05         TJZB off 0x06ae, label_50f0
label_50eb:
...
label_50f5:
0x50f5 DD=0: 58 74               RB sbafix 0x02f4.0
0x50f7 DD=0: 22 d4 02            MOV DP, #0x02d4
0x50fa DD=0: 20 87 8e            MOV X1, #tbl_8e87
0x50fd DD=0: 55 62               ACAL label_1562
label_50ff:
0x50ff DD=0: 5a f9 4c            JBR sbafix 0x02f9.2, label_514e
0x5102 DD=0: 5c f5 4b            JBR sbafix 0x02f5.4, label_5150
0x5105 DD=0: 5d b3 48            JBS sbafix 0x02f3.5, label_5150
0x5108 DD=0: 5a b6 40            JBS sbafix 0x02f6.2, label_514b
0x510b DD=0: 5a b7 3d            JBS sbafix 0x02f7.2, label_514b
0x510e DD=0: 5a b8 50            JBS sbafix 0x02f8.2, label_5161
0x5111 DD=0: 58 ef 3c            JBR sbafix 0x02ef.0, label_5150
0x5114 DD=0: 58 9c 19            JBS sbafix 0x02dc.0, label_5130
0x5117 DD=0: 5e b5 07            JBS sbafix 0x02f5.6, label_5121
0x511a DD=0: 5e 35               SB sbafix 0x02f5.6
0x511c DD=0: d7 af 32            MOVB off 0x06af, #0x32
0x511f DD=0: 04 04               SJ label_5125
label_5121:
0x5121 DD=0: b5 af a7 1a         TJZB off 0x06af, label_513f
label_5125:
0x5125 DD=0: b5 30 c7            CLRB off 0x0630
0x5128 DD=0: b5 ad c7            CLRB off 0x06ad
0x512b DD=0: b5 2f c7            CLRB off 0x062f
0x512e DD=0: 04 22               SJ label_5152
label_5130:
0x5130 DD=0: 5e f5 24            JBR sbafix 0x02f5.6, label_5157
0x5133 DD=0: b5 af a7 08         TJZB off 0x06af, label_513f
0x5137 DD=0: 5a 36               SB sbafix 0x02f6.2
0x5139 DD=0: b7 b2 08 0b         SB 0x08b2.3
0x513d DD=0: 04 0c               SJ label_514b
label_513f:
0x513f DD=0: b5 ae a6 08         TJNZB off 0x06ae, label_514b
0x5143 DD=0: 58 b4 0a            JBS sbafix 0x02f4.0, label_5150
0x5146 DD=0: 58 34               SB sbafix 0x02f4.0
0x5148 DD=0: d7 ae 17            MOVB off 0x06ae, #0x17
label_514b:
0x514b DD=0: b6 10 01            RB P0.1
label_514e:
0x514e DD=0: 04 32               SJ label_5182
label_5150:
0x5150 DD=0: 5d 33               SB sbafix 0x02f3.5
label_5152:
0x5152 DD=0: b6 10 09            SB P0.1
0x5155 DD=0: 04 2b               SJ label_5182
label_5157:
0x5157 DD=0: 22 d8 02            MOV DP, #0x02d8
0x515a DD=0: 20 a7 8e            MOV X1, #tbl_8ea7
0x515d DD=0: 55 62               ACAL label_1562
0x515f DD=0: 04 21               SJ label_5182
label_5161:
0x5161 DD=0: 58 96 04            JBS sbafix 0x02d6.0, label_5168
0x5164 DD=0: 55 c3               ACAL label_15c3
0x5166 DD=0: 04 1a               SJ label_5182
label_5168:
0x5168 DD=0: 22 d4 02            MOV DP, #0x02d4
0x516b DD=0: 20 87 8e            MOV X1, #tbl_8e87
0x516e DD=0: 55 62               ACAL label_1562
0x5170 DD=0: a4 d8 c7            CLR fix 0x02d8
0x5173 DD=0: a4 da c7            CLR fix 0x02da
...
0x5182 DD=0: 01                  RT
label_5183:
0x5183 DD=1: 4c 48               RB sbaoff 0x06c8.4
...
0x51a6 DD=0: 94 a2               LB A, fix 0x02a2
0x51a8 DD=0: cc                  INCB A
0x51a9 DD=0: f1 02               JEQ label_51ad
0x51ab DD=0: 34 a2               STB A, fix 0x02a2
label_51ad:
0x51ad DD=0: 95 b0               LB A, off 0x06b0
0x51af DD=0: f6 25               JNE label_51d6
0x51b1 DD=0: d7 b0 28            MOVB off 0x06b0, #0x28
0x51b4 DD=0: 17 19               MOVB R7, #0x19
0x51b6 DD=0: 22 96 02            MOV DP, #0x0296
0x51b9 DD=0: 20 d2 8f            MOV X1, #tbl_8fd2
label_51bc:
0x51bc DD=0: da                  DI
...
0x51c7 DD=0: 8d 9f               SUBB A, off 0x069f
0x51c9 DD=0: f6 02               JNE label_51cd
0x51cb DD=0: 35 9f               STB A, off 0x069f
label_51cd:
...
0x51e9 DD=0: 95 b8               LB A, off 0x08b8
0x51eb DD=0: f1 03               JEQ label_51f0
0x51ed DD=0: b5 b8 d6            DECB off 0x08b8
label_51f0:
0x51f0 DD=0: b6 40 05            RB IRQ0L.5
0x51f3 DD=0: f1 0a               JEQ label_51ff
0x51f5 DD=1: 86 8e               L A, TMR2
0x51f7 DD=1: a5 5e 73            MOV ER3, off 0x085e
0x51fa DD=1: 35 5e               ST A, off 0x085e
0x51fc DD=1: 0b                  SUB A, ER3
0x51fd DD=1: 35 5a               ST A, off 0x085a
label_51ff:
...
0x5210 DD=1: 85 60               L A, off 0x0860
...
0x522b DD=1: 85 62               L A, off 0x0862
...
0x5245 DD=1: a5 5c 73            MOV ER3, off 0x085c
0x5248 DD=1: 35 5c               ST A, off 0x085c
0x524a DD=1: 0b                  SUB A, ER3
0x524b DD=1: 35 58               ST A, off 0x0858
...
0x526b DD=1: 9e ff ff            CMP A, #tbl_ffff
...
0x52a2 DD=1: 9e ff ff            CMP A, #tbl_ffff
...
label_52cc:
0x52cc DD=1: b5 b1 21 04         JBR off 0x08b1.1, label_52d4
0x52d0 DD=1: b5 b0 25 03         JBR off 0x08b0.5, label_52d7
label_52d4:
0x52d4 DD=1: 03 9a 55            J label_559a
label_52d7:
0x52d7 DD=0: 95 78               LB A, off 0x0878
0x52d9 DD=0: dc                  DECB A
0x52da DD=0: 3c                  STB A, R4
0x52db DD=0: 95 76               LB A, off 0x0876
...
0x52e9 DD=1: 85 64               L A, off 0x0864
0x52eb DD=1: 9e 82 82            CMP A, #tbl_8282
...
0x5325 DD=0: 95 6a               LB A, off 0x086a
...
0x534d DD=0: 95 67               LB A, off 0x0867
...
0x535b DD=1: d9                  SDD
0x535c DD=1: ad 68               ADD A, off 0x0868
...
0x5368 DD=1: a5 68 76            MOV DP, off 0x0868
...
0x537c DD=0: 95 67               LB A, off 0x0867
...
0x538e DD=1: d9                  SDD
0x538f DD=1: ad 68               ADD A, off 0x0868
...
0x539b DD=1: a5 68 76            MOV DP, off 0x0868
...
0x53b0 DD=0: 95 6b               LB A, off 0x086b
...
0x53ba DD=1: b5 68 a6 0d         TJNZB off 0x0868, label_53cb
0x53be DD=1: f8 00 00            L A, #0x0000
0x53c1 DD=1: 0a                  SUB A, ER2
0x53c2 DD=1: b5 69 70            MOVB R0, off 0x0869
0x53c5 DD=1: b5 6a 71            MOVB R1, off 0x086a
...
label_53e1:
0x53e1 DD=0: 95 68               LB A, off 0x0868
...
0x5443 DD=1: ce 00 c0            OR A, #tbl_c000
...
label_549a:
0x549a DD=0: 95 68               LB A, off 0x0868
0x549c DD=0: 9e 80               CMPB A, #0x80
0x549e DD=0: f2 03               JLT label_54a3
0x54a0 DD=0: 03 97 55            J label_5597
label_54a3:
0x54a3 DD=0: b5 b0 2e 06         JBS off 0x08b0.6, label_54ad
0x54a7 DD=0: fe 92 16            CAL label_1692
0x54aa DD=0: b5 b0 0e            SB off 0x08b0.6
label_54ad:
0x54ad DD=0: 55 f3               ACAL label_15f3
0x54af DD=0: b5 6a 96 07         MOVB ACCH, off 0x086a
0x54b3 DD=0: 95 69               LB A, off 0x0869
0x54b5 DD=0: b5 68 72            MOVB R2, off 0x0868
...
0x54e4 DD=1: 00                  NOP
0x54e5 DD=1: 00                  NOP
0x54e6 DD=1: b5 b0 0d            SB off 0x08b0.5
0x54e9 DD=1: 03 69 55            J label_5569
label_54ec:
0x54ec DD=0: 9e 18               CMPB A, #0x18
0x54ee DD=0: f6 3a               JNE label_552a
0x54f0 DD=0: b5 b0 2e 05         JBS off 0x08b0.6, label_54f9
0x54f4 DD=0: 56 92               ACAL label_1692
0x54f6 DD=0: b5 b0 0e            SB off 0x08b0.6
label_54f9:
0x54f9 DD=0: 55 f3               ACAL label_15f3
0x54fb DD=0: 25 1f 88            MOV ER1, #tbl_881f
0x54fe DD=1: f8 e0 ff            L A, #tbl_ffe0
...
0x5523 DD=1: 00                  NOP
0x5524 DD=1: 00                  NOP
0x5525 DD=1: b5 b0 0d            SB off 0x08b0.5
...
label_5531:
0x5531 DD=0: b5 b0 2e 05         JBS off 0x08b0.6, label_553a
0x5535 DD=0: 56 92               ACAL label_1692
0x5537 DD=0: b5 b0 0e            SB off 0x08b0.6
label_553a:
0x553a DD=0: 55 f3               ACAL label_15f3
0x553c DD=0: 25 00 88            MOV ER1, #tbl_8800
...
0x5564 DD=1: 00                  NOP
0x5565 DD=1: 00                  NOP
0x5566 DD=1: b5 b0 0d            SB off 0x08b0.5
label_5569:
0x5569 DD=1: d7 7f 05            MOVB off 0x087f, #0x05
...
0x557b DD=0: 35 7f               STB A, off 0x087f
label_557d:
...
0x5585 DD=0: b5 7f 87 79         MOVB off 0x0879, off 0x087f
0x5589 DD=0: b5 b0 2d 0a         JBS off 0x08b0.5, label_5597
0x558d DD=0: d7 78 01            MOVB off 0x0878, #0x01
0x5590 DD=0: b5 b2 0e            SB off 0x08b2.6
0x5593 DD=0: b5 7c 96 26         MOVB S1BUF, off 0x087c
label_5597:
0x5597 DD=0: b5 b1 01            RB off 0x08b1.1
label_559a:
0x559a DD=0: fe f3 15            CAL label_15f3
0x559d DD=0: b5 b0 25 25         JBR off 0x08b0.5, label_55c6
...
0x55b6 DD=1: b5 b0 05            RB off 0x08b0.5
0x55b9 DD=1: d7 78 01            MOVB off 0x0878, #0x01
0x55bc DD=1: b5 b2 0e            SB off 0x08b2.6
0x55bf DD=1: b5 7c 96 26         MOVB S1BUF, off 0x087c
0x55c3 DD=1: b5 b1 01            RB off 0x08b1.1
label_55c6:
0x55c6 DD=1: 03 d7 51            J label_51d7

org 0x8001
0x8001:                          db    f0 55 dd f0 55 cc 78 32 b7 06 21 92
tbl_800d:
0x800d:                          db                                        6c 18 70
0x8010:                          db 88 13 2d d0 07 01 d0 07 00 ff 00 ff dd 00 ff cc
0x8020:                          db 00 ff b7 00 ff 00 00
tbl_8027:
0x8027:                          db                      ff cd 2c dd cd 2c cc 85 2b
0x8030:                          db 9f 2f 25 7a 00 20 34 00 20 01 00 20 00
tbl_803d:
0x803d:                          db                                        ff ff 5c
0x8040:                          db 00 c7 71 5c 00 55 55 48 00 e4 38 3c 00 ab
tbl_804e:
0x804e:                          db                                           2a 3c
0x8050:                          db 00 72 1c 3c 00 55 15 3c 00 01 00 3c 00 00 00
tbl_805f:
0x805f:                          db                                              05
0x8060:                          db 05 05 05 dc 60 00 8d 00 00 73 00 00 24 40 00 00
0x8070:                          db 00 00 40 48 60 68 80 88 a0 a8 c0 c8 ff ff
tbl_807e:
0x807e:                          db                                           02 00
0x8080:                          db 02 00
tbl_8082:
0x8082:                          db       05 00 05 00
tbl_8086:
0x8086:                          db                   05 00
tbl_8088:
0x8088:                          db                         39 0e 1c 47 1c 07 00 80
0x8090:                          db 00 00 00 00
tbl_8094:
0x8094:                          db             00 80
tbl_8096:
0x8096:                          db                   00 80 00 00
tbl_809a:
0x809a:                          db                               04 00
tbl_809c:
0x809c:                          db                                     10 00 8e 23
0x80a0:                          db ab 2a c7 31 e4 38 00 40 1c 47
tbl_80aa:
0x80aa:                          db                               55 55 00 00
tbl_80ae:
0x80ae:                          db                                           0f 0f
0x80b0:                          db 0f 0f 0f 0f 0f 0f 0f 0f 0f 0f 0f 0f 0f 0f 0f 0f
0x80c0:                          db 0f 0f 0f 0f 0f 0f
tbl_80c6:
0x80c6:                          db                   1a 02 29 02 47 02 65 02 83 02
...
0x81a0:                          db 00 03 00 1d 00 00 00 10 87 01 e8 01 e8 01
tbl_81ae:
0x81ae:                          db                                           c4 09
...
0x8280:                          db e8 03
tbl_8282:
0x8282:                          db       30 00 f4 01 02 00 c8 00 00 00 08 58 02 28
...
0x8310:                          db 06 00 c8 00 00 00 04 f4 01 64 00 04 00 a0
tbl_831e:
0x831e:                          db                                           c7 08
...
0x8400:                          db 06 00 c8 00 00 00 04 f4 01 69 00 04 00 90
tbl_840e:
0x840e:                          db                                           ef 03
0x8410:                          db 10 00
tbl_8412:
0x8412:                          db       00 20 ff ff 00 30 ff ff 00 40 00 60
tbl_841e:
0x841e:                          db                                           00 80
tbl_8420:
0x8420:                          db 00 70 00 80 ab 2a e4 38 55 55 c7 71 00 80 00 85
tbl_8430:
0x8430:                          db 00 90 00 00
tbl_8434:
0x8434:                          db             05 05 01 01 03 03 03 03 02 02 0a 0a
...
0x8520:                          db e8 01 e8 01
tbl_8524:
0x8524:                          db             fa 02 bf 02 bf 02 bf 02 bf 02 10 a0
...
0x8680:                          db 00 02 00 a0
tbl_8684:
0x8684:                          db             ea 00 60 00 d3 02 30 00 ea 00 20 00
...
0x8760:                          db 00 02 00 90
tbl_8764:
0x8764:                          db             72 9c 72 9c de 5d de 5d
tbl_876c:
0x876c:                          db                                     72 9c 72 9c
0x8770:                          db de 5d de 5d
tbl_8774:
0x8774:                          db             72 9c 72 9c ab 6a ab 6a
tbl_877c:
0x877c:                          db                                     72 9c fa 64
0x8780:                          db 39 8e de 5d
tbl_8784:
0x8784:                          db             72 9c fa 64 39 8e de 5d
tbl_878c:
0x878c:                          db                                     72 9c c7 71
0x8790:                          db 39 8e ab 6a
tbl_8794:
0x8794:                          db             39 8e
tbl_8796:
0x8796:                          db                   ff ff
tbl_8798:
0x8798:                          db                         04 03 01 02 00 9d 00 a4
0x87a0:                          db 00 90 de b7
tbl_87a4:
0x87a4:                          db             04 03 01 02
tbl_87a8:
0x87a8:                          db                         72 9c f4 02 8e 63 f4 02
0x87b0:                          db 72 5c f7 02 e4 58 f7 02 55 55 fa 02 39 4e 06 03
0x87c0:                          db 1c 47 09 03 00 40 fa 02 e4 38 fa 02 c7 31 fa 02
0x87d0:                          db 00 00
tbl_87d2:
0x87d2:                          db       de 5d de 5d
tbl_87d6:
0x87d6:                          db                   1c 47 1c 47
tbl_87da:
0x87da:                          db                               e4 38 e4 38
tbl_87de:
0x87de:                          db                                           ab 2a
0x87e0:                          db ab 2a
tbl_87e2:
0x87e2:                          db       28 3d 28 3d bc 3b 94 94
tbl_87ea:
0x87ea:                          db                               04 03 01 02
tbl_87ee:
0x87ee:                          db                                           ff 80
0x87f0:                          db f9 80 bd a7 98 ca 73 ef 01 ef 00
tbl_87fb:
0x87fb:                          db                                  ff 80 f9 80 bd
tbl_8800:
0x8800:                          db 80 98 80 73 80 2e 80 00
tbl_8808:
0x8808:                          db                         ff 80 fa 80 72 80 2e 80
0x8810:                          db 00
tbl_8811:
0x8811:                          db    ff 60 e2 60 d5 53 cc 50 b7 4a 86 42 6e 40
tbl_881f:
0x881f:                          db                                              2d
...
0x88a0:                          db 80 00 01 00 80 00 00 00
tbl_88a8:
0x88a8:                          db                         ff 35 e2 35 d5 34 cc 2f
...
0x88e0:                          db 2d 50 21 35 01 35 00
tbl_88e7:
0x88e7:                          db                      00 1c 00 2c 00 55 00 65 30
...
0x8930:                          db 00 72 1c 90 00 55 15 80 00 01 00 80 00 00 00
tbl_893f:
0x893f:                          db                                              ff
0x8940:                          db a0 e4 a0 c5 8f a1 86 7b 80 57 7d 3c 7a 23 75 13
0x8950:                          db 75 01 75 00 ff 96 e1 96 d0 90 a1 87 7b 80 57 7a
0x8960:                          db 3c 75 23 6e 18 6a 01 6a 00
tbl_8969:
0x8969:                          db                            00 0a 80
tbl_896c:
0x896c:                          db                                     01 10 80 ff
0x8970:                          db aa e2 aa d5 a0 cc 96 b7 86 86 6a 47 40 2d 20 1b
0x8980:                          db 03 01 03 00
tbl_8984:
0x8984:                          db             ff 2a e2 2a d5 2a cc 26 b7 24 86 22
0x8990:                          db 59 20 2d 20 1b 20 01 20 00 ff aa e2 aa d5 a0 cc
0x89a0:                          db 96 b7 86 86 6a 47 40 2d 20 1b 03 01 03 00
tbl_89ae:
0x89ae:                          db                                           ff 50
0x89b0:                          db e2 50 d5 48 cc 40 b7 30 85 28 47 22 2d 20 1b 20
0x89c0:                          db 01 20 00
tbl_89c3:
0x89c3:                          db          cf 40 a1 40 7a 40 56 40 3c 40 23 40 17
0x89d0:                          db 40 00
tbl_89d2:
0x89d2:                          db       ff 01 80 80 01 80 40 01 80 00 01 80 80 00
0x89e0:                          db 80 40 00 80 10 00 80 00 00
tbl_89e9:
0x89e9:                          db                            a7 07 03 92 bb 03 7d
0x89f0:                          db bc 04 68 68 06 54 b9 09 3f 82 11 00
tbl_89fc:
0x89fc:                          db                                     01 03 04 02
tbl_8a00:
0x8a00:                          db 00 00 00 00 9a 19
tbl_8a06:
0x8a06:                          db                   72 1c 39 2e c7 31 72 3c 00 40
0x8a10:                          db ab 4a 39 4e e4 58 72 5c 1c 67 ab 6a 39 6e c7 71
0x8a20:                          db 72 7c 00 80 ab 8a 39 8e ff ff ff ff
tbl_8a2c:
0x8a2c:                          db                                     00 00 00 00
0x8a30:                          db ff 03
tbl_8a32:
0x8a32:                          db       ff 03 ff 03 ff 03 ff 03 ff 03 ff 03 ff 03
0x8a40:                          db ff ff ff ff
tbl_8a44:
0x8a44:                          db             02
tbl_8a45:
0x8a45:                          db                0d 0d 0d 0d 0d 0a 0a 0a 0a 0a 05
0x8a50:                          db 05 05 05 05 02 02 02 02 02 00 00 00 00 00 17 17
0x8a60:                          db 17 17 17 04 04 04 04 04 04 04 04 04 04 04 04 04
0x8a70:                          db 04 04 04 04 04 04 04
tbl_8a77:
0x8a77:                          db                      40 0a 80 50 08 80 70 06 80
0x8a80:                          db 90 03 80 a0 02 80 c0 01 80 e0 00 80 00 00 e0 15
0x8a90:                          db 64 80 0c 60 40 06 54 c0 03 4a e0 01 40 00 00
tbl_8a9f:
0x8a9f:                          db                                              77
0x8aa0:                          db 77 47 47 47 4d 55 5b 61 6b 79 84 91 8e 8b 86 7f
0x8ab0:                          db 78 72 72 72 6c 6c 67 65 65
tbl_8ab9:
0x8ab9:                          db                            70 80 60 80 53 80 52
0x8ac0:                          db 80 50 80 4f 80 4e 80 29 80 00
tbl_8aca:
0x8aca:                          db                               94 fe d0 fe e0 ff
0x8ad0:                          db ff ff 30 00 ff ff 10 02 ab 2a c0 00 72 1c 90 00
0x8ae0:                          db 55 15 80 00 01 00 80 00 00 00 40 00 40 40 00 05
0x8af0:                          db 40 01
tbl_8af2:
0x8af2:                          db       70 80 60 80 53 80 52 80 50 80 4f 80 4e 80
0x8b00:                          db 29 80 00
tbl_8b03:
0x8b03:                          db          94 fe d0 fe e0 ff ff ff 30 00 ff ff 10
0x8b10:                          db 02 ab 2a c0 00 72 1c 90 00 55 15 80 00 01 00 80
0x8b20:                          db 00 00 00 40 00 40 40 00 05 40 01
tbl_8b2b:
0x8b2b:                          db                                  e6 80 cc 80 85
0x8b30:                          db 80 45 80 00 e6 80 85 80 59 80 44 80 00 30 80 1f
0x8b40:                          db 80 1b 80 12 80 00
tbl_8b46:
0x8b46:                          db                   01 00 2f d0 30 00 5f 00 60 30
...
0x8b80:                          db 00 01 00 80 00 00 00
tbl_8b87:
0x8b87:                          db                      e6 80 85 80 59 80 45 80 00
0x8b90:                          db e6 80 85 80 59 80 44 80 00 30 80 1f 80 1b 80 12
0x8ba0:                          db 80 00
tbl_8ba2:
0x8ba2:                          db       47 00 2f d0 30 00 5f 00 60 30 00 ff ff 10
...
0x8be0:                          db 00 00 00
tbl_8be3:
0x8be3:                          db          77 77 47 47 47 4d 55 5b 61 6b 79 84 91
0x8bf0:                          db 8e 8b 86 7f 78 72 72 72 6c 6c 67 65 65
tbl_8bfd:
0x8bfd:                          db                                        ff 03
tbl_8bff:
0x8bff:                          db                                              ff
...
0x8c50:                          db 86 86 86 86 86 86 86 86 86
tbl_8c59:
0x8c59:                          db                            01 22 17 17 17 01 17
0x8c60:                          db 17 17 17 01 17 17 17 17 01 0e 0e 0e 0e 01 00 00
0x8c70:                          db 00 00 01 00 00 00 00 01 00 00 00 00 01 00 00 00
0x8c80:                          db 00
tbl_8c81:
0x8c81:                          db    e0 80 a1 80 70 80 3c 80 00
tbl_8c8a:
0x8c8a:                          db                               01
tbl_8c8b:
0x8c8b:                          db                                  02
tbl_8c8c:
0x8c8c:                          db                                     ff 01 80 80
0x8c90:                          db 01 80 40 01 80 00 01 80 80 00 80 40 00 80 10 00
0x8ca0:                          db 80 00 00
tbl_8ca3:
0x8ca3:                          db          00 80 00 55 55 00 1c 47 07 e4 38 06 ab
0x8cb0:                          db 2a 04 72 1c 03 39 0e 03 00 00
tbl_8cba:
0x8cba:                          db                               2b 2b 2b 2b 2b 2b
0x8cc0:                          db 2b 2b 2b 2b 2b 3c 3c 3c 3c 3f 47 59 67 68 6a 6c
0x8cd0:                          db 6c 6c 6c 6c
tbl_8cd4:
0x8cd4:                          db             ab aa 1c 00 80 17 8e 63 11 1c 47 0c
0x8ce0:                          db ab 2a 06 72 1c 01 39 0e 01 1d 07 01 00 00
tbl_8cee:
0x8cee:                          db                                           ab aa
0x8cf0:                          db c4 09 e4 78 b8 0b 55 55 b8 0b 1c 47 b8 0b c7 31
0x8d00:                          db b8 0b 72 1c b8 0b 1d 07 a0 0f 00 00
tbl_8d0c:
0x8d0c:                          db                                     a7 40 7d 40
0x8d10:                          db 68 40 3f 40
tbl_8d14:
0x8d14:                          db             00 00 12 06 0c
tbl_8d19:
0x8d19:                          db                            38 8e e3
tbl_8d1c:
0x8d1c:                          db                                     00 f0 67 1c
0x8d20:                          db 67 67 8e 63 67 72 5c 67 e4 58 67 c1 56 6d 55 55
0x8d30:                          db 67 39 4e 67 1c 47 67 e4 38 50 c7 31 33 ab 2a 33
0x8d40:                          db 8e 23 33 72 1c 33 8c 05 33 00 00
tbl_8d4b:
0x8d4b:                          db                                  00 f0 41 1c 67
0x8d50:                          db 41 8e 63 41 72 5c 41 e4 58 41 c1 56 4a 55 55 4a
0x8d60:                          db 39 4e 48 1c 47 46 e4 38 24 c7 31 24 ab 2a 24 8e
0x8d70:                          db 23 24 72 1c 24 8c 05 24 00 00
tbl_8d7a:
0x8d7a:                          db                               ae 00 a1 1d 88 4f
0x8d80:                          db 70 7d 58 7d 45 7d 35 7d 00
tbl_8d89:
0x8d89:                          db                            ae 00 a1 1d 88 4f 70
0x8d90:                          db 4f 58 4f 45 4f 35 4f 00
tbl_8d98:
0x8d98:                          db                         55 55 66 02 1c 47 66 02
0x8da0:                          db e4 38 66 02 ab 2a 66 02 00 00
tbl_8daa:
0x8daa:                          db                               20 40 01
tbl_8dad:
0x8dad:                          db                                        2c 80 01
...
0x8dc0:                          db 38 80 ab 2a 80 00 00
tbl_8dc7:
0x8dc7:                          db                      ff 70 94 f3 a0 8c da d0 84
0x8dd0:                          db b6 60 6d 9c c0 5d 82 20 4e 68 80 3e 4e e0 2e 34
0x8de0:                          db 40 1f 01 b8 0b 00
tbl_8de6:
0x8de6:                          db                   a7 b0 04 92 00 00 00
tbl_8ded:
0x8ded:                          db                                        92 00 00
0x8df0:                          db 88 20 03 7d e8 03 68 2e 11 00
tbl_8dfa:
0x8dfa:                          db                               e0 8e 23 39 0e 08
tbl_8e00:
0x8e00:                          db 41 10 04
tbl_8e03:
0x8e03:                          db          20 08 82
...
0x8e06:                          db                   20 08 84
tbl_8e09:
0x8e09:                          db                            d2 27 ab 2a 06 5b de
0x8e10:                          db 5d cf
tbl_8e12:
0x8e12:                          db       07
tbl_8e13:
...
0x8e17:                          db                      20 00
tbl_8e19:
0x8e19:                          db                            90 00 68 00
tbl_8e1d:
0x8e1d:                          db                                        cc 00 ab
0x8e20:                          db 2a e4 38 1c 47
tbl_8e25:
0x8e25:                          db                55 55 01 01 01 01 01 01 01 01 01
0x8e30:                          db 01 01 01 01 01 01
tbl_8e36:
0x8e36:                          db                   00 00 00 00 00 00 00 00 00 00
0x8e40:                          db 00 11 11 11 11 14 1c 1f 0b 0a 08 00 00 00 00 00
tbl_8e50:
0x8e50:                          db d0 be b0 be 90 be 70 be 50 be 30 be 10 be 00
tbl_8e5f:
0x8e5f:                          db                                              e0
0x8e60:                          db 87 cf 87 c5 82 b9 73 a1 69 88 50 7c 00 00
tbl_8e6e:
0x8e6e:                          db                                           e0 af
0x8e70:                          db cf aa c5 a0 b9 91 a1 82 88 69 7c 69 00
tbl_8e7d:
0x8e7d:                          db                                        f5 00 bd
0x8e80:                          db 00
tbl_8e81:
0x8e81:                          db    30 20
tbl_8e83:
0x8e83:                          db          00 10 30 20
tbl_8e87:
0x8e87:                          db                      01 02 44 07 08 09 10 00 12
0x8e90:                          db 13 14 15 18 19 00 00 33 00 00 00 00 42 43 45 46
0x8ea0:                          db 47 00 00 25 00 00 29
tbl_8ea7:
0x8ea7:                          db                      01 02 44 07 08 09 10 00 12
0x8eb0:                          db 13 14 15 18 19 00 00 33 00 00 00 00 42 43 45 46
0x8ec0:                          db 47 00 00 25 00 00 29
tbl_8ec7:
0x8ec7:                          db                      04
tbl_8ec8:
0x8ec8:                          db                         fc 05 58 05 14 e1 cf a0
0x8ed0:                          db 6d 28
tbl_8ed2:
0x8ed2:                          db       04
tbl_8ed3:
...
0x8ed7:                          db                      14
tbl_8ed8:
0x8ed8:                          db                         df ba 6e 32 1a 04 fc 05
0x8ee0:                          db 58 05 14 e1 cf a0 6d 28
tbl_8ee8:
0x8ee8:                          db                         00 02
tbl_8eea:
0x8eea:                          db                               00 0a
tbl_8eec:
0x8eec:                          db                                     c7 71 28 1c
0x8ef0:                          db 47 28 ab 2a 1e 38 0e 1e 00 00
tbl_8efa:
0x8efa:                          db                               fe 03
tbl_8efc:
0x8efc:                          db                                     fe 09 fe 04
...
0x8f50:                          db fe 06 fe 01 fe 07 fe 02 fe 08
tbl_8f5a:
0x8f5a:                          db                               0e 14
tbl_8f5c:
0x8f5c:                          db                                     08 02 0f 15
...
0x8fb0:                          db 05 17 0c 12 06 00 0d 13 07
tbl_8fb9:
0x8fb9:                          db                            01 0f 2d ff 0f 0f 0f
0x8fc0:                          db 0f 0f 0f 2d 0a 0f 32 0f 14 14
tbl_8fca:
0x8fca:                          db                               10
tbl_8fcb:
0x8fcb:                          db                                  10 ff ff 19 19
0x8fd0:                          db ff ff
tbl_8fd2:
0x8fd2:                          db       19 19 19 19 ff ff ff
tbl_8fd9:
0x8fd9:                          db                            ff 01 02 00 04 05 06
...
0x9030:                          db ff 00
tbl_9032:
0x9032:                          db       fc 00 f6 08 e6 1a cd 29 4d 5f 33 6f 24 7c
0x9040:                          db 19 8a 0f 9f 01 ff 00
tbl_9047:
0x9047:                          db                      a5 00
tbl_9049:
0x9049:                          db                            b5 55
...
0x9054:                          db             62
tbl_9055:
0x9055:                          db                fc 00 f6 06 e6 19 cd 29 4d 5f 33
0x9060:                          db 6f 24 7c 19 8a 0f 9f 01 ff 00
tbl_906a:
0x906a:                          db                               a5 00
tbl_906c:
0x906c:                          db                                     b5 55
...
0x9073:                          db          63 00
tbl_9075:
0x9075:                          db                00 00 01 01 01 02 02 01 07 01 07
...
0x9120:                          db 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
tbl_912f:
0x912f:                          db                                              0a
0x9130:                          db 00 0c 01 0c 02 0c 03 0c 04 0c 00 06 74 90 74 90
0x9140:                          db 74 90 74 90
tbl_9144:
0x9144:                          db             11 07 0c 06 0c 08 0c 09 0c 0a 0c 0b
0x9150:                          db 0c 0c 0c 0d 0c 0e 0c 0f 0c 10 0c 11 0c 12 0c 74
0x9160:                          db 90 15 0c 14 0c 16 0c
tbl_9167:
0x9167:                          db                      14 07 0c 06 0c 08 0c 09 0c
...
0x91b0:                          db 0c 16 0c 17 0c 18 0c 19 0c 1a 0c 1b 0c
tbl_91bd:
0x91bd:                          db                                        11 81 0c
...
0x9200:                          db 0c 90 0c 91 0c 74 90 74 90
tbl_9209:
0x9209:                          db                            16 81 0c 80 0c 82 0c
0x9210:                          db 83 0c 84 0c 85 0c 86 0c 87 0c 88 0c 89 0c 8a 0c
0x9220:                          db 8b 0c 8c 0c 74 90 8f 0c 8e 0c 90 0c 91 0c 92 0c
0x9230:                          db 93 0c 94 0c 95 0c
tbl_9236:
0x9236:                          db                   05 22 0c 23 0c 74 90 24 0c 74
0x9240:                          db 90
tbl_9241:
0x9241:                          db    06 27 0c 28 0c 29 0c 2a 0c 2b 0c 2c 0c
tbl_924e:
0x924e:                          db                                           59
tbl_924f:
0x924f:                          db                                              33
...
0x9253:                          db          30
tbl_9254:
0x9254:                          db             61 14 6d 14 21 15 72 14 7e 14 8a 14
...
0x9290:                          db 4d 15 f7 14
tbl_9294:
0x9294:                          db             01 01 02 04 04 05 05 06 06 00 00 00
0x92a0:                          db 09 0a 0b 0c 00 00 0d 0e 00 00 00 00 1d 00 00 00
0x92b0:                          db 20 11 00 00 00 00 16 16 17 03 03 18 19 1a 00 00

org 0xa000
tbl_a000:
0xa000:                          db 48 31 31 41 32 30 41 20
tbl_a008:
0xa008:                          db                         53 0c 45 00 00 00 00 00
tbl_a010:
0xa010:                          db 3b 07 2b
tbl_a013:
0xa013:                          db          00
...
0xaa00:                          db 55 55 55 55 55 55 55 55 55 55
tbl_aa0a:
0xaa0a:                          db                               55 55 55 55 55 55
...
0xddd0:                          db 5f 02 ca 02 11 03 4d 03 8f 03 96 03
tbl_dddc:
0xdddc:                          db                                     97 03 82 03
...
0xeba0:                          db 8e 63 39 8e
tbl_eba4:
0xeba4:                          db             24 00 54 00 a4 00 10 01 48 01 98 01
0xebb0:                          db 64 02 30 03
tbl_ebb4:
0xebb4:                          db             d4 01 d4 01 d4 01 d4 01 d4 01 d4 01
...
0xec50:                          db 83 02 cb 02
tbl_ec54:
0xec54:                          db             00 00 55 15 72 1c 8e 23 ab 2a c7 31
0xec60:                          db e4 38 00 40 1c 47 39 4e 55 55 72 5c 8e 63 1c 67
0xec70:                          db ff ff
tbl_ec72:
0xec72:                          db       00 00 50 00 d8 00 34 01 98 01 00 02 68 02
0xec80:                          db cc 02 34 03 fc 03
tbl_ec86:
0xec86:                          db                   00 00 00 00 00 00 00 00 00 00
...
0xed10:                          db 00 00 00 00 00 00 00 00 00 00 00 00
tbl_ed1c:
0xed1c:                          db                                     00 00 55 15
0xed20:                          db 72 1c 8e 23 ab 2a c7 31 e4 38 00 40 1c 47 39 4e
0xed30:                          db 55 55 72 5c 8e 63 1c 67 ff ff
tbl_ed3a:
0xed3a:                          db                               01 07 18 1f 28 34
0xed40:                          db 44 87 ba e1
tbl_ed44:
